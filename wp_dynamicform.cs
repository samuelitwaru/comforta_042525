...
namespace GeneXus.Programs {
   public class wp_dynamicform : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_dynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV20WWPFormType,1,0)),UrlEncode(StringUtil.BoolToStr(AV21WWPFormIsForDynamicValidations)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"WWPFormType","WWPFormIsForDynamicValidations","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vWWPFORMTYPE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20WWPFormType), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vWWPFORMTYPE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV20WWPFormType), "9"), context));
      ...
      {
         return formatLink("wp_dynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV20WWPFormType,1,0)),UrlEncode(StringUtil.BoolToStr(AV21WWPFormIsForDynamicValidations)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"WWPFormType","WWPFormIsForDynamicValidations","TabCode"})  ;
      }
      ...
      protected void WBB80( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneraldynamicform_title_Internalname, "General Dynamic Form", "", "", lblGeneraldynamicform_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_DynamicForm.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrganisationdynamicform_title_Internalname, "Organisation Dynamic Form", "", "", lblOrganisationdynamicform_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_DynamicForm.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLocationdynamicform_title_Internalname, "Location Dynamic Form", "", "", lblLocationdynamicform_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_DynamicForm.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void RFB82( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A207WWPFormVersionNumber = H00B82_A207WWPFormVersionNumber[0];
               A206WWPFormId = H00B82_A206WWPFormId[0];
               A240WWPFormType = H00B82_A240WWPFormType[0];
               /* Execute user event: Load */
               E14B82 ();
      ...
      protected void STRUPB80( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV20WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vWWPFORMTYPE"), ".", ","), 18, MidpointRounding.ToEven));
            AV21WWPFormIsForDynamicValidations = StringUtil.StrToBool( cgiGet( "vWWPFORMISFORDYNAMICVALIDATIONS"));
            AV12LoadAllTabs = StringUtil.StrToBool( cgiGet( "vLOADALLTABS"));
            AV13SelectedTabCode = cgiGet( "vSELECTEDTABCODE");
            AV17RecordDescription = cgiGet( "vRECORDDESCRIPTION");
            A207WWPFormVersionNumber = (short)(Math.Round(context.localUtil.CToN( cgiGet( "WWPFORMVERSIONNUMBER"), ".", ","), 18, MidpointRounding.ToEven));
            A206WWPFormId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "WWPFORMID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E12B82( )
      {
         ...
         {
            A240WWPFormType = H00B83_A240WWPFormType[0];
            AV22GXLvl8 = 1;
            AV9Exists = true;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025424121281", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_dynamicform.js", "?2025424121281", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00B82_A207WWPFormVersionNumber = new short[1] ;
         H00B82_A206WWPFormId = new short[1] ;
         H00B82_A240WWPFormType = new short[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B83_A206WWPFormId = new short[1] ;
         H00B83_A207WWPFormVersionNumber = new short[1] ;
         H00B83_A240WWPFormType = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_dynamicform__default(),
            new Object[][] {
                new Object[] {
               H00B82_A207WWPFormVersionNumber, H00B82_A206WWPFormId, H00B82_A240WWPFormType
               }
               , new Object[] {
               H00B83_A206WWPFormId, H00B83_A207WWPFormVersionNumber, H00B83_A240WWPFormType
               }
            }
         );
      ...
      private short[] H00B82_A207WWPFormVersionNumber ;
      private short[] H00B82_A206WWPFormId ;
      private short[] H00B82_A240WWPFormType ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private short[] H00B83_A206WWPFormId ;
      private short[] H00B83_A207WWPFormVersionNumber ;
      private short[] H00B83_A240WWPFormType ;
   ...
   public class wp_dynamicform__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B82", "SELECT WWPFormVersionNumber, WWPFormId, WWPFormType FROM WWP_Form WHERE WWPFormType = :AV20WWPFormType ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B82,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00B83", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormType FROM WWP_Form WHERE WWPFormType = :AV20WWPFormType ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B83,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
