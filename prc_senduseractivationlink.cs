         ...
         if ( StringUtil.StrCmp(AV16Repository.gxTpr_Useractivationmethod, "U") == 0 )
         {
            ...
            if ( AV12GAMUser.success() )
            {
               ...
               if ( AV11GAMErrors.Count == 0 )
               {
                  ...
                  AV38BaseUrl_Link = "" + AV23baseUrl + "WP_UserActivation.aspx?ActivationKey=" + AV9ActivactionKey + "&GamGuid=" + AV12GAMUser.gxTpr_Guid;
                  if ( StringUtil.StrCmp(AV28language, "English") == 0 )
                  {
                     ...
                     {
                        AV15MailMessage.HTMLText = "<div style=\"max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; border: 1px solid #e0e0e0; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\">"+"<div style=\"background-color: #222F54; color: #ffffff; text-align: center; padding: 20px 0;\"><h2>Comforta Software</h2></div><div style=\"padding: 20px; line-height: 1.5;\"><p>Dear "+AV19Username+",</p><p>Welcome to Comforta Software! We are thrilled to have you on board.</p><p>To get started, we need to verify your email address. Please click the button below to activate your account:</p>"+"</b></p><a href=\""+AV38BaseUrl_Link+"\" style=\"display: block; padding: 10px 20px; width: 150px;  margin: 20px auto; background-color: #222F54; text-align: center; border-radius: 8px; color: white; font-weight: bold; line-height: 30px; text-decoration: none;\">Verify Email</a>"+"<p>Please note that the link expires in 36 hours.</p>"+"<p>Once you have activated your account and set a password, you will gain access to the platform.</p>"+"<br><p>Many thanks and kind regards,</p><p>Comforta Software</p></div></div>";
                     }
                     else
                     {
                  ...
                  else if ( StringUtil.StrCmp(AV28language, "Dutch") == 0 )
                  {
                     ...
                     if ( String.IsNullOrEmpty(StringUtil.RTrim( AV40MailTemplateBody)) )
                     {
                        AV15MailMessage.HTMLText = "<div style=\"max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; border: 1px solid #e0e0e0; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\">"+"<div style=\"background-color: #222F54; color: #ffffff; text-align: center; padding: 20px 0;\"><h2>Comforta Software</h2></div><div style=\"padding: 20px; line-height: 1.5;\"><p>Beste "+AV19Username+",</p><p>Welkom bij Comforta Software! We kijken ernaar uit om u van dienst te zijn.</p><p>Om te beginnen verifiëren we uw e-mailadres. Klik op de knop hieronder om uw account te activeren:</p>"+"</b></p><a href=\""+AV38BaseUrl_Link+"\" style=\"display: block; padding: 10px 20px; width: 150px;  margin: 20px auto; background-color: #222F54; text-align: center; border-radius: 8px; color: white; font-weight: bold; line-height: 30px; text-decoration: none;\">Email verifiëren</a>"+"<p>Houd er rekening mee dat de link over 36 uur verloopt.</p>"+"<p>Zodra u uw account heeft geactiveerd en een wachtwoord heeft ingesteld, krijgt u toegang tot het platform.</p>"+"<br><p>Hartelijk dank en groeten,</p><p>Comforta Software</p></div></div>";
                     }
                     else
                     {
