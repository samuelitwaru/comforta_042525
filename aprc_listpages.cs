...
namespace GeneXus.Programs {
   public class aprc_listpages : GXProcedure
   {
      ...
      {
         this.AV28SDT_PageStructureCollection = new GXBaseCollection<SdtSDT_PageStructure>( context, "SDT_PageStructure", "Comforta_version20") ;
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV30Error.gxTpr_Status = "Error";
            AV30Error.gxTpr_Message = "Not Authenticated";
         }
         else
         {
      ...
      {
         AV28SDT_PageStructureCollection = new GXBaseCollection<SdtSDT_PageStructure>( context, "SDT_PageStructure", "Comforta_version20");
