...
namespace GeneXus.Programs {
   public class prc_checkresidentpackageavailable : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A527ResidentPackageId = P00G13_A527ResidentPackageId[0];
            n527ResidentPackageId = P00G13_n527ResidentPackageId[0];
            A529SG_OrganisationId = P00G13_A529SG_OrganisationId[0];
            A528SG_LocationId = P00G13_A528SG_LocationId[0];
            A40000GXC1 = P00G13_A40000GXC1[0];
            n40000GXC1 = P00G13_n40000GXC1[0];
            A40000GXC1 = P00G13_A40000GXC1[0];
            n40000GXC1 = P00G13_n40000GXC1[0];
      ...
      public override void initialize( )
      {
         ...
         P00G13_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         P00G13_n527ResidentPackageId = new bool[] {false} ;
         P00G13_A529SG_OrganisationId = new Guid[] {Guid.Empty} ;
         P00G13_A528SG_LocationId = new Guid[] {Guid.Empty} ;
         P00G13_A40000GXC1 = new int[1] ;
         P00G13_n40000GXC1 = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_checkresidentpackageavailable__default(),
            new Object[][] {
                new Object[] {
               P00G13_A527ResidentPackageId, P00G13_A529SG_OrganisationId, P00G13_A528SG_LocationId, P00G13_A40000GXC1, P00G13_n40000GXC1
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00G13_A527ResidentPackageId ;
      private bool[] P00G13_n527ResidentPackageId ;
      private Guid[] P00G13_A529SG_OrganisationId ;
      private Guid[] P00G13_A528SG_LocationId ;
      private int[] P00G13_A40000GXC1 ;
      private bool[] P00G13_n40000GXC1 ;
