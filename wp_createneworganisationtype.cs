...
namespace GeneXus.Programs {
   public class wp_createneworganisationtype : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wp_createneworganisationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10TrnMode)),UrlEncode(AV14OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultOrganisationTypeName))}, new string[] {"TrnMode","OrganisationTypeId","DefaultOrganisationTypeName"}) +"\">") ;
      ...
      {
         return formatLink("wp_createneworganisationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10TrnMode)),UrlEncode(AV14OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultOrganisationTypeName))}, new string[] {"TrnMode","OrganisationTypeId","DefaultOrganisationTypeName"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542718164953", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createneworganisationtype.js", "?202542718164953", false, true);
