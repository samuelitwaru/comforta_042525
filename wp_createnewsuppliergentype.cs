...
namespace GeneXus.Programs {
   public class wp_createnewsuppliergentype : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wp_createnewsuppliergentype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV11TrnMode)),UrlEncode(AV14SupplierGenTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultSupplierGenTypeName))}, new string[] {"TrnMode","SupplierGenTypeId","DefaultSupplierGenTypeName"}) +"\">") ;
      ...
      {
         return formatLink("wp_createnewsuppliergentype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV11TrnMode)),UrlEncode(AV14SupplierGenTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultSupplierGenTypeName))}, new string[] {"TrnMode","SupplierGenTypeId","DefaultSupplierGenTypeName"})  ;
      }
      ...
      protected void S132( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Type Name", "", "", "", "", "", "", "", ""),  "error",  edtavTrn_suppliergentype_suppliergentypename_Internalname,  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241815265", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createnewsuppliergentype.js", "?20254241815265", false, true);
