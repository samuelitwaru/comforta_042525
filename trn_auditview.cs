...
namespace GeneXus.Programs {
   public class trn_auditview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_auditview.aspx", new object[] {UrlEncode(AV10AuditId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"AuditId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_auditview.aspx", new object[] {UrlEncode(AV10AuditId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"AuditId","TabCode"})  ;
      }
      ...
      protected void WB6P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_AuditView.htm");
            /* Div Control */
      ...
      protected void STRUP6P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10AuditId = StringUtil.StrToGuid( cgiGet( "vAUDITID"));
      ...
      protected void E136P2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AV17GXLvl8 = 1;
            Form.Caption = context.localUtil.TToC( A372AuditDate, 8, 5, 0, 3, "/", ":", " ");
      ...
      protected void E126P2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Audit",StringUtil.Trim( A371AuditId.ToString()),(string)AV14RecordDescription,formatLink("trn_auditview.aspx", new object[] {UrlEncode(A371AuditId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"AuditId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411552477", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_auditview.js", "?202542411552477", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
