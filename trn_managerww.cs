   ...
   public class trn_managerww : GXDataArea
   {
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV105Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext), "%", "");
            lV105Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext), "%", "");
            lV105Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext), "%", "");
            lV105Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext), "%", "");
            lV105Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext), "%", "");
            ...
            /* Using cursor H003E2 */
            pr_default.execute(0, new Object[] {AV61OrganisationId, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV106Trn_managerwwds_2_tfmanagergivenname, AV107Trn_managerwwds_3_tfmanagergivenname_sel, lV108Trn_managerwwds_4_tfmanagerlastname, AV109Trn_managerwwds_5_tfmanagerlastname_sel, lV110Trn_managerwwds_6_tfmanageremail, AV111Trn_managerwwds_7_tfmanageremail_sel, lV112Trn_managerwwds_8_tfmanagerphone, AV113Trn_managerwwds_9_tfmanagerphone_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV112Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV112Trn_managerwwds_8_tfmanagerphone), 20, "%");
         /* Using cursor H003E3 */
         pr_default.execute(1, new Object[] {AV61OrganisationId, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV105Trn_managerwwds_1_filterfulltext, lV106Trn_managerwwds_2_tfmanagergivenname, AV107Trn_managerwwds_3_tfmanagergivenname_sel, lV108Trn_managerwwds_4_tfmanagerlastname, AV109Trn_managerwwds_5_tfmanagerlastname_sel, lV110Trn_managerwwds_6_tfmanageremail, AV111Trn_managerwwds_7_tfmanageremail_sel, lV112Trn_managerwwds_8_tfmanagerphone, AV113Trn_managerwwds_9_tfmanagerphone_sel});
      ...
      protected void E203E2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV94successmsg = AV95websession.Get("NotificationMessage");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV94successmsg)) )
         {
            ...
            AV95websession.Remove("NotificationMessage");
         }
      ...
      private void E223E2( )
      {
         ...
         if ( AV99IsAuthorized_UserActionBlock )
         {
            ...
            {
               cmbavActiongroup.addItem("2", StringUtil.Format( "%1;%2", "Block", "fas fa-lock", "", "", "", "", "", "", ""), 0);
            }
         }
         if ( AV100IsAuthorized_UserActionUnblock )
         {
            if ( ( AV89IsGAMActive ) && ( AV90IsGAMBlocked ) && ( AV51isMainManager ) )
            {
               cmbavActiongroup.addItem("3", StringUtil.Format( "%1;%2", "Unblock", "fas fa-lock-open", "", "", "", "", "", "", ""), 0);
            }
         }
         if ( AV43IsAuthorized_Display )
         {
            cmbavActiongroup.addItem("4", StringUtil.Format( "%1;%2", "Display", "fa fa-search", "", "", "", "", "", "", ""), 0);
         }
         if ( AV45IsAuthorized_Update )
         {
            if ( AV51isMainManager )
            {
               cmbavActiongroup.addItem("5", StringUtil.Format( "%1;%2", "Edit", "fa fa-pen", "", "", "", "", "", "", ""), 0);
            }
         }
         if ( AV47IsAuthorized_Delete )
         {
            ...
            {
               cmbavActiongroup.addItem("6", StringUtil.Format( "%1;%2", "Delete", "fa fa-times", "", "", "", "", "", "", ""), 0);
            }
         }
      ...
      protected void E113E2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ManagerWWFilters")),UrlEncode(StringUtil.RTrim(AV104Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ManagerWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void E193E2( )
      {
         ...
         returnInSub = false;
         CallWebObject(formatLink("trn_manager.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString()),UrlEncode(new prc_getuserorganisationid(context).executeUdp( ).ToString())}, new string[] {"Mode","ManagerId","OrganisationId"}) );
      ...
      protected void S272( )
      {
         ...
         if ( AV102Trn_Manager.Success() )
         {
            context.CommitDataStores("trn_managerww",pr_default);
            gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV61OrganisationId, AV19ManageFiltersExecutionStep, AV87ColumnsSelector, AV104Pgmname, AV20TFManagerGivenName, AV21TFManagerGivenName_Sel, AV22TFManagerLastName, AV23TFManagerLastName_Sel, AV26TFManagerEmail, AV27TFManagerEmail_Sel, AV28TFManagerPhone, AV29TFManagerPhone_Sel, AV31TFManagerGender_Sels, AV51isMainManager, AV99IsAuthorized_UserActionBlock, AV100IsAuthorized_UserActionUnblock, AV43IsAuthorized_Display, AV45IsAuthorized_Update, AV47IsAuthorized_Delete, AV41IsAuthorized_ManagerGivenName) ;
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  "Manager Blocked sucessfully",  "success",  "",  "true",  ""));
         }
         else
         {
      ...
      protected void S282( )
      {
         ...
         if ( AV102Trn_Manager.Success() )
         {
            context.CommitDataStores("trn_managerww",pr_default);
            gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV61OrganisationId, AV19ManageFiltersExecutionStep, AV87ColumnsSelector, AV104Pgmname, AV20TFManagerGivenName, AV21TFManagerGivenName_Sel, AV22TFManagerLastName, AV23TFManagerLastName_Sel, AV26TFManagerEmail, AV27TFManagerEmail_Sel, AV28TFManagerPhone, AV29TFManagerPhone_Sel, AV31TFManagerGender_Sels, AV51isMainManager, AV99IsAuthorized_UserActionBlock, AV100IsAuthorized_UserActionUnblock, AV43IsAuthorized_Display, AV45IsAuthorized_Update, AV47IsAuthorized_Delete, AV41IsAuthorized_ManagerGivenName) ;
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  "Manager Unblocked sucessfully",  "success",  "",  "true",  ""));
         }
         else
         {
            AV69Messages = AV102Trn_Manager.GetMessages();
      ...
      protected void S232( )
      {
         ...
         if ( AV43IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_managerview.aspx", new object[] {UrlEncode(A21ManagerId.ToString()),UrlEncode(A11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ManagerId","OrganisationId","TabCode"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S242( )
      {
         ...
         if ( AV45IsAuthorized_Update )
         {
            CallWebObject(formatLink("trn_manager.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A21ManagerId.ToString()),UrlEncode(A11OrganisationId.ToString())}, new string[] {"Mode","ManagerId","OrganisationId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S252( )
      {
         ...
         if ( AV47IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_manager.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A21ManagerId.ToString()),UrlEncode(A11OrganisationId.ToString())}, new string[] {"Mode","ManagerId","OrganisationId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411544513", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerww.js", "?202542411544516", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_useractionunblock_Title = "Unblock Manager";
         ...
         Dvelop_confirmpanel_useractionblock_Title = "Block Manager Account";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E233E2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV82ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"A21ManagerId","fld":"MANAGERID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"A28ManagerGAMGUID","fld":"MANAGERGAMGUID","hsh":true},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV61OrganisationId","fld":"vORGANISATIONID"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV87ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV104Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV20TFManagerGivenName","fld":"vTFMANAGERGIVENNAME"},{"av":"AV21TFManagerGivenName_Sel","fld":"vTFMANAGERGIVENNAME_SEL"},{"av":"AV22TFManagerLastName","fld":"vTFMANAGERLASTNAME"},{"av":"AV23TFManagerLastName_Sel","fld":"vTFMANAGERLASTNAME_SEL"},{"av":"AV26TFManagerEmail","fld":"vTFMANAGEREMAIL"},{"av":"AV27TFManagerEmail_Sel","fld":"vTFMANAGEREMAIL_SEL"},{"av":"AV28TFManagerPhone","fld":"vTFMANAGERPHONE"},{"av":"AV29TFManagerPhone_Sel","fld":"vTFMANAGERPHONE_SEL"},{"av":"AV31TFManagerGender_Sels","fld":"vTFMANAGERGENDER_SELS"},{"av":"AV51isMainManager","fld":"vISMAINMANAGER","hsh":true},{"av":"AV99IsAuthorized_UserActionBlock","fld":"vISAUTHORIZED_USERACTIONBLOCK","hsh":true},{"av":"AV100IsAuthorized_UserActionUnblock","fld":"vISAUTHORIZED_USERACTIONUNBLOCK","hsh":true},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV41IsAuthorized_ManagerGivenName","fld":"vISAUTHORIZED_MANAGERGIVENNAME","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERTMANAGER'","""{"handler":"E193E2","iparms":[{"av":"A21ManagerId","fld":"MANAGERID","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV105Trn_managerwwds_1_filterfulltext = "";
      ...
      private string lV105Trn_managerwwds_1_filterfulltext ;
...
public class trn_managerww__default : DataStoreHelperBase, IDataStoreHelper
{
                                          ...
                                          Guid AV61OrganisationId )
   {
      ...
      if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV105Trn_managerwwds_1_filterfulltext)) )
      {
         AddWhere(sWhereString, "(( LOWER(ManagerGivenName) like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext)) or ( LOWER(ManagerLastName) like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext)) or ( LOWER(ManagerEmail) like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext)) or ( LOWER(ManagerPhone) like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext)) or ( 'male' like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Male')) or ( 'female' like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Female')) or ( 'other' like '%' || LOWER(:lV105Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Other')))");
      }
      else
      {
         GXv_int10[1] = 1;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       new ParDef("lV105Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
       new ParDef("lV105Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
       new ParDef("lV105Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
       new ParDef("lV105Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
       new ParDef("lV105Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
