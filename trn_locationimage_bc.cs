...
namespace GeneXus.Programs {
   public class trn_locationimage_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void ScanKeyNext1U108( )
      {
         /* Scan next routine */
      ...
      protected void ScanKeyLoad1U108( )
      {
         sMode108 = Gx_mode;
         Gx_mode = "DSP";
         if ( (pr_default.getStatus(8) != 101) )
      ...
      protected void ScanKeyEnd1U108( )
      {
         pr_default.close(8);
      }
      ...
      protected void AddRow1U108( )
      {
         VarsToRow108( bcTrn_LocationImage) ;
      }

      protected void ReadRow1U108( )
      {
         RowToVars108( bcTrn_LocationImage, 1) ;
      }
      ...
      public void VarsToRow108( SdtTrn_LocationImage obj108 )
      {
         obj108.gxTpr_Mode = Gx_mode;
         obj108.gxTpr_Organisationlocationid = A614OrganisationLocationId;
         obj108.gxTpr_Organisationlocationimage = A615OrganisationLocationImage;
         obj108.gxTpr_Organisationlocationimage_gxi = A40000OrganisationLocationImage_GXI;
         obj108.gxTpr_Locationimageid = A613LocationImageId;
         obj108.gxTpr_Locationimageid_Z = Z613LocationImageId;
         obj108.gxTpr_Organisationlocationid_Z = Z614OrganisationLocationId;
         obj108.gxTpr_Organisationlocationimage_gxi_Z = Z40000OrganisationLocationImage_GXI;
         obj108.gxTpr_Mode = Gx_mode;
         return  ;
      }

      public void KeyVarsToRow108( SdtTrn_LocationImage obj108 )
      {
         obj108.gxTpr_Locationimageid = A613LocationImageId;
         return  ;
      }

      public void RowToVars108( SdtTrn_LocationImage obj108 ,
                                int forceLoad )
      {
         Gx_mode = obj108.gxTpr_Mode;
         A614OrganisationLocationId = obj108.gxTpr_Organisationlocationid;
         A615OrganisationLocationImage = obj108.gxTpr_Organisationlocationimage;
         A40000OrganisationLocationImage_GXI = obj108.gxTpr_Organisationlocationimage_gxi;
         A613LocationImageId = obj108.gxTpr_Locationimageid;
         Z613LocationImageId = obj108.gxTpr_Locationimageid_Z;
         Z614OrganisationLocationId = obj108.gxTpr_Organisationlocationid_Z;
         Z40000OrganisationLocationImage_GXI = obj108.gxTpr_Organisationlocationimage_gxi_Z;
         Gx_mode = obj108.gxTpr_Mode;
         return  ;
      }
      ...
      public void Load( )
      {
         ...
         BackMsgLst = context.GX_msglist;
         context.GX_msglist = LclMsgLst;
         RowToVars108( bcTrn_LocationImage, 0) ;
         ScanKeyStart1U108( ) ;
         if ( RcdFound108 == 0 )
         {
            Gx_mode = "INS";
