   ...
   public class wp_productservicestep2 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_productservicestep2.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6WebSessionKey)),UrlEncode(StringUtil.RTrim(AV8PreviousStep)),UrlEncode(StringUtil.BoolToStr(AV7GoingBack)),UrlEncode(StringUtil.BoolToStr(AV70IsPopup)),UrlEncode(AV72FromToolBox_ProductServiceId.ToString()),UrlEncode(StringUtil.RTrim(AV73PageType))}, new string[] {"WebSessionKey","PreviousStep","GoingBack","IsPopup","FromToolBox_ProductServiceId","PageType"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_89", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_89), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB6D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCalltoactionemail_Internalname, AV14CallToActionEmail, StringUtil.RTrim( context.localUtil.Format( AV14CallToActionEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "johndoe@gmail.com", edtavCalltoactionemail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCalltoactionemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WP_ProductServiceStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuseractionadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(89), 2, 0)+","+"null"+");", "Save", bttBtnuseractionadd_Jsonclick, 5, "Save", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOUSERACTIONADD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_ProductServiceStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void STRUP6D0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_89 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_89"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E146D2( )
      {
         ...
         S172 ();
         if (returnInSub) return;
         CallWebObject(formatLink("wp_productservice.aspx", new object[] {UrlEncode(StringUtil.RTrim("Step2")),UrlEncode(StringUtil.RTrim("Step1")),UrlEncode(StringUtil.BoolToStr(true)),UrlEncode(StringUtil.BoolToStr(AV70IsPopup)),UrlEncode(AV72FromToolBox_ProductServiceId.ToString()),UrlEncode(StringUtil.RTrim(AV73PageType))}, new string[] {"PreviousStep","CurrentStep","GoingBack","IsPopup","FromToolBox_ProductServiceId","PageType"}) );
      ...
      protected void E156D2( )
      {
         ...
         if ( AV57CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            if ( StringUtil.StrCmp(AV5WebSession.Get("isLastIndex"), "true") == 0 )
            {
               AV24SDT_CallToAction.Clear();
               gx_BV89 = true;
               if ( AV24SDT_CallToAction.FromJSonString(AV5WebSession.Get("CallToActions"), null) )
               {
                  AV5WebSession.Set("isLastIndex", "false");
                  AV5WebSession.Remove("CallToActions");
               }
            }
      ...
      protected void S182( )
      {
         ...
         if ( AV42Trn_ProductService.Insert() )
         {
            ...
            if ( AV70IsPopup )
            {
               AV5WebSession.Set("NewProductServiceId", AV71ProductServiceId.ToString());
            ...
            {
               AV5WebSession.Set("NotificationMessage", "service Inserted successfully");
      ...
      protected void S202( )
      {
         ...
         if ( AV53IndexToEdit == AV24SDT_CallToAction.Count )
         {
            ...
            AV5WebSession.Set("CallToActions", AV24SDT_CallToAction.ToJSonString(false));
         }
         else
         {
            AV24SDT_CallToAction.RemoveItem(AV53IndexToEdit);
      ...
      protected void E166D2( )
      {
         ...
         returnInSub = false;
         if ( ! GxRegex.IsMatch(AV14CallToActionEmail,"^((\\w+([-+.']\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*)|(\\s*))$") )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Email is incorrect",  "error",  edtavCalltoactionemail_Internalname,  "true",  ""));
      ...
      protected void E176D2( )
      {
         ...
         returnInSub = false;
         if ( ! GxRegex.IsMatch(AV17CallToActionUrl,"(?:https?://|www\\.)[^\\s/$.?#].[^\\s]*") )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "url is incorrect",  "error",  edtavCalltoactionurl_Internalname,  "true",  ""));
            AV10HasValidationErrors = true;
            AssignAttri(sPrefix, false, "AV10HasValidationErrors", AV10HasValidationErrors);
         }
         else
      ...
      protected void E186D2( )
      {
         ...
         returnInSub = false;
         if ( ! GxRegex.IsMatch(AV60PhoneNumber,"\\b\\d{9}\\b") && ! String.IsNullOrEmpty(StringUtil.RTrim( AV60PhoneNumber)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Phone contains 9 digits",  "error",  edtavPhonenumber_Internalname,  "true",  ""));
            AV10HasValidationErrors = true;
            AssignAttri(sPrefix, false, "AV10HasValidationErrors", AV10HasValidationErrors);
         }
         else
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418142073", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_productservicestep2.js", "?202542418142075", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV24SDT_CallToAction = new GXBaseCollection<SdtSDT_CallToAction_SDT_CallToActionItem>( context, "SDT_CallToActionItem", "Comforta_version20");
         ...
         GXt_char2 = "";
         AV42Trn_ProductService = new SdtTrn_ProductService(context);
         AV75SDT_FileUploadData = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         AV51ImageFile = "";
         AV77base64String = "";
         ...
         Combo_locationdynamicformid_Selectedtext_set = "";
         Combo_locationdynamicformid_Selectedvalue_set = "";
         AV96GXV17 = new GXBaseCollection<SdtSDT_LocationDynamicForm_SDT_LocationDynamicFormItem>( context, "SDT_LocationDynamicFormItem", "Comforta_version20");
         GXt_objcol_SdtSDT_LocationDynamicForm_SDT_LocationDynamicFormItem3 = new GXBaseCollection<SdtSDT_LocationDynamicForm_SDT_LocationDynamicFormItem>( context, "SDT_LocationDynamicFormItem", "Comforta_version20");
         AV23LocationDynamicFormId_DPItem = new SdtSDT_LocationDynamicForm_SDT_LocationDynamicFormItem(context);
         AV22Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV98GXV19 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
         GXt_objcol_SdtSDT_Country_SDT_CountryItem4 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
