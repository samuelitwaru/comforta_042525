   ...
   public class prc_restoretrash : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV16Type, context.GetMessage( "Page", "")) == 0 )
         {
            ...
            {
               A523AppVersionId = P00GF2_A523AppVersionId[0];
               A535IsActive = P00GF2_A535IsActive[0];
               /* Using cursor P00GF3 */
               pr_default.execute(1, new Object[] {A523AppVersionId, AV17ItemId});
               while ( (pr_default.getStatus(1) != 101) )
               {
                  GXTGF3 = 0;
                  A516PageId = P00GF3_A516PageId[0];
                  A621IsPageDeleted = P00GF3_A621IsPageDeleted[0];
      ...
      public override void initialize( )
      {
         ...
         P00GF2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00GF2_A535IsActive = new bool[] {false} ;
         A523AppVersionId = Guid.Empty;
         P00GF3_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00GF3_A516PageId = new Guid[] {Guid.Empty} ;
         P00GF3_A621IsPageDeleted = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_restoretrash__default(),
            new Object[][] {
                new Object[] {
               P00GF2_A523AppVersionId, P00GF2_A535IsActive
               }
               , new Object[] {
               P00GF3_A523AppVersionId, P00GF3_A516PageId, P00GF3_A621IsPageDeleted
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private Guid[] P00GF2_A523AppVersionId ;
      private bool[] P00GF2_A535IsActive ;
      private Guid[] P00GF3_A523AppVersionId ;
      private Guid[] P00GF3_A516PageId ;
      private bool[] P00GF3_A621IsPageDeleted ;
...
public class prc_restoretrash__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       Object[] prmP00GF5;
       prmP00GF5 = new Object[] {
       new ParDef("AV17ItemId",GXType.UniqueIdentifier,36,0) ,
       new ParDef("AV12LocationId",GXType.UniqueIdentifier,36,0)
       };
       def= new CursorDef[] {
           new CursorDef("P00GF2", "SELECT AppVersionId, IsActive FROM Trn_AppVersion WHERE IsActive = TRUE ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GF2,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("P00GF3", "SELECT AppVersionId, PageId, IsPageDeleted FROM Trn_AppVersionPage WHERE (AppVersionId = :AppVersionId and PageId = :AV17ItemId) AND (IsPageDeleted = TRUE) ORDER BY AppVersionId, PageId  FOR UPDATE OF Trn_AppVersionPage",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GF3,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("P00GF4", "SAVEPOINT gxupdate;UPDATE Trn_AppVersionPage SET IsPageDeleted=:IsPageDeleted  WHERE AppVersionId = :AppVersionId AND PageId = :PageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00GF4)
          ,new CursorDef("P00GF5", "UPDATE Trn_AppVersion SET IsVersionDeleted=FALSE  WHERE (AppVersionId = :AV17ItemId) AND (LocationId = :AV12LocationId)", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00GF5)
       };
    }
 }
