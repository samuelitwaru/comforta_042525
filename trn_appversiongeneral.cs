   ...
   public class trn_appversiongeneral : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_App Version General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_appversiongeneral.aspx", new object[] {UrlEncode(A523AppVersionId.ToString())}, new string[] {"AppVersionId"}) +"\">") ;
      ...
      {
         return "Trn_App Version General" ;
      }
      ...
      protected void WBBF0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkIsActive_Internalname, "Active", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkIsActive_Internalname, StringUtil.BoolToStr( A535IsActive), "", "Active", 1, chkIsActive.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(34, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,34);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Edit", bttBtnupdate_Jsonclick, 7, "Edit", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11bf1_client"+"'", TempTags, "", 2, "HLP_Trn_AppVersionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12bf1_client"+"'", TempTags, "", 2, "HLP_Trn_AppVersionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTBF2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_App Version General", 0) ;
            context.wjLoc = "";
      ...
      protected void RFBF2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               n11OrganisationId = H00BF2_n11OrganisationId[0];
               A29LocationId = H00BF2_A29LocationId[0];
               n29LocationId = H00BF2_n29LocationId[0];
               A535IsActive = H00BF2_A535IsActive[0];
               AssignAttri(sPrefix, false, "A535IsActive", A535IsActive);
               A13OrganisationName = H00BF2_A13OrganisationName[0];
               AssignAttri(sPrefix, false, "A13OrganisationName", A13OrganisationName);
               A31LocationName = H00BF2_A31LocationName[0];
               AssignAttri(sPrefix, false, "A31LocationName", A31LocationName);
               A524AppVersionName = H00BF2_A524AppVersionName[0];
      ...
      protected void E14BF2( )
      {
         ...
         if ( AV14TempBoolean )
         {
            edtOrganisationName_Link = formatLink("trn_organisationview.aspx", new object[] {UrlEncode(A11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationId","TabCode"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241152518", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_appversiongeneral.js", "?20254241152518", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E11BF1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E12BF1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00BF2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         H00BF2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BF2_n11OrganisationId = new bool[] {false} ;
         H00BF2_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BF2_n29LocationId = new bool[] {false} ;
         H00BF2_A535IsActive = new bool[] {false} ;
         H00BF2_A13OrganisationName = new string[] {""} ;
         H00BF2_A31LocationName = new string[] {""} ;
         H00BF2_A524AppVersionName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversiongeneral__default(),
            new Object[][] {
                new Object[] {
               H00BF2_A523AppVersionId, H00BF2_A11OrganisationId, H00BF2_n11OrganisationId, H00BF2_A29LocationId, H00BF2_n29LocationId, H00BF2_A535IsActive, H00BF2_A13OrganisationName, H00BF2_A31LocationName, H00BF2_A524AppVersionName
               }
            }
         );
         AV15Pgmname = "Trn_AppVersionGeneral";
      ...
      private Guid[] H00BF2_A523AppVersionId ;
      private Guid[] H00BF2_A11OrganisationId ;
      private bool[] H00BF2_n11OrganisationId ;
      private Guid[] H00BF2_A29LocationId ;
      private bool[] H00BF2_n29LocationId ;
      private bool[] H00BF2_A535IsActive ;
      private string[] H00BF2_A13OrganisationName ;
      private string[] H00BF2_A31LocationName ;
      private string[] H00BF2_A524AppVersionName ;
