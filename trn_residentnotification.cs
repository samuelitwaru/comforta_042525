...
namespace GeneXus.Programs {
   public class trn_residentnotification : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtAppNotificationDate_Internalname, "App Notification Date", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtAppNotificationDate_Internalname, context.localUtil.TToC( A489AppNotificationDate, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A489AppNotificationDate, "99/99/9999 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',5,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',5,24,'eng',false,0);"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppNotificationDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAppNotificationDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Trn_ResidentNotification.htm");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtAppNotificationTitle_Internalname, "App Notification Title", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtAppNotificationDescription_Internalname, "App Notification Description", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Multiple line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtAppNotificationTopic_Internalname, "App Notification Topic", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtAppNotificationMetadata_Internalname, "App Notification Metadata", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Multiple line edit */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AssignAttri("", false, "A489AppNotificationDate", context.localUtil.TToC( A489AppNotificationDate, 10, 5, 0, 3, "/", ":", " "));
      ...
      protected void gxLoad_7( Guid A486AppNotificationId )
      {
         ...
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( context.localUtil.TToC( A489AppNotificationDate, 10, 8, 0, 3, "/", ":", " "))+"\""+","+"\""+GXUtil.EncodeJSConstant( A487AppNotificationTitle)+"\""+","+"\""+GXUtil.EncodeJSConstant( A488AppNotificationDescription)+"\""+","+"\""+GXUtil.EncodeJSConstant( A490AppNotificationTopic)+"\""+","+"\""+GXUtil.EncodeJSConstant( A498AppNotificationMetadata)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(4) == 101) )
         {
            AddString( ",") ;
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentnotification.js", "?20254241151486", false, true);
      ...
      public void Valid_Residentnotificationid( )
      {
         ...
         AssignAttri("", false, "A486AppNotificationId", A486AppNotificationId.ToString());
         AssignAttri("", false, "A62ResidentId", A62ResidentId.ToString());
         AssignAttri("", false, "A489AppNotificationDate", context.localUtil.TToC( A489AppNotificationDate, 10, 8, 0, 3, "/", ":", " "));
         AssignAttri("", false, "A487AppNotificationTitle", A487AppNotificationTitle);
         AssignAttri("", false, "A488AppNotificationDescription", A488AppNotificationDescription);
         AssignAttri("", false, "A490AppNotificationTopic", A490AppNotificationTopic);
         AssignAttri("", false, "A498AppNotificationMetadata", A498AppNotificationMetadata);
         ...
         GxWebStd.gx_hidden_field( context, "Z486AppNotificationId", Z486AppNotificationId.ToString());
         GxWebStd.gx_hidden_field( context, "Z62ResidentId", Z62ResidentId.ToString());
         GxWebStd.gx_hidden_field( context, "Z489AppNotificationDate", context.localUtil.TToC( Z489AppNotificationDate, 10, 8, 0, 3, "/", ":", " "));
