...
namespace GeneXus.Programs {
   public class trn_residentpackageview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_residentpackageview.aspx", new object[] {UrlEncode(AV10ResidentPackageId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"ResidentPackageId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_residentpackageview.aspx", new object[] {UrlEncode(AV10ResidentPackageId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"ResidentPackageId","TabCode"})  ;
      }
      ...
      {
         return "Trn_Resident Package View" ;
      }
      ...
      protected void WBAD0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentPackageView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_resident_title_Internalname, "Residents", "", "", lblTrn_resident_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentPackageView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void STARTAD2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Resident Package View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUPAD0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10ResidentPackageId = StringUtil.StrToGuid( cgiGet( "vRESIDENTPACKAGEID"));
      ...
      protected void E12AD2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_ResidentPackage",StringUtil.Trim( A527ResidentPackageId.ToString()),(string)AV14RecordDescription,formatLink("trn_residentpackageview.aspx", new object[] {UrlEncode(A527ResidentPackageId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ResidentPackageId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241202695", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentpackageview.js", "?20254241202696", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Resident Package View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
