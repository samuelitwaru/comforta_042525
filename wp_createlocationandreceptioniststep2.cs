   ...
   public class wp_createlocationandreceptioniststep2 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_createlocationandreceptioniststep2.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6WebSessionKey)),UrlEncode(StringUtil.RTrim(AV8PreviousStep)),UrlEncode(StringUtil.BoolToStr(AV7GoingBack)),UrlEncode(AV63OrganisationId.ToString())}, new string[] {"WebSessionKey","PreviousStep","GoingBack","OrganisationId"}) +"\">") ;
      ...
      protected void E19662( )
      {
         ...
         {
            CallWebObject(formatLink("wp_createlocationandreceptionist.aspx", new object[] {UrlEncode(StringUtil.RTrim("Step2")),UrlEncode(StringUtil.RTrim("Step1")),UrlEncode(StringUtil.BoolToStr(true))}, new string[] {"PreviousStep","CurrentStep","GoingBack","OrganisationId"}) );
      ...
      private void E21662( )
      {
         ...
         while ( AV68GXV1 <= AV19SDT_Receptionists.Count )
         {
            ...
            cmbavGridactiongroup1.addItem("1", StringUtil.Format( "%1;%2", "Edit", "fas fa-pencil", "", "", "", "", "", "", ""), 0);
      ...
      protected void E15662( )
      {
         ...
         S152 ();
         if (returnInSub) return;
         CallWebObject(formatLink("wp_createlocationandreceptionist.aspx", new object[] {UrlEncode(StringUtil.RTrim("Step2")),UrlEncode(StringUtil.RTrim("Step1")),UrlEncode(StringUtil.BoolToStr(true)),UrlEncode(AV63OrganisationId.ToString())}, new string[] {"PreviousStep","CurrentStep","GoingBack","OrganisationId"}) );
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11WizardData", AV11WizardData);
      }
         ...
         if ( AV25isLocationInserted )
         {
            ...
            while ( AV85GXV17 <= AV19SDT_Receptionists.Count )
            {
               ...
               else
               {
                  ...
                  {
                     GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  "Invitation sent successfully",  "success",  "",  "true",  ""));
                  }
                  AV88GXV20 = 1;
            ...
            else
            {
               ...
               if (returnInSub) return;
               AV5WebSession.Remove(AV6WebSessionKey);
               AV5WebSession.Set("NotificationMessage", "Location Inserted successfully");
      ...
      protected void S172( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "First Name", "", "", "", "", "", "", "", ""),  "error",  edtavReceptionistgivenname_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV15ReceptionistLastName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Last Name", "", "", "", "", "", "", "", ""),  "error",  edtavReceptionistlastname_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16ReceptionistEmail)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Email", "", "", "", "", "", "", "", ""),  "error",  edtavReceptionistemail_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV38ReceptionistPhoneNumber)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Receptionist Phone Number", "", "", "", "", "", "", "", ""),  "error",  edtavReceptionistphonenumber_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
      ...
      protected void E17662( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Email is incorrect",  "error",  edtavReceptionistemail_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         /*  Sending Event outputs  */
      ...
      protected void E18662( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Phone contains 9 digits",  "error",  edtavReceptionistphonenumber_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         /*  Sending Event outputs  */
      ...
      protected void wb_table1_34_662( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUseractiondelete_Internalname, "<i class=\"fas fa-trash-can\"></i>", "", "", lblUseractiondelete_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e23661_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, 1, "HLP_WP_CreateLocationAndReceptionistStep2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241816375", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createlocationandreceptioniststep2.js", "?20254241816378", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_btnuseraction1_Title = "Confirm Location";
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         forbiddenHiddens = new GXProperties();
         AV19SDT_Receptionists = new GXBaseCollection<SdtSDT_Receptionists_SDT_ReceptionistsItem>( context, "SDT_ReceptionistsItem", "Comforta_version20");
         AV43UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version20");
         AV44FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version20");
         ...
         AV50Image = "";
         AV66SDT_FileUploadData = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         AV64base64String = "";
         ...
         AV89GXV21 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
