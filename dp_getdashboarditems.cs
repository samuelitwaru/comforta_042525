...
namespace GeneXus.Programs {
   public class dp_getdashboarditems : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm1uhomemodulessdt = new SdtUHomeModulesSDT_UHomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1uhomemodulessdt, 0);
         Gxm1uhomemodulessdt.gxTpr_Optiontitle = "AGB Suppliers";
         ...
         Gxm1uhomemodulessdt = new SdtUHomeModulesSDT_UHomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1uhomemodulessdt, 0);
         Gxm1uhomemodulessdt.gxTpr_Optiontitle = "General Suppliers";
