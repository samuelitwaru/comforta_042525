...
namespace GeneXus.Programs {
   public class trn_organisationtypeww : GXDataArea
   {
      ...
      private void E193I2( )
      {
         ...
         {
            edtOrganisationTypeName_Link = formatLink("trn_organisationtypeview.aspx", new object[] {UrlEncode(A19OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationTypeId","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E113I2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_OrganisationTypeWWFilters")),UrlEncode(StringUtil.RTrim(AV43Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_OrganisationTypeWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void E163I2( )
      {
         ...
         {
            context.PopUp(formatLink("trn_organisationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","OrganisationTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S202( )
      {
         ...
         if ( AV31IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_organisationtypeview.aspx", new object[] {UrlEncode(A19OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationTypeId","TabCode"}) );
      ...
      protected void S212( )
      {
         ...
         if ( AV33IsAuthorized_Update )
         {
            context.PopUp(formatLink("trn_organisationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A19OrganisationTypeId.ToString())}, new string[] {"Mode","OrganisationTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV35IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_organisationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A19OrganisationTypeId.ToString())}, new string[] {"Mode","OrganisationTypeId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411541411", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationtypeww.js", "?202542411541413", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
