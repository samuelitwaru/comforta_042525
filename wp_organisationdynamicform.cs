...
namespace GeneXus.Programs {
   public class wp_organisationdynamicform : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_organisationdynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV59WWPFormType,1,0)),UrlEncode(StringUtil.BoolToStr(AV58WWPFormIsForDynamicValidations))}, new string[] {"WWPFormType","WWPFormIsForDynamicValidations"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vWWPFORMTYPE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV59WWPFormType), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vWWPFORMTYPE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV59WWPFormType), "9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTFWWPFORMVERSIONNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV52TFWWPFormVersionNumber), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFWWPFORMVERSIONNUMBER_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53TFWWPFormVersionNumber_To), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFWWPFORMLATESTVERSIONNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV46TFWWPFormLatestVersionNumber), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFWWPFORMLATESTVERSIONNUMBER_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV47TFWWPFormLatestVersionNumber_To), 4, 0, ".", "")));
      ...
      {
         return formatLink("wp_organisationdynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV59WWPFormType,1,0)),UrlEncode(StringUtil.BoolToStr(AV58WWPFormIsForDynamicValidations))}, new string[] {"WWPFormType","WWPFormIsForDynamicValidations"})  ;
      }
      ...
      {
         return " Trn_Organisation Dynamic Form" ;
      }
      ...
      protected void WBA30( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_OrganisationDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_OrganisationDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTA32( )
      {
         ...
         Form.Meta.addItem("description", " Trn_Organisation Dynamic Form", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUPA30( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV59WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vWWPFORMTYPE"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E19A32( )
      {
         ...
         Form.Caption = " Trn_Organisation Dynamic Form";
      ...
      protected void E15A32( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            {
               AV44TFWWPFormDate = context.localUtil.CToT( Ddo_grid_Filteredtext_get, 2);
               AssignAttri("", false, "AV44TFWWPFormDate", context.localUtil.TToC( AV44TFWWPFormDate, 8, 5, 0, 3, "/", ":", " "));
               AV45TFWWPFormDate_To = context.localUtil.CToT( Ddo_grid_Filteredtextto_get, 2);
               AssignAttri("", false, "AV45TFWWPFormDate_To", context.localUtil.TToC( AV45TFWWPFormDate_To, 8, 5, 0, 3, "/", ":", " "));
      ...
      protected void E12A32( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("WP_OrganisationDynamicFormFilters")),UrlEncode(StringUtil.RTrim(AV71Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV31ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV31ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV31ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("WP_OrganisationDynamicFormFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV31ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV31ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV31ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void S202( )
      {
         ...
         while ( AV98GXV12 <= AV19GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV44TFWWPFormDate = context.localUtil.CToT( AV20GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri("", false, "AV44TFWWPFormDate", context.localUtil.TToC( AV44TFWWPFormDate, 8, 5, 0, 3, "/", ":", " "));
               AV45TFWWPFormDate_To = context.localUtil.CToT( AV20GridStateFilterValue.gxTpr_Valueto, 2);
               AssignAttri("", false, "AV45TFWWPFormDate_To", context.localUtil.TToC( AV45TFWWPFormDate_To, 8, 5, 0, 3, "/", ":", " "));
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV19GridState,  "FILTERFULLTEXT",  "Main filter",  !String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)),  0,  AV13FilterFullText,  AV13FilterFullText,  false,  "",  "") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025424122036", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_organisationdynamicform.js", "?2025424122039", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E21A32","iparms":[{"av":"AV26IsAuthorized_UserActionEdit","fld":"vISAUTHORIZED_USERACTIONEDIT","hsh":true},{"av":"AV25IsAuthorized_UserActionDisplay","fld":"vISAUTHORIZED_USERACTIONDISPLAY","hsh":true},{"av":"AV23IsAuthorized_UserActionCopy","fld":"vISAUTHORIZED_USERACTIONCOPY","hsh":true},{"av":"AV24IsAuthorized_UserActionDelete","fld":"vISAUTHORIZED_USERACTIONDELETE","hsh":true},{"av":"AV27IsAuthorized_UserActionFilledForms","fld":"vISAUTHORIZED_USERACTIONFILLEDFORMS","hsh":true},{"av":"AV28IsAuthorized_UserActionFillOutForm","fld":"vISAUTHORIZED_USERACTIONFILLOUTFORM","hsh":true},{"av":"AV67IsAuthorized_UCopyToLocation","fld":"vISAUTHORIZED_UCOPYTOLOCATION","hsh":true},{"av":"AV68IsAuthorized_UDirectCopyToLocation","fld":"vISAUTHORIZED_UDIRECTCOPYTOLOCATION","hsh":true}]""");
         ...
         setEventMetadata("'DOUSERACTIONINSERT'","""{"handler":"E11A31","iparms":[{"av":"AV59WWPFormType","fld":"vWWPFORMTYPE","pic":"9","hsh":true}]}""");
         setEventMetadata("VORGANISATIONIDFILTER.CONTROLVALUECHANGED","""{"handler":"E18A32","iparms":[{"av":"AV57WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"dynavOrganisationidfilter"},{"av":"AV40OrganisationIdFilter","fld":"vORGANISATIONIDFILTER"}]""");
