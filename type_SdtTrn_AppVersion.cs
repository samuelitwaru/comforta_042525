...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Trn_AppVersion" , Namespace = "Comforta_version20" )]
   [Serializable]
   public class SdtTrn_AppVersion : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtTrn_AppVersion_Page> gxTpr_Page_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtTrn_AppVersion_Page == null )
            {
               gxTv_SdtTrn_AppVersion_Page = new GXBCLevelCollection<SdtTrn_AppVersion_Page>( context, "Trn_AppVersion.Page", "Comforta_version20");
            }
   ...
   [DataContract(Name = @"Trn_AppVersion", Namespace = "Comforta_version20")]
