...
namespace GeneXus.Programs {
   public class prc_loadwwpcontext : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV13DashboardItems = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20");
         ...
         AV14FilteredDashboardItems = new GXBaseCollection<SdtUHomeModulesSDT_UHomeModulesSDTItem>( context, "UHomeModulesSDTItem", "Comforta_version20");
         AV15FooterText = "";
