...
namespace GeneXus.Programs {
   public class prc_updatepagetitle : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A523AppVersionId = P00DO2_A523AppVersionId[0];
            AV15GXLvl8 = 1;
            AV16GXLvl10 = 0;
            /* Using cursor P00DO3 */
            ...
            {
               GXTDO3 = 0;
               A516PageId = P00DO3_A516PageId[0];
               A517PageName = P00DO3_A517PageName[0];
               AV16GXLvl10 = 1;
      ...
      public override void initialize( )
      {
         ...
         P00DO2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         A523AppVersionId = Guid.Empty;
         P00DO3_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00DO3_A516PageId = new Guid[] {Guid.Empty} ;
         P00DO3_A517PageName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_updatepagetitle__default(),
            new Object[][] {
                new Object[] {
               P00DO2_A523AppVersionId
               }
               , new Object[] {
               P00DO3_A523AppVersionId, P00DO3_A516PageId, P00DO3_A517PageName
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00DO2_A523AppVersionId ;
      private Guid[] P00DO3_A523AppVersionId ;
      private Guid[] P00DO3_A516PageId ;
      private string[] P00DO3_A517PageName ;
...
public class prc_updatepagetitle__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00DO2", "SELECT AppVersionId FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DO2,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("P00DO3", "SELECT AppVersionId, PageId, PageName FROM Trn_AppVersionPage WHERE AppVersionId = :AppVersionId and PageId = :AV9PageId ORDER BY AppVersionId, PageId  FOR UPDATE OF Trn_AppVersionPage",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DO3,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("P00DO4", "SAVEPOINT gxupdate;UPDATE Trn_AppVersionPage SET PageName=:PageName  WHERE AppVersionId = :AppVersionId AND PageId = :PageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00DO4)
       };
    }
 }
