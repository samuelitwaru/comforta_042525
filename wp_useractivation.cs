   ...
   public class wp_useractivation : GXDataArea
   {
      ...
      protected void S122( )
      {
         ...
         while ( AV22GXV1 <= AV13GAMErrors.Count )
         {
            ...
            {
               GX_msglist.addItem(StringUtil.Format( "Error: %1", AV14Error.gxTpr_Message, "", "", "", "", "", "", "", ""));
            }
      ...
      protected void wb_table1_35_3W2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRegisteruser_Internalname, "Login", "", "", lblRegisteruser_Jsonclick, "'"+""+"'"+",false,"+"'"+"e143w1_client"+"'", "", "DataDescriptionLogin", 7, "", 1, 1, 0, 0, "HLP_WP_UserActivation.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411542090", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_useractivation.js", "?202542411542094", false, true);
