...
namespace GeneXus.Programs {
   public class prc_getresidentbcfromguid : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A71ResidentGUID = P00G62_A71ResidentGUID[0];
            A11OrganisationId = P00G62_A11OrganisationId[0];
            A29LocationId = P00G62_A29LocationId[0];
            A62ResidentId = P00G62_A62ResidentId[0];
            AV11GXLvl1 = 1;
      ...
      public override void initialize( )
      {
         ...
         P00G62_A71ResidentGUID = new string[] {""} ;
         P00G62_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00G62_A29LocationId = new Guid[] {Guid.Empty} ;
         P00G62_A62ResidentId = new Guid[] {Guid.Empty} ;
         A71ResidentGUID = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getresidentbcfromguid__default(),
            new Object[][] {
                new Object[] {
               P00G62_A71ResidentGUID, P00G62_A11OrganisationId, P00G62_A29LocationId, P00G62_A62ResidentId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00G62_A71ResidentGUID ;
      private Guid[] P00G62_A11OrganisationId ;
      private Guid[] P00G62_A29LocationId ;
      private Guid[] P00G62_A62ResidentId ;
   ...
   public class prc_getresidentbcfromguid__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00G62", "SELECT ResidentGUID, OrganisationId, LocationId, ResidentId FROM Trn_Resident WHERE ResidentGUID = ( RTRIM(LTRIM(:AV8ResidentGUID))) ORDER BY ResidentId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00G62,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
