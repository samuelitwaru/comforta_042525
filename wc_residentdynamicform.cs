   ...
   public class wc_residentdynamicform : GXWebComponent
   {
      ...
      protected void WB7J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnopendiscussion_Internalname, "", "Discussion", bttBtnopendiscussion_Jsonclick, 7, "Discussion", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e117j1_client"+"'", TempTags, "", 2, "HLP_WC_ResidentDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Submit", bttBtnenter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WC_ResidentDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuaresume_Internalname, "", "Resume", bttBtnuaresume_Jsonclick, 7, "Resume", "", StyleString, ClassString, bttBtnuaresume_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e127j1_client"+"'", TempTags, "", 2, "HLP_WC_ResidentDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E147J2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV27ResidentGUID = AV6WebSession.Get("WebViewResidentId");
                  ...
                  if ( ! AV20HasErrors )
                  {
                     ...
                     if ( AV7WWPFormInstance.Success() )
                     {
                        ...
                        else if ( StringUtil.StrCmp(AV8WWPDynamicFormMode, "UPD") == 0 )
                        {
                           ...
                           new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_sendnotification(context ).execute(  "DynamicFormNotification",  "DynamicForms",  "",  "fas fa-pencil-alt NotificationFontIconWarning",  "Form Response Updated",  AV31NotificationDescription,  AV31NotificationDescription,  AV44Formlink,  AV37WWPNotificationMetadataSDT.ToJSonString(false, true),  "",  true) ;
                        }
                        else if ( StringUtil.StrCmp(AV8WWPDynamicFormMode, "DLT") == 0 )
                        {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411442883", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_residentdynamicform.js", "?202542411442885", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/ConfirmPanel/BootstrapConfirmPanelRender.js", "", false, true);
