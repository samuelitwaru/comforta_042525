...
namespace GeneXus.Programs {
   public class wp_applicationdesign : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vCURRENTAPPVERSION", AV58CurrentAppVersion);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vCURRENTAPPVERSION", AV58CurrentAppVersion);
         }
      ...
      protected void WB5C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ucApptoolbox1.SetProperty("Current_Version", AV58CurrentAppVersion);
      ...
      protected void STRUP5C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vCURRENTAPPVERSION"), AV58CurrentAppVersion);
            /* Read saved values. */
      ...
      protected void E125C2( )
      {
         ...
         pr_default.close(2);
         AV64Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         AV65Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
         /* Using cursor H005C5 */
         pr_default.execute(3, new Object[] {AV64Udparg1, AV65Udparg2});
         ...
         AV65Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
         /* Using cursor H005C6 */
         pr_default.execute(4, new Object[] {AV64Udparg1, AV65Udparg2});
         ...
         while ( (pr_default.getStatus(5) != 101) )
         {
            ...
            new prc_getcalltoactionformurl(context ).execute( ref  GXt_char1, ref  A208WWPFormReferenceName, out  GXt_char3) ;
            AssignAttri("", false, "A208WWPFormReferenceName", A208WWPFormReferenceName);
         ...
         AV64Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         /* Using cursor H005C8 */
         pr_default.execute(6, new Object[] {AV64Udparg1});
         ...
         new prc_getappversion(context ).execute( out  AV58CurrentAppVersion, out  AV57SDT_Error) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255129274268", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesign.js", "?20255129274270", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBox1Render.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV58CurrentAppVersion = new SdtSDT_AppVersion(context);
         GX_FocusControl = "";
         Form = new GXWebForm();
         sPrefix = "";
         ClassString = "";
         ...
         AV5BC_Trn_Template = new SdtTrn_Template(context);
         AV64Udparg1 = Guid.Empty;
         AV65Udparg2 = Guid.Empty;
         ...
         AV57SDT_Error = new SdtSDT_Error(context);
         GXt_objcol_SdtTrn_SupplierGen5 = new GXBCCollection<SdtTrn_SupplierGen>( context, "Trn_SupplierGen", "Comforta_version20");
      ...
      private Guid AV64Udparg1 ;
      private Guid AV65Udparg2 ;
      ...
      private SdtSDT_AppVersion AV58CurrentAppVersion ;
      ...
      private SdtSDT_Error AV57SDT_Error ;
...
public class wp_applicationdesign__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       new ParDef("AV64Udparg1",GXType.UniqueIdentifier,36,0) ,
       new ParDef("AV65Udparg2",GXType.UniqueIdentifier,36,0)
       };
       Object[] prmH005C6;
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("H005C8", "SELECT LocationId, MediaId, MediaName FROM Trn_Media WHERE LocationId = :AV64Udparg1 ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005C8,100, GxCacheFrequency.OFF ,true,false )
