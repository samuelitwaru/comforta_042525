...
namespace GeneXus.Programs {
   public class wp_applicationdesign : GXDataArea
   {
      ...
      protected void E125C2( )
      {
         ...
         AV64Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         /* Using cursor H005C7 */
         pr_default.execute(5, new Object[] {AV64Udparg1});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202543014595938", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesign.js", "?202543014595939", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBox1Render.js", "", false, true);
