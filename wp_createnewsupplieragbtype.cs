...
namespace GeneXus.Programs {
   public class wp_createnewsupplieragbtype : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wp_createnewsupplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV11TrnMode)),UrlEncode(AV14SupplierAgbTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultSupplierAgbTypeName))}, new string[] {"TrnMode","SupplierAgbTypeId","DefaultSupplierAgbTypeName"}) +"\">") ;
      ...
      {
         return formatLink("wp_createnewsupplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV11TrnMode)),UrlEncode(AV14SupplierAgbTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV16DefaultSupplierAgbTypeName))}, new string[] {"TrnMode","SupplierAgbTypeId","DefaultSupplierAgbTypeName"})  ;
      }
      ...
      protected void S132( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Type Name", "", "", "", "", "", "", "", ""),  "error",  edtavTrn_supplieragbtype_supplieragbtypename_Internalname,  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241156055", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createnewsupplieragbtype.js", "?20254241156055", false, true);
