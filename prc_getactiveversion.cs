   ...
   public class prc_getactiveversion : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            n29LocationId = P00F62_n29LocationId[0];
            A535IsActive = P00F62_A535IsActive[0];
            A524AppVersionName = P00F62_A524AppVersionName[0];
            A523AppVersionId = P00F62_A523AppVersionId[0];
      ...
      public override void initialize( )
      {
         ...
         P00F62_n29LocationId = new bool[] {false} ;
         P00F62_A535IsActive = new bool[] {false} ;
         P00F62_A524AppVersionName = new string[] {""} ;
         P00F62_A523AppVersionId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getactiveversion__default(),
            new Object[][] {
                new Object[] {
               P00F62_A29LocationId, P00F62_n29LocationId, P00F62_A535IsActive, P00F62_A524AppVersionName, P00F62_A523AppVersionId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P00F62_n29LocationId ;
      private bool[] P00F62_A535IsActive ;
      private string[] P00F62_A524AppVersionName ;
      private Guid[] P00F62_A523AppVersionId ;
   ...
   public class prc_getactiveversion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00F62", "SELECT LocationId, IsActive, AppVersionName, AppVersionId FROM Trn_AppVersion WHERE (LocationId = :AV10Udparg1) AND (IsActive = TRUE) ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00F62,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
