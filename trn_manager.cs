...
namespace GeneXus.Programs {
   public class trn_manager : GXDataArea
   {
      ...
      protected void E12032( )
      {
         ...
         {
            AV13WebSession.Set("NotificationMessage", "Manager Updated successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            AV13WebSession.Set("NotificationMessage", "Manager Deleted successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV13WebSession.Set("NotificationMessage", "Manager Inserted successfully");
         }
      ...
      protected void CheckExtendedTable035( )
      {
         ...
         {
            GX_msglist.addItem("Organisation must have atleast one main Manager", 1, "MANAGERISMAINMANAGER");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "MANAGEREMAIL");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_manager.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7ManagerId.ToString()),UrlEncode(AV8OrganisationId.ToString())}, new string[] {"Gx_mode","ManagerId","OrganisationId"}) +"\">") ;
      ...
      {
         return formatLink("trn_manager.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7ManagerId.ToString()),UrlEncode(AV8OrganisationId.ToString())}, new string[] {"Gx_mode","ManagerId","OrganisationId"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411463158", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_manager.js", "?202542411463161", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
