   ...
   public class wc_notificationgrouping : GXWebComponent
   {
      ...
      private void E159K2( )
      {
         ...
         while ( AV50GXV1 <= AV36SDT_NotificationGroup.Count )
         {
            ...
            AV29NotificationIcon = StringUtil.Format( "<span class=\"%1\">%2</span>", "NotificationBadgeNumber", StringUtil.LTrimStr( (decimal)(((SdtSDT_NotificationGroup_SDT_NotificationGroupItem)(AV36SDT_NotificationGroup.CurrentItem)).gxTpr_Numberofchildnotifications), 4, 0), "", "", "", "", "", "", "");
            AssignAttri(sPrefix, false, edtavNotificationicon_Internalname, AV29NotificationIcon);
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411434692", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_notificationgrouping.js", "?202542411434693", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         sPrefix = "";
         AV60Pgmname = "";
         AV36SDT_NotificationGroup = new GXBaseCollection<SdtSDT_NotificationGroup_SDT_NotificationGroupItem>( context, "SDT_NotificationGroupItem", "Comforta_version20");
         AV38SDT_NotificationGroupCollection = new GXBaseCollection<SdtSDT_NotificationGroup_SDT_NotificationGroupItem>( context, "SDT_NotificationGroupItem", "Comforta_version20");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
