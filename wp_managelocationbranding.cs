...
namespace GeneXus.Programs {
   public class wp_managelocationbranding : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_managelocationbranding.aspx", new object[] {UrlEncode(AV24OrganisationId.ToString()),UrlEncode(AV31LocationId.ToString())}, new string[] {"OrganisationId","LocationId"}) +"\">") ;
      ...
      {
         return formatLink("wp_managelocationbranding.aspx", new object[] {UrlEncode(AV24OrganisationId.ToString()),UrlEncode(AV31LocationId.ToString())}, new string[] {"OrganisationId","LocationId"})  ;
      }
