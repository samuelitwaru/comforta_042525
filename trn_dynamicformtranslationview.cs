...
namespace GeneXus.Programs {
   public class trn_dynamicformtranslationview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_dynamicformtranslationview.aspx", new object[] {UrlEncode(AV10DynamicFormTranslationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"DynamicFormTranslationId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_dynamicformtranslationview.aspx", new object[] {UrlEncode(AV10DynamicFormTranslationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"DynamicFormTranslationId","TabCode"})  ;
      }
      ...
      {
         return "Trn_Dynamic Form Translation View" ;
      }
      ...
      protected void WBBI0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Trn_Dynamic Form Translation", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_DynamicFormTranslationView.htm");
      ...
      protected void STARTBI2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Dynamic Form Translation View", 0) ;
         context.wjLoc = "";
      ...
      protected void RFBI2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A587DynamicFormTranslationId = H00BI2_A587DynamicFormTranslationId[0];
               /* Execute user event: Load */
               E15BI2 ();
      ...
      protected void E13BI2( )
      {
         ...
         {
            A587DynamicFormTranslationId = H00BI3_A587DynamicFormTranslationId[0];
            A588DynamicFormTranslationWWpFormI = H00BI3_A588DynamicFormTranslationWWpFormI[0];
            AV17GXLvl9 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A588DynamicFormTranslationWWpFormI), 6, 0);
      ...
      protected void E14BI2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_DynamicFormTranslation",  StringUtil.Trim( A587DynamicFormTranslationId.ToString())) )
         {
      ...
      protected void E11BI2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicFormTranslation",(short)2,StringUtil.Trim( A587DynamicFormTranslationId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12BI2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicFormTranslation",StringUtil.Trim( A587DynamicFormTranslationId.ToString()),(string)AV14RecordDescription,formatLink("trn_dynamicformtranslationview.aspx", new object[] {UrlEncode(A587DynamicFormTranslationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"DynamicFormTranslationId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241212677", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_dynamicformtranslationview.js", "?20254241212677", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Dynamic Form Translation View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BI2","iparms":[{"av":"A587DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BI2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A587DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00BI2_A587DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00BI3_A587DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         H00BI3_A588DynamicFormTranslationWWpFormI = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_dynamicformtranslationview__default(),
            new Object[][] {
                new Object[] {
               H00BI2_A587DynamicFormTranslationId
               }
               , new Object[] {
               H00BI3_A587DynamicFormTranslationId, H00BI3_A588DynamicFormTranslationWWpFormI
               }
            }
         );
      ...
      private Guid[] H00BI2_A587DynamicFormTranslationId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00BI3_A587DynamicFormTranslationId ;
      private int[] H00BI3_A588DynamicFormTranslationWWpFormI ;
   ...
   public class trn_dynamicformtranslationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00BI2", "SELECT DynamicFormTranslationId FROM Trn_DynamicFormTranslation WHERE DynamicFormTranslationId = :AV10DynamicFormTranslationId ORDER BY DynamicFormTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BI2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00BI3", "SELECT DynamicFormTranslationId, DynamicFormTranslationWWpFormI FROM Trn_DynamicFormTranslation WHERE DynamicFormTranslationId = :AV10DynamicFormTranslationId ORDER BY DynamicFormTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BI3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
