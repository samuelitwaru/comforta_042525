...
namespace GeneXus.Programs {
   public class trn_locationloaddvcombo : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV24GXV1 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
         ...
         A327LocationCountry = "";
         AV28GXV4 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
