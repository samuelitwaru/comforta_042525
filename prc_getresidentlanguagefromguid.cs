...
namespace GeneXus.Programs {
   public class prc_getresidentlanguagefromguid : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A71ResidentGUID = P00G42_A71ResidentGUID[0];
            A603ResidentLanguage = P00G42_A603ResidentLanguage[0];
            A62ResidentId = P00G42_A62ResidentId[0];
            A29LocationId = P00G42_A29LocationId[0];
            A11OrganisationId = P00G42_A11OrganisationId[0];
            AV11GXLvl3 = 1;
            AV10ResidentLanguage = A603ResidentLanguage;
      ...
      public override void initialize( )
      {
         ...
         P00G42_A71ResidentGUID = new string[] {""} ;
         P00G42_A603ResidentLanguage = new string[] {""} ;
         P00G42_A62ResidentId = new Guid[] {Guid.Empty} ;
         P00G42_A29LocationId = new Guid[] {Guid.Empty} ;
         P00G42_A11OrganisationId = new Guid[] {Guid.Empty} ;
         A71ResidentGUID = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getresidentlanguagefromguid__default(),
            new Object[][] {
                new Object[] {
               P00G42_A71ResidentGUID, P00G42_A603ResidentLanguage, P00G42_A62ResidentId, P00G42_A29LocationId, P00G42_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00G42_A71ResidentGUID ;
      private string[] P00G42_A603ResidentLanguage ;
      private Guid[] P00G42_A62ResidentId ;
      private Guid[] P00G42_A29LocationId ;
      private Guid[] P00G42_A11OrganisationId ;
   ...
   public class prc_getresidentlanguagefromguid__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00G42", "SELECT ResidentGUID, ResidentLanguage, ResidentId, LocationId, OrganisationId FROM Trn_Resident WHERE ResidentGUID = ( RTRIM(LTRIM(:AV8ResidentGUID))) ORDER BY ResidentId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00G42,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
