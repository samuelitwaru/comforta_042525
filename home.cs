   ...
   public class home : GXDataArea
   {
      ...
      private void E12132( )
      {
         ...
         while ( AV14GXV1 <= AV6HomeModulesSDT.Count )
         {
            ...
            {
               lblLayoutoptionandtitleoptionicon_Caption = StringUtil.Format( "<i class='CardsMenuIcon %1' style='font-size: 40px'></i>", ((WorkWithPlus.workwithplus_web.SdtHomeModulesSDT_HomeModulesSDTItem)(AV6HomeModulesSDT.CurrentItem)).gxTpr_Optioniconthemeclass, "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411533256", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("home.js", "?202542411533257", false, true);
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV6HomeModulesSDT = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta_version20");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
