   ...
   public class trn_supplierdynamicform_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CONFIRM_1V0( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( IsDlt( ) )
            {
               OnDeleteControls1V109( ) ;
            }
            else
            {
               CheckExtendedTable1V109( ) ;
               if ( AnyError == 0 )
               {
                  ZM1V109( 6) ;
                  ZM1V109( 7) ;
               }
               CloseExtendedTableCursors1V109( ) ;
            }
         }
         if ( AnyError == 0 )
         {
      ...
      protected void ZM1V109( short GX_JID )
      {
      ...
      protected void OnLoadActions1V109( )
      {
      ...
      protected void CheckExtendedTable1V109( )
      {
         standaloneModal( ) ;
      ...
      protected void CloseExtendedTableCursors1V109( )
      {
         pr_default.close(2);
         pr_default.close(3);
      }
      ...
      protected void CheckOptimisticConcurrency1V109( )
      {
         if ( ! IsIns( ) )
         {
      ...
      protected void Insert1V109( )
      {
         ...
         {
            ZM1V109( 0) ;
            CheckOptimisticConcurrency1V109( ) ;
            if ( AnyError == 0 )
            {
               AfterConfirm1V109( ) ;
               if ( AnyError == 0 )
      ...
      protected void DeferredUpdate1V109( )
      {
      }
      ...
      protected void OnDeleteControls1V109( )
      {
         standaloneModal( ) ;
         if ( AnyError == 0 )
         {
      ...
      protected void ScanKeyNext1V109( )
      {
         /* Scan next routine */
      ...
      protected void ScanKeyLoad1V109( )
      {
         sMode109 = Gx_mode;
         Gx_mode = "DSP";
         if ( (pr_default.getStatus(10) != 101) )
      ...
      protected void ScanKeyEnd1V109( )
      {
         pr_default.close(10);
      }

      protected void AfterConfirm1V109( )
      {
         /* After Confirm Rules */
      }

      protected void BeforeInsert1V109( )
      {
         /* Before Insert Rules */
      }

      protected void BeforeUpdate1V109( )
      {
         /* Before Update Rules */
      }

      protected void BeforeDelete1V109( )
      {
         /* Before Delete Rules */
      }

      protected void BeforeComplete1V109( )
      {
         /* Before Complete Rules */
      }

      protected void BeforeValidate1V109( )
      {
         /* Before Validate Rules */
      }

      protected void DisableAttributes1V109( )
      {
      }

      protected void send_integrity_lvl_hashes1V109( )
      {
      }

      protected void AddRow1V109( )
      {
         VarsToRow109( bcTrn_SupplierDynamicForm) ;
      }

      protected void ReadRow1V109( )
      {
         RowToVars109( bcTrn_SupplierDynamicForm, 1) ;
      }

      protected void InitializeNonKey1V109( )
      {
      ...
      public void VarsToRow109( SdtTrn_SupplierDynamicForm obj109 )
      {
         obj109.gxTpr_Mode = Gx_mode;
         obj109.gxTpr_Wwpformlatestversionnumber = A219WWPFormLatestVersionNumber;
         obj109.gxTpr_Wwpformid = A206WWPFormId;
         obj109.gxTpr_Wwpformversionnumber = A207WWPFormVersionNumber;
         obj109.gxTpr_Wwpformreferencename = A208WWPFormReferenceName;
         obj109.gxTpr_Wwpformtitle = A209WWPFormTitle;
         obj109.gxTpr_Wwpformdate = A231WWPFormDate;
         obj109.gxTpr_Wwpformiswizard = A232WWPFormIsWizard;
         obj109.gxTpr_Wwpformresume = A216WWPFormResume;
         obj109.gxTpr_Wwpformresumemessage = A235WWPFormResumeMessage;
         obj109.gxTpr_Wwpformvalidations = A233WWPFormValidations;
         obj109.gxTpr_Wwpforminstantiated = A234WWPFormInstantiated;
         obj109.gxTpr_Wwpformtype = A240WWPFormType;
         obj109.gxTpr_Wwpformsectionrefelements = A241WWPFormSectionRefElements;
         obj109.gxTpr_Wwpformisfordynamicvalidations = A242WWPFormIsForDynamicValidations;
         obj109.gxTpr_Supplierdynamicformid = A616SupplierDynamicFormId;
         obj109.gxTpr_Suppliergenid = A42SupplierGenId;
         obj109.gxTpr_Supplierdynamicformid_Z = Z616SupplierDynamicFormId;
         obj109.gxTpr_Suppliergenid_Z = Z42SupplierGenId;
         obj109.gxTpr_Wwpformid_Z = Z206WWPFormId;
         obj109.gxTpr_Wwpformversionnumber_Z = Z207WWPFormVersionNumber;
         obj109.gxTpr_Wwpformreferencename_Z = Z208WWPFormReferenceName;
         obj109.gxTpr_Wwpformtitle_Z = Z209WWPFormTitle;
         obj109.gxTpr_Wwpformdate_Z = Z231WWPFormDate;
         obj109.gxTpr_Wwpformiswizard_Z = Z232WWPFormIsWizard;
         obj109.gxTpr_Wwpformresume_Z = Z216WWPFormResume;
         obj109.gxTpr_Wwpforminstantiated_Z = Z234WWPFormInstantiated;
         obj109.gxTpr_Wwpformlatestversionnumber_Z = Z219WWPFormLatestVersionNumber;
         obj109.gxTpr_Wwpformtype_Z = Z240WWPFormType;
         obj109.gxTpr_Wwpformsectionrefelements_Z = Z241WWPFormSectionRefElements;
         obj109.gxTpr_Wwpformisfordynamicvalidations_Z = Z242WWPFormIsForDynamicValidations;
         obj109.gxTpr_Mode = Gx_mode;
         return  ;
      }

      public void KeyVarsToRow109( SdtTrn_SupplierDynamicForm obj109 )
      {
         obj109.gxTpr_Supplierdynamicformid = A616SupplierDynamicFormId;
         obj109.gxTpr_Suppliergenid = A42SupplierGenId;
         return  ;
      ...
      public void RowToVars109( SdtTrn_SupplierDynamicForm obj109 ,
                                int forceLoad )
      {
         Gx_mode = obj109.gxTpr_Mode;
         A219WWPFormLatestVersionNumber = obj109.gxTpr_Wwpformlatestversionnumber;
         A206WWPFormId = obj109.gxTpr_Wwpformid;
         A207WWPFormVersionNumber = obj109.gxTpr_Wwpformversionnumber;
         A208WWPFormReferenceName = obj109.gxTpr_Wwpformreferencename;
         A209WWPFormTitle = obj109.gxTpr_Wwpformtitle;
         A231WWPFormDate = obj109.gxTpr_Wwpformdate;
         A232WWPFormIsWizard = obj109.gxTpr_Wwpformiswizard;
         A216WWPFormResume = obj109.gxTpr_Wwpformresume;
         A235WWPFormResumeMessage = obj109.gxTpr_Wwpformresumemessage;
         A233WWPFormValidations = obj109.gxTpr_Wwpformvalidations;
         A234WWPFormInstantiated = obj109.gxTpr_Wwpforminstantiated;
         A240WWPFormType = obj109.gxTpr_Wwpformtype;
         A241WWPFormSectionRefElements = obj109.gxTpr_Wwpformsectionrefelements;
         A242WWPFormIsForDynamicValidations = obj109.gxTpr_Wwpformisfordynamicvalidations;
         A616SupplierDynamicFormId = obj109.gxTpr_Supplierdynamicformid;
         A42SupplierGenId = obj109.gxTpr_Suppliergenid;
         Z616SupplierDynamicFormId = obj109.gxTpr_Supplierdynamicformid_Z;
         Z42SupplierGenId = obj109.gxTpr_Suppliergenid_Z;
         Z206WWPFormId = obj109.gxTpr_Wwpformid_Z;
         Z207WWPFormVersionNumber = obj109.gxTpr_Wwpformversionnumber_Z;
         Z208WWPFormReferenceName = obj109.gxTpr_Wwpformreferencename_Z;
         Z209WWPFormTitle = obj109.gxTpr_Wwpformtitle_Z;
         Z231WWPFormDate = obj109.gxTpr_Wwpformdate_Z;
         Z232WWPFormIsWizard = obj109.gxTpr_Wwpformiswizard_Z;
         Z216WWPFormResume = obj109.gxTpr_Wwpformresume_Z;
         Z234WWPFormInstantiated = obj109.gxTpr_Wwpforminstantiated_Z;
         Z219WWPFormLatestVersionNumber = obj109.gxTpr_Wwpformlatestversionnumber_Z;
         Z240WWPFormType = obj109.gxTpr_Wwpformtype_Z;
         Z241WWPFormSectionRefElements = obj109.gxTpr_Wwpformsectionrefelements_Z;
         Z242WWPFormIsForDynamicValidations = obj109.gxTpr_Wwpformisfordynamicvalidations_Z;
         Gx_mode = obj109.gxTpr_Mode;
         return  ;
      }
      ...
      public void Load( )
      {
         ...
         BackMsgLst = context.GX_msglist;
         context.GX_msglist = LclMsgLst;
         RowToVars109( bcTrn_SupplierDynamicForm, 0) ;
         ScanKeyStart1V109( ) ;
         if ( RcdFound109 == 0 )
         {
            Gx_mode = "INS";
