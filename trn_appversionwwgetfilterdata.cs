...
namespace GeneXus.Programs {
   public class trn_appversionwwgetfilterdata : GXProcedure
   {
      ...
      protected void S121( )
      {
         ...
         {
            BRKE62 = false;
            A524AppVersionName = P00E62_A524AppVersionName[0];
            A535IsActive = P00E62_A535IsActive[0];
            A523AppVersionId = P00E62_A523AppVersionId[0];
            AV24count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00E62_A524AppVersionName[0], A524AppVersionName) == 0 ) )
            {
               BRKE62 = false;
               A523AppVersionId = P00E62_A523AppVersionId[0];
      ...
      public override void initialize( )
      {
         ...
         A524AppVersionName = "";
         P00E62_A524AppVersionName = new string[] {""} ;
         P00E62_A535IsActive = new bool[] {false} ;
         P00E62_A523AppVersionId = new Guid[] {Guid.Empty} ;
         A523AppVersionId = Guid.Empty;
         AV19Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionwwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00E62_A524AppVersionName, P00E62_A535IsActive, P00E62_A523AppVersionId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00E62_A524AppVersionName ;
      private bool[] P00E62_A535IsActive ;
      private Guid[] P00E62_A523AppVersionId ;
   ...
   public class trn_appversionwwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00E62(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] );
         }
