   ...
   public class trn_organisation : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel16"+"_"+"ORGANISATIONPHONE") == 0 )
         {
            ...
            GX16ASAORGANISATIONPHONE01102( A361OrganisationPhoneCode, A362OrganisationPhoneNumber) ;
            return  ;
         }
      ...
      protected void E13012( )
      {
         ...
         {
            AV12WebSession.Set("NotificationMessage", "Organisation Updated successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "Organisation Deleted successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "Organisation Inserted successfully");
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_organisation.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7OrganisationId.ToString())}, new string[] {"Gx_mode","OrganisationId"}) +"\">") ;
      ...
      {
         return formatLink("trn_organisation.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7OrganisationId.ToString())}, new string[] {"Gx_mode","OrganisationId"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411463924", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisation.js", "?202542411463926", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void GX16ASAORGANISATIONPHONE01102( string A361OrganisationPhoneCode ,
      ...
      public override void initialize( )
      {
         ...
         T000119_A509OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisation__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000119_A509OrganisationDynamicFormId, T000119_A11OrganisationId
               }
               , new Object[] {
      ...
      private Guid[] T000119_A509OrganisationDynamicFormId ;
