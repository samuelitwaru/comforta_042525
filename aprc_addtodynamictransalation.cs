...
namespace GeneXus.Programs {
   public class aprc_addtodynamictransalation : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A580DynamicTranslationPrimaryKey = P00DU2_A580DynamicTranslationPrimaryKey[0];
            A579DynamicTranslationTrnName = P00DU2_A579DynamicTranslationTrnName[0];
            A581DynamicTranslationAttributeNam = P00DU2_A581DynamicTranslationAttributeNam[0];
            A582DynamicTranslationEnglish = P00DU2_A582DynamicTranslationEnglish[0];
            A583DynamicTranslationDutch = P00DU2_A583DynamicTranslationDutch[0];
            A578DynamicTranslationId = P00DU2_A578DynamicTranslationId[0];
            AV16GXLvl11 = 1;
            AV17GXV1 = 1;
      ...
      protected void S111( )
      {
         ...
         if ( StringUtil.StrCmp(AV9Language, "English") == 0 )
         {
            ...
            new prc_translatelanguage(context ).execute(  AV12LanguageCode,  "nl",  AV11Attribute.gxTpr_Attributevalue, out  GXt_char1) ;
         ...
         else if ( StringUtil.StrCmp(AV9Language, "Dutch") == 0 )
         {
            ...
            new prc_translatelanguage(context ).execute(  AV12LanguageCode,  "en",  AV11Attribute.gxTpr_Attributevalue, out  GXt_char1) ;
      ...
      public override void initialize( )
      {
         AV9Language = "";
         AV12LanguageCode = "";
         P00DU2_A580DynamicTranslationPrimaryKey = new Guid[] {Guid.Empty} ;
         P00DU2_A579DynamicTranslationTrnName = new string[] {""} ;
         P00DU2_A581DynamicTranslationAttributeNam = new string[] {""} ;
         P00DU2_A582DynamicTranslationEnglish = new string[] {""} ;
         P00DU2_A583DynamicTranslationDutch = new string[] {""} ;
         P00DU2_A578DynamicTranslationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprc_addtodynamictransalation__default(),
            new Object[][] {
                new Object[] {
               P00DU2_A580DynamicTranslationPrimaryKey, P00DU2_A579DynamicTranslationTrnName, P00DU2_A581DynamicTranslationAttributeNam, P00DU2_A582DynamicTranslationEnglish, P00DU2_A583DynamicTranslationDutch, P00DU2_A578DynamicTranslationId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private Guid[] P00DU2_A580DynamicTranslationPrimaryKey ;
      private string[] P00DU2_A579DynamicTranslationTrnName ;
      private string[] P00DU2_A581DynamicTranslationAttributeNam ;
      private string[] P00DU2_A582DynamicTranslationEnglish ;
      private string[] P00DU2_A583DynamicTranslationDutch ;
      private Guid[] P00DU2_A578DynamicTranslationId ;
...
public class aprc_addtodynamictransalation__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00DU2", "SELECT DynamicTranslationPrimaryKey, DynamicTranslationTrnName, DynamicTranslationAttributeNam, DynamicTranslationEnglish, DynamicTranslationDutch, DynamicTranslationId FROM Trn_DynamicTranslation WHERE (DynamicTranslationPrimaryKey = :AV8SDT_T_1Transaction_1Primar) AND (DynamicTranslationTrnName = ( :AV8SDT_TrnAttributes__Trnname)) ORDER BY DynamicTranslationId  FOR UPDATE OF Trn_DynamicTranslation",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DU2,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("P00DU3", "SAVEPOINT gxupdate;UPDATE Trn_DynamicTranslation SET DynamicTranslationEnglish=:DynamicTranslationEnglish, DynamicTranslationDutch=:DynamicTranslationDutch  WHERE DynamicTranslationId = :DynamicTranslationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00DU3)
          ,new CursorDef("P00DU4", "SAVEPOINT gxupdate;INSERT INTO Trn_DynamicTranslation(DynamicTranslationId, DynamicTranslationTrnName, DynamicTranslationPrimaryKey, DynamicTranslationAttributeNam, DynamicTranslationEnglish, DynamicTranslationDutch) VALUES(:DynamicTranslationId, :DynamicTranslationTrnName, :DynamicTranslationPrimaryKey, :DynamicTranslationAttributeNam, :DynamicTranslationEnglish, :DynamicTranslationDutch);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00DU4)
       };
    }
 }
