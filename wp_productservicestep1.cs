   ...
   public class wp_productservicestep1 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_productservicestep1.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV25WebSessionKey)),UrlEncode(StringUtil.RTrim(AV12PreviousStep)),UrlEncode(StringUtil.BoolToStr(AV10GoingBack)),UrlEncode(StringUtil.BoolToStr(AV52IsPopup)),UrlEncode(AV53FromToolBox_ProductServiceId.ToString()),UrlEncode(StringUtil.RTrim(AV54PageType))}, new string[] {"WebSessionKey","PreviousStep","GoingBack","IsPopup","FromToolBox_ProductServiceId","PageType"}) +"\">") ;
      ...
      protected void WB6C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProductserviceimagetext_Internalname, "Images", "", "", lblProductserviceimagetext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_WP_ProductServiceStep1.htm");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynavProductservicegroup_Internalname, "Delivered By", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
      ...
      protected void wb_table1_63_6C2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_suppliergenid_Internalname, "Supplier", "", "", lblTextblockcombo_suppliergenid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WP_ProductServiceStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
      ...
      protected void wb_table2_80_6C2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, Productservicedescription_Internalname, "Description", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void GXDSVvPRODUCTSERVICEGROUP_data6C2( )
      {
         ...
         gxdynajaxctrldescr.Add("Select Service Delivery");
      ...
      protected void E146C2( )
      {
         ...
         {
            cmbavProductserviceclass.removeItem("My Services");
            cmbavProductserviceclass.removeItem("My Living");
         }
         else if ( StringUtil.StrCmp(AV54PageType, "MyService") == 0 )
         {
            cmbavProductserviceclass.removeItem("My Care");
            cmbavProductserviceclass.removeItem("My Living");
         }
      ...
      protected void E166C2( )
      {
         ...
         if ( (Guid.Empty==AV53FromToolBox_ProductServiceId) )
         {
            ...
            if ( AV31CheckRequiredFieldsResult && ! AV11HasValidationErrors )
            {
               ...
               S182 ();
               if (returnInSub) return;
               CallWebObject(formatLink("wp_productservice.aspx", new object[] {UrlEncode(StringUtil.RTrim("Step1")),UrlEncode(StringUtil.RTrim("Step2")),UrlEncode(StringUtil.BoolToStr(false)),UrlEncode(StringUtil.BoolToStr(AV52IsPopup)),UrlEncode(AV53FromToolBox_ProductServiceId.ToString()),UrlEncode(StringUtil.RTrim(AV54PageType))}, new string[] {"PreviousStep","CurrentStep","GoingBack","IsPopup","FromToolBox_ProductServiceId","PageType"}) );
         ...
         else
         {
            ...
            if ( AV31CheckRequiredFieldsResult && ! AV11HasValidationErrors )
            {
               ...
               S182 ();
               if (returnInSub) return;
               CallWebObject(formatLink("wp_productservice.aspx", new object[] {UrlEncode(StringUtil.RTrim("Step1")),UrlEncode(StringUtil.RTrim("Step2")),UrlEncode(StringUtil.BoolToStr(false)),UrlEncode(StringUtil.BoolToStr(AV52IsPopup)),UrlEncode(AV53FromToolBox_ProductServiceId.ToString())}, new string[] {"PreviousStep","CurrentStep","GoingBack","IsPopup","FromToolBox_ProductServiceId","PageType"}) );
               context.wjLocDisableFrm = 1;
            }
         }
         /*  Sending Event outputs  */
      ...
      protected void E136C2( )
      {
         ...
         {
            context.PopUp(formatLink("wp_createnewgeneralsupplier.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(AV21SupplierGenId.ToString())}, new string[] {"TrnMode","SupplierGenId"}) , new Object[] {});
         }
      ...
      protected void S172( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Location", "", "", "", "", "", "", "", ""),  "error",  dynavLocationid_Internalname,  "true",  ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV17ProductServiceName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Name", "", "", "", "", "", "", "", ""),  "error",  edtavProductservicename_Internalname,  "true",  ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "Service name already exist",  "error",  edtavProductservicename_Internalname,  "true",  ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S132( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A601SG_LocationSupplierLocationId = H006C3_A601SG_LocationSupplierLocationId[0];
            n601SG_LocationSupplierLocationId = H006C3_n601SG_LocationSupplierLocationId[0];
      ...
      protected void S152( )
      {
         ...
         else if ( ! AV48noFilterGen && ( StringUtil.StrCmp(AV14ProductServiceGroup, "Supplier") == 0 ) )
         {
            ...
            while ( (pr_default.getStatus(8) != 101) )
            {
               ...
               A601SG_LocationSupplierLocationId = H006C10_A601SG_LocationSupplierLocationId[0];
               n601SG_LocationSupplierLocationId = H006C10_n601SG_LocationSupplierLocationId[0];
      ...
      protected void S192( )
      {
         ...
         if ( ( AV51GAMUser.checkrole("Organisation Manager") || AV51GAMUser.checkrole("Root Admin") ) && (Guid.Empty==AV34LocationId) )
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Location", "", "", "", "", "", "", "", ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV17ProductServiceName)) )
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Name", "", "", "", "", "", "", "", ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV18ProductServiceTileName)) )
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "App Tile Name", "", "", "", "", "", "", "", ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV40ProductServiceClass)) )
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Category", "", "", "", "", "", "", "", ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
         }
         ...
         while ( (pr_default.getStatus(13) != 101) )
         {
            ...
            GX_msglist.addItem(StringUtil.Format( "Service name Already exists", "Name", "", "", "", "", "", "", "", ""));
            AV31CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV31CheckRequiredFieldsResult", AV31CheckRequiredFieldsResult);
      ...
      protected void wb_table2_80_6C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavNofiltergen_Internalname, StringUtil.BoolToStr( AV48noFilterGen), "", "no Filter Gen", 1, chkavNofiltergen.Enabled, "true", "Preferred", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(86, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,86);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void wb_table1_63_6C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavNofilteragb_Internalname, StringUtil.BoolToStr( AV47noFilterAgb), "", "no Filter Agb", 1, chkavNofilteragb.Enabled, "true", "Preferred", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(69, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,69);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418132170", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_productservicestep1.js", "?202542418132174", false, true);
         context.AddJavascriptSource("UserControls/UC_CustomImageUploadRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         AV23UploadedFiles = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         AV55FilesToUpdate = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         ...
         H006C3_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         H006C3_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         ...
         H006C10_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         H006C10_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_productservicestep1__default(),
            new Object[][] {
               ...
               , new Object[] {
               H006C3_A602SG_LocationSupplierOrganisatio, H006C3_n602SG_LocationSupplierOrganisatio, H006C3_A601SG_LocationSupplierLocationId, H006C3_n601SG_LocationSupplierLocationId, H006C3_A584ActiveAppVersionId, H006C3_n584ActiveAppVersionId, H006C3_A598PublishedActiveAppVersionId, H006C3_n598PublishedActiveAppVersionId, H006C3_A42SupplierGenId, H006C3_A44SupplierGenCompanyName
               }
               , new Object[] {
               ...
               , new Object[] {
               H006C10_A602SG_LocationSupplierOrganisatio, H006C10_n602SG_LocationSupplierOrganisatio, H006C10_A601SG_LocationSupplierLocationId, H006C10_n601SG_LocationSupplierLocationId, H006C10_A584ActiveAppVersionId, H006C10_n584ActiveAppVersionId, H006C10_A598PublishedActiveAppVersionId, H006C10_n598PublishedActiveAppVersionId, H006C10_A42SupplierGenId, H006C10_A44SupplierGenCompanyName
               }
               , new Object[] {
      ...
      private Guid[] H006C3_A601SG_LocationSupplierLocationId ;
      private bool[] H006C3_n601SG_LocationSupplierLocationId ;
      ...
      private Guid[] H006C10_A601SG_LocationSupplierLocationId ;
      private bool[] H006C10_n601SG_LocationSupplierLocationId ;
