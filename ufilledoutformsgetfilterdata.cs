...
namespace GeneXus.Programs {
   ...
   public class ufilledoutformsgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A206WWPFormId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV53Ufilledoutformsds_8_tfwwpuserextendedfullname_sel)) && ! ( StringUtil.StrCmp(AV53Ufilledoutformsds_8_tfwwpuserextendedfullname_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV53Ufilledoutformsds_8_tfwwpuserextendedfullname_sel, "<#Empty#>") == 0 )
         {
