...
namespace GeneXus.Programs {
   public class wp_provisionedappdashboard : GXDataArea
   {
      ...
      protected void gxgrFreestylegrid1_refresh_invoke( )
      {
         ...
         AV27ResidentPackageId = StringUtil.StrToGuid( GetPar( "ResidentPackageId"));
         A11OrganisationId = StringUtil.StrToGuid( GetPar( "OrganisationId"));
         ajax_req_read_hidden_sdt(GetNextPar( ), AV44WWPContext);
         AV72Udparg2 = StringUtil.StrToGuid( GetPar( "Udparg2"));
         A29LocationId = StringUtil.StrToGuid( GetPar( "LocationId"));
         AV73Udparg3 = StringUtil.StrToGuid( GetPar( "Udparg3"));
         ...
         AV75Udparg4 = StringUtil.StrToGuid( GetPar( "Udparg4"));
         ...
         AV68Udparg1 = StringUtil.StrToGuid( GetPar( "Udparg1"));
         ...
         AV31IsAuthorized_SDT_Residents = StringUtil.StrToBool( GetPar( "IsAuthorized_SDT_Residents"));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrFreestylegrid1_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV72Udparg2, A29LocationId, AV73Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV75Udparg4, A527ResidentPackageId, A528SG_LocationId, AV68Udparg1, A531ResidentPackageName, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents) ;
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         A527ResidentPackageId = StringUtil.StrToGuid( GetPar( "ResidentPackageId"));
         n527ResidentPackageId = false;
         ajax_req_read_hidden_sdt(GetNextPar( ), AV28SDT_Residents);
         AV33IsAuthorized_Delete = StringUtil.StrToBool( GetPar( "IsAuthorized_Delete"));
         AV31IsAuthorized_SDT_Residents = StringUtil.StrToBool( GetPar( "IsAuthorized_SDT_Residents"));
         AV68Udparg1 = StringUtil.StrToGuid( GetPar( "Udparg1"));
         setAjaxCallMode();
         ...
         gxgrGrid_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV72Udparg2, A29LocationId, AV73Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV75Udparg4, A527ResidentPackageId, AV28SDT_Residents, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents, AV68Udparg1) ;
         AddString( context.getJSONResponse( )) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vWWPCONTEXT", AV44WWPContext);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vWWPCONTEXT", AV44WWPContext);
         }
         GxWebStd.gx_hidden_field( context, "gxhash_vWWPCONTEXT", GetSecureSignedToken( "", AV44WWPContext, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG2", AV72Udparg2.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG2", GetSecureSignedToken( "", AV72Udparg2, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG3", AV73Udparg3.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG3", GetSecureSignedToken( "", AV73Udparg3, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG4", AV75Udparg4.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG4", GetSecureSignedToken( "", AV75Udparg4, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG1", AV68Udparg1.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG1", GetSecureSignedToken( "", AV68Udparg1, context));
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_SDT_RESIDENTS", AV31IsAuthorized_SDT_Residents);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SDT_RESIDENTS", GetSecureSignedToken( "", AV31IsAuthorized_SDT_Residents, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "Sdt_residents", AV28SDT_Residents);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("Sdt_residents", AV28SDT_Residents);
         }
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vRESIDENTPACKAGEID_DATA", AV35ResidentPackageId_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vRESIDENTPACKAGEID_DATA", AV35ResidentPackageId_Data);
         }
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSDT_RESIDENTS", AV28SDT_Residents);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSDT_RESIDENTS", AV28SDT_Residents);
         }
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV33IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV33IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_SDT_RESIDENTS", AV31IsAuthorized_SDT_Residents);
         ...
         GxWebStd.gx_hidden_field( context, "subFreestylegrid1_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subFreestylegrid1_Recordcount), 5, 0, ".", "")));
      ...
      {
         return "WP_Provisioned App Dashboard" ;
      }
      ...
      protected void WBBM0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCardlefticon1_icon_Internalname, "<i class='ProgressCardIconBaseColor fas fa-mobile-alt' style='font-size: 50px'></i>", "", "", lblCardlefticon1_icon_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_WP_ProvisionedAppDashboard.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCardlefticon1_description_Internalname, "Provisioned App version", "", "", lblCardlefticon1_description_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockDashboardDescriptionCard", 0, "", 1, 1, 0, 0, "HLP_WP_ProvisionedAppDashboard.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavCardlefticon1_value_Internalname, "Card Left Icon1_Value", "gx-form-item TextBlockDashboardDescriptionCardLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'" + sGXsfl_31_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCardlefticon1_value_Internalname, AV26CardLeftIcon1_Value, StringUtil.RTrim( context.localUtil.Format( AV26CardLeftIcon1_Value, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCardlefticon1_value_Jsonclick, 0, "TextBlockDashboardDescriptionCard", "", "", "", "", 1, edtavCardlefticon1_value_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_ProvisionedAppDashboard.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_24_BM2( true) ;
         }
         else
         {
            wb_table1_24_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 31 )
         {
            ...
            ucCombo_residentpackageid.SetProperty("DropDownOptionsData", AV35ResidentPackageId_Data);
         ...
         if ( wbEnd == 84 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavResidentpackageid_Internalname, AV27ResidentPackageId.ToString(), AV27ResidentPackageId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,108);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResidentpackageid_Jsonclick, 0, "Attribute", "", "", "", "", edtavResidentpackageid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_ProvisionedAppDashboard.htm");
            wb_table2_109_BM2( true) ;
         }
         else
         {
            wb_table2_109_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table2_109_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_114_BM2( true) ;
         }
         else
         {
            wb_table3_114_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table3_114_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_119_BM2( true) ;
         }
         else
         {
            wb_table4_119_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table4_119_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table5_124_BM2( true) ;
         }
         else
         {
            wb_table5_124_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table5_124_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
      ...
      protected void STARTBM2( )
      {
         ...
         Form.Meta.addItem("description", "WP_Provisioned App Dashboard", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "FREESTYLEGRID1.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV23Cardcomponent1_Value = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavCardcomponent1_value_Internalname), ".", ","), 18, MidpointRounding.ToEven));
                              AssignAttri("", false, edtavCardcomponent1_value_Internalname, StringUtil.LTrimStr( (decimal)(AV23Cardcomponent1_Value), 12, 0));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                           ...
                           else if ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 )
                           {
                              ...
                              SubsflControlProps_845( ) ;
                              AV48GXV1 = (int)(nGXsfl_84_idx+GRID_nFirstRecordOnPage);
                              if ( ( AV28SDT_Residents.Count >= AV48GXV1 ) && ( AV48GXV1 > 0 ) )
                              {
                                 AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1));
                                 AV29AccountStatus = cgiGet( edtavAccountstatus_Internalname);
                                 AssignAttri("", false, edtavAccountstatus_Internalname, AV29AccountStatus);
                                 cmbavActiongroup.Name = cmbavActiongroup_Internalname;
                                 cmbavActiongroup.CurrentValue = cgiGet( cmbavActiongroup_Internalname);
                                 AV32ActionGroup = (short)(Math.Round(NumberUtil.Val( cgiGet( cmbavActiongroup_Internalname), "."), 18, MidpointRounding.ToEven));
                                 AssignAttri("", false, cmbavActiongroup_Internalname, StringUtil.LTrimStr( (decimal)(AV32ActionGroup), 4, 0));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void gxgrFreestylegrid1_refresh( int subGrid_Rows ,
                                                 Guid AV27ResidentPackageId ,
                                                 Guid A11OrganisationId ,
                                                 GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV44WWPContext ,
                                                 Guid AV72Udparg2 ,
                                                 Guid A29LocationId ,
                                                 Guid AV73Udparg3 ,
                                                 Guid A62ResidentId ,
                                                 ...
                                                 bool AV31IsAuthorized_SDT_Residents )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       Guid AV75Udparg4 ,
                                       Guid A527ResidentPackageId ,
                                       GXBaseCollection<SdtSDT_Resident> AV28SDT_Residents ,
                                       bool AV33IsAuthorized_Delete ,
                                       bool AV31IsAuthorized_SDT_Residents ,
                                       Guid AV68Udparg1 )
      {
      ...
      protected void RFBM5( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Execute user event: Grid.Load */
            E15BM5 ();
            if ( ( subGrid_Islastpage == 0 ) && ( GRID_nCurrentRecord > 0 ) && ( GRID_nGridOutOfScope == 0 ) && ( nGXsfl_84_idx == 1 ) )
            {
               GRID_nCurrentRecord = 0;
      ...
      protected void send_integrity_lvl_hashesBM5( )
      {
      }
      ...
      {
         return AV28SDT_Residents.Count ;
      }
      ...
      protected void STRUPBM0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "Sdt_residents"), AV28SDT_Residents);
            ajax_req_read_hidden_sdt(cgiGet( "vRESIDENTPACKAGEID_DATA"), AV35ResidentPackageId_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vSDT_RESIDENTS"), AV28SDT_Residents);
            /* Read saved values. */
            ...
            subFreestylegrid1_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( "subFreestylegrid1_Recordcount"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            nRC_GXsfl_84 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "nRC_GXsfl_84"), ".", ","), 18, MidpointRounding.ToEven));
            nGXsfl_84_fel_idx = 0;
            while ( nGXsfl_84_fel_idx < nRC_GXsfl_84 )
            {
               nGXsfl_84_fel_idx = ((subGrid_Islastpage==1)&&(nGXsfl_84_fel_idx+1>subGrid_fnc_Recordsperpage( )) ? 1 : nGXsfl_84_fel_idx+1);
               sGXsfl_84_fel_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_fel_idx), 4, 0), 4, "0");
               SubsflControlProps_fel_845( ) ;
               AV48GXV1 = (int)(nGXsfl_84_fel_idx+GRID_nFirstRecordOnPage);
               if ( ( AV28SDT_Residents.Count >= AV48GXV1 ) && ( AV48GXV1 > 0 ) )
               {
                  AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1));
                  AV29AccountStatus = cgiGet( edtavAccountstatus_Internalname);
            ...
            AV26CardLeftIcon1_Value = cgiGet( edtavCardlefticon1_value_Internalname);
            AssignAttri("", false, "AV26CardLeftIcon1_Value", AV26CardLeftIcon1_Value);
            if ( StringUtil.StrCmp(cgiGet( edtavResidentpackageid_Internalname), "") == 0 )
            {
               AV27ResidentPackageId = Guid.Empty;
               AssignAttri("", false, "AV27ResidentPackageId", AV27ResidentPackageId.ToString());
            }
            else
            {
               try
               {
                  AV27ResidentPackageId = StringUtil.StrToGuid( cgiGet( edtavResidentpackageid_Internalname));
                  AssignAttri("", false, "AV27ResidentPackageId", AV27ResidentPackageId.ToString());
               }
               catch ( Exception  )
               {
      ...
      protected void E12BM2( )
      {
         /* Start Routine */
         returnInSub = false;
         GXt_guid1 = AV24LocationId;
         new prc_getuserlocationid(context ).execute( out  GXt_guid1) ;
         AV24LocationId = GXt_guid1;
         AssignAttri("", false, "AV24LocationId", AV24LocationId.ToString());
         GXt_char2 = AV26CardLeftIcon1_Value;
         new prc_getactiveversion(context ).execute( out  GXt_char2) ;
         AV26CardLeftIcon1_Value = GXt_char2;
         AssignAttri("", false, "AV26CardLeftIcon1_Value", AV26CardLeftIcon1_Value);
         ...
         subGrid_Rows = 0;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         GXt_boolean3 = AV31IsAuthorized_SDT_Residents;
         ...
         AV31IsAuthorized_SDT_Residents = GXt_boolean3;
         AssignAttri("", false, "AV31IsAuthorized_SDT_Residents", AV31IsAuthorized_SDT_Residents);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SDT_RESIDENTS", GetSecureSignedToken( "", AV31IsAuthorized_SDT_Residents, context));
         GXt_boolean3 = AV31IsAuthorized_SDT_Residents;
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_residentview_Execute", out  GXt_boolean3) ;
         AV31IsAuthorized_SDT_Residents = GXt_boolean3;
      ...
      protected void E13BM2( )
      {
         ...
         AssignProp("", false, edtavAccountstatus_Internalname, "Columnheaderclass", edtavAccountstatus_Columnheaderclass, !bGXsfl_84_Refreshing);
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV28SDT_Residents", AV28SDT_Residents);
      }
      ...
      private void E14BM2( )
      {
         ...
         returnInSub = false;
         AV68Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         /* Using cursor H00BM2 */
         pr_default.execute(0, new Object[] {AV68Udparg1});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A527ResidentPackageId = H00BM2_A527ResidentPackageId[0];
            n527ResidentPackageId = H00BM2_n527ResidentPackageId[0];
            A528SG_LocationId = H00BM2_A528SG_LocationId[0];
            A531ResidentPackageName = H00BM2_A531ResidentPackageName[0];
            AV23Cardcomponent1_Value = 0;
            AssignAttri("", false, edtavCardcomponent1_value_Internalname, StringUtil.LTrimStr( (decimal)(AV23Cardcomponent1_Value), 12, 0));
            /* Using cursor H00BM3 */
            pr_default.execute(1, new Object[] {n527ResidentPackageId, A527ResidentPackageId});
            while ( (pr_default.getStatus(1) != 101) )
            {
               AV23Cardcomponent1_Value = (long)(AV23Cardcomponent1_Value+1);
               AssignAttri("", false, edtavCardcomponent1_value_Internalname, StringUtil.LTrimStr( (decimal)(AV23Cardcomponent1_Value), 12, 0));
               lblCardcomponent1_icon_Fontname = "fas fa-file";
               pr_default.readNext(1);
            }
            pr_default.close(1);
            AV25ResidentPackageName = A531ResidentPackageName;
            lblCardcomponent1_description_Caption = AV25ResidentPackageName;
            /* Load Method */
            if ( wbStart != -1 )
            {
               wbStart = 31;
      ...
      protected void E11BM2( )
      {
         ...
         returnInSub = false;
         AV27ResidentPackageId = StringUtil.StrToGuid( Combo_residentpackageid_Selectedvalue_get);
         AssignAttri("", false, "AV27ResidentPackageId", AV27ResidentPackageId.ToString());
         /* Execute user subroutine: 'LOADGRIDSDT' */
         S132 ();
         if (returnInSub) return;
         ...
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV28SDT_Residents", AV28SDT_Residents);
            nGXsfl_84_bak_idx = nGXsfl_84_idx;
            gxgrGrid_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV72Udparg2, A29LocationId, AV73Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV75Udparg4, A527ResidentPackageId, AV28SDT_Residents, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents, AV68Udparg1) ;
            nGXsfl_84_idx = nGXsfl_84_bak_idx;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_845( ) ;
         }
      }
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         /* Using cursor H00BM4 */
         pr_default.execute(2, new Object[] {AV24LocationId});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A528SG_LocationId = H00BM4_A528SG_LocationId[0];
            A527ResidentPackageId = H00BM4_A527ResidentPackageId[0];
            n527ResidentPackageId = H00BM4_n527ResidentPackageId[0];
            A531ResidentPackageName = H00BM4_A531ResidentPackageName[0];
            AV36Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
            AV36Combo_DataItem.gxTpr_Id = StringUtil.Trim( A527ResidentPackageId.ToString());
            AV36Combo_DataItem.gxTpr_Title = A531ResidentPackageName;
            AV35ResidentPackageId_Data.Add(AV36Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_residentpackageid_Selectedvalue_set = ((Guid.Empty==AV27ResidentPackageId) ? "" : StringUtil.Trim( AV27ResidentPackageId.ToString()));
      ...
      protected void S132( )
      {
         /* 'LOADGRIDSDT' Routine */
         returnInSub = false;
         if ( (Guid.Empty==AV27ResidentPackageId) )
         {
            AV28SDT_Residents.Clear();
            gx_BV84 = true;
            AV72Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
            AV73Udparg3 = new prc_getuserlocationid(context).executeUdp( );
            /* Using cursor H00BM5 */
            pr_default.execute(3, new Object[] {AV73Udparg3, AV44WWPContext.gxTpr_Organisationid, AV44WWPContext.gxTpr_Isrootadmin, AV72Udparg2});
            while ( (pr_default.getStatus(3) != 101) )
            {
               A29LocationId = H00BM5_A29LocationId[0];
               A11OrganisationId = H00BM5_A11OrganisationId[0];
               A62ResidentId = H00BM5_A62ResidentId[0];
               A72ResidentSalutation = H00BM5_A72ResidentSalutation[0];
               A63ResidentBsnNumber = H00BM5_A63ResidentBsnNumber[0];
               A64ResidentGivenName = H00BM5_A64ResidentGivenName[0];
               A65ResidentLastName = H00BM5_A65ResidentLastName[0];
               A66ResidentInitials = H00BM5_A66ResidentInitials[0];
               A67ResidentEmail = H00BM5_A67ResidentEmail[0];
               A68ResidentGender = H00BM5_A68ResidentGender[0];
               A312ResidentCountry = H00BM5_A312ResidentCountry[0];
               A313ResidentCity = H00BM5_A313ResidentCity[0];
               A314ResidentZipCode = H00BM5_A314ResidentZipCode[0];
               A315ResidentAddressLine1 = H00BM5_A315ResidentAddressLine1[0];
               A316ResidentAddressLine2 = H00BM5_A316ResidentAddressLine2[0];
               A70ResidentPhone = H00BM5_A70ResidentPhone[0];
               A97ResidentTypeName = H00BM5_A97ResidentTypeName[0];
               A98MedicalIndicationId = H00BM5_A98MedicalIndicationId[0];
               n98MedicalIndicationId = H00BM5_n98MedicalIndicationId[0];
               A99MedicalIndicationName = H00BM5_A99MedicalIndicationName[0];
               A73ResidentBirthDate = H00BM5_A73ResidentBirthDate[0];
               A96ResidentTypeId = H00BM5_A96ResidentTypeId[0];
               n96ResidentTypeId = H00BM5_n96ResidentTypeId[0];
               A71ResidentGUID = H00BM5_A71ResidentGUID[0];
               A99MedicalIndicationName = H00BM5_A99MedicalIndicationName[0];
               A97ResidentTypeName = H00BM5_A97ResidentTypeName[0];
               AV45SDT_Resident = new SdtSDT_Resident(context);
               AV45SDT_Resident.gxTpr_Residentid = A62ResidentId;
               AV45SDT_Resident.gxTpr_Locationid = A29LocationId;
               AV45SDT_Resident.gxTpr_Organisationid = A11OrganisationId;
               AV45SDT_Resident.gxTpr_Residentsalutation = A72ResidentSalutation;
               AV45SDT_Resident.gxTpr_Residentbsnnumber = A63ResidentBsnNumber;
               AV45SDT_Resident.gxTpr_Residentgivenname = A64ResidentGivenName;
               AV45SDT_Resident.gxTpr_Residentlastname = A65ResidentLastName;
               AV45SDT_Resident.gxTpr_Residentinitials = A66ResidentInitials;
               AV45SDT_Resident.gxTpr_Residentemail = A67ResidentEmail;
               AV45SDT_Resident.gxTpr_Residentgender = A68ResidentGender;
               GXt_char2 = "";
               ...
               AV45SDT_Resident.gxTpr_Residentaddress = GXt_char2;
               AV45SDT_Resident.gxTpr_Residentphone = A70ResidentPhone;
               AV45SDT_Resident.gxTpr_Residenttypename = A97ResidentTypeName;
               AV45SDT_Resident.gxTpr_Medicalindicationid = A98MedicalIndicationId;
               AV45SDT_Resident.gxTpr_Medicalindicationname = A99MedicalIndicationName;
               AV45SDT_Resident.gxTpr_Residentbirthdate = A73ResidentBirthDate;
               AV45SDT_Resident.gxTpr_Residenttypeid = A96ResidentTypeId;
               AV45SDT_Resident.gxTpr_Residenttypename = A97ResidentTypeName;
               AV45SDT_Resident.gxTpr_Residentguid = A71ResidentGUID;
               AV28SDT_Residents.Add(AV45SDT_Resident, 0);
               gx_BV84 = true;
         ...
         else
         {
            if ( ! (Guid.Empty==AV27ResidentPackageId) )
            {
               AV28SDT_Residents.Clear();
               gx_BV84 = true;
               AV75Udparg4 = new prc_getuserlocationid(context).executeUdp( );
               pr_default.dynParam(4, new Object[]{ new Object[]{
                                                    AV27ResidentPackageId ,
               ...
               /* Using cursor H00BM6 */
               pr_default.execute(4, new Object[] {AV75Udparg4, AV27ResidentPackageId});
               while ( (pr_default.getStatus(4) != 101) )
               {
                  A527ResidentPackageId = H00BM6_A527ResidentPackageId[0];
                  n527ResidentPackageId = H00BM6_n527ResidentPackageId[0];
                  A29LocationId = H00BM6_A29LocationId[0];
                  A62ResidentId = H00BM6_A62ResidentId[0];
                  A11OrganisationId = H00BM6_A11OrganisationId[0];
                  A72ResidentSalutation = H00BM6_A72ResidentSalutation[0];
                  A63ResidentBsnNumber = H00BM6_A63ResidentBsnNumber[0];
                  A64ResidentGivenName = H00BM6_A64ResidentGivenName[0];
                  A65ResidentLastName = H00BM6_A65ResidentLastName[0];
                  A66ResidentInitials = H00BM6_A66ResidentInitials[0];
                  A67ResidentEmail = H00BM6_A67ResidentEmail[0];
                  A68ResidentGender = H00BM6_A68ResidentGender[0];
                  A312ResidentCountry = H00BM6_A312ResidentCountry[0];
                  A313ResidentCity = H00BM6_A313ResidentCity[0];
                  A314ResidentZipCode = H00BM6_A314ResidentZipCode[0];
                  A315ResidentAddressLine1 = H00BM6_A315ResidentAddressLine1[0];
                  A316ResidentAddressLine2 = H00BM6_A316ResidentAddressLine2[0];
                  A70ResidentPhone = H00BM6_A70ResidentPhone[0];
                  A97ResidentTypeName = H00BM6_A97ResidentTypeName[0];
                  A98MedicalIndicationId = H00BM6_A98MedicalIndicationId[0];
                  n98MedicalIndicationId = H00BM6_n98MedicalIndicationId[0];
                  A99MedicalIndicationName = H00BM6_A99MedicalIndicationName[0];
                  A73ResidentBirthDate = H00BM6_A73ResidentBirthDate[0];
                  A96ResidentTypeId = H00BM6_A96ResidentTypeId[0];
                  n96ResidentTypeId = H00BM6_n96ResidentTypeId[0];
                  A71ResidentGUID = H00BM6_A71ResidentGUID[0];
                  A99MedicalIndicationName = H00BM6_A99MedicalIndicationName[0];
                  A97ResidentTypeName = H00BM6_A97ResidentTypeName[0];
                  AV45SDT_Resident = new SdtSDT_Resident(context);
                  AV45SDT_Resident.gxTpr_Residentid = A62ResidentId;
      ...
      private void E15BM5( )
      {
         ...
         returnInSub = false;
         AV48GXV1 = 1;
         while ( AV48GXV1 <= AV28SDT_Residents.Count )
         {
            AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1));
            GXt_boolean3 = AV42IsGAMActive;
            new prc_checkgamuseractivationstatus(context ).execute(  ((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid, out  GXt_boolean3) ;
            AV42IsGAMActive = GXt_boolean3;
            GXt_boolean3 = AV43IsGAMBlocked;
            new prc_checkgamuserblockedstatus(context ).execute(  ((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid, out  GXt_boolean3) ;
            AV43IsGAMBlocked = GXt_boolean3;
            if ( ( AV42IsGAMActive ) && ! AV43IsGAMBlocked )
            {
               AV29AccountStatus = "Active";
               AssignAttri("", false, edtavAccountstatus_Internalname, AV29AccountStatus);
            }
            else if ( ( AV42IsGAMActive ) && ( AV43IsGAMBlocked ) )
            {
               AV29AccountStatus = "Blocked";
               AssignAttri("", false, edtavAccountstatus_Internalname, AV29AccountStatus);
            }
            else if ( ! AV42IsGAMActive )
            {
               AV29AccountStatus = "Inactive";
               AssignAttri("", false, edtavAccountstatus_Internalname, AV29AccountStatus);
            }
            ...
            if ( ( AV42IsGAMActive ) && ( AV43IsGAMBlocked ) )
            {
               cmbavActiongroup.addItem("2", StringUtil.Format( "%1;%2", "Unblock", "fas fa-lock-open", "", "", "", "", "", "", ""), 0);
            }
            if ( ( AV42IsGAMActive ) && ! AV43IsGAMBlocked )
            {
               cmbavActiongroup.addItem("3", StringUtil.Format( "%1;%2", "Block", "fas fa-lock", "", "", "", "", "", "", ""), 0);
            }
            if ( 1 == 0 )
            {
               cmbavActiongroup.addItem("4", StringUtil.Format( "%1;%2", "QR code", "fas fa-qrcode", "", "", "", "", "", "", ""), 0);
            }
            cmbavActiongroup.addItem("5", StringUtil.Format( "%1;%2", "Display", "fa fa-search", "", "", "", "", "", "", ""), 0);
            cmbavActiongroup.addItem("6", StringUtil.Format( "%1;%2", "Edit", "fa fa-pen", "", "", "", "", "", "", ""), 0);
            if ( AV33IsAuthorized_Delete )
            {
               if ( false )
               {
                  cmbavActiongroup.addItem("7", StringUtil.Format( "%1;%2", "Delete", "fa fa-times", "", "", "", "", "", "", ""), 0);
               }
            }
            cmbavActiongroup.addItem("8", StringUtil.Format( "%1;%2", "Delete", "fas fa-x", "", "", "", "", "", "", ""), 0);
            if ( AV31IsAuthorized_SDT_Residents )
            {
               edtavSdt_residents__residentgivenname_Link = formatLink("trn_residentview.aspx", new object[] {UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentid.ToString()),UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Locationid.ToString()),UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Organisationid.ToString())}, new string[] {"ResidentId","LocationId","OrganisationId","TabCode"}) ;
            }
            if ( AV31IsAuthorized_SDT_Residents )
            {
               edtavSdt_residents__residentlastname_Link = formatLink("trn_residentview.aspx", new object[] {UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentid.ToString()),UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Locationid.ToString()),UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Organisationid.ToString())}, new string[] {"ResidentId","LocationId","OrganisationId","TabCode"}) ;
            }
            if ( ( AV42IsGAMActive ) && ! AV43IsGAMBlocked )
            {
            ...
            {
               DoAjaxLoad(84, GridRow);
            }
            AV48GXV1 = (int)(AV48GXV1+1);
         }
         /*  Sending Event outputs  */
         cmbavActiongroup.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0));
      }

      protected void wb_table5_124_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_124_BM2e( true) ;
         }
         else
         {
            wb_table5_124_BM2e( false) ;
         }
      }

      protected void wb_table4_119_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_119_BM2e( true) ;
         }
         else
         {
            wb_table4_119_BM2e( false) ;
         }
      }

      protected void wb_table3_114_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_114_BM2e( true) ;
         }
         else
         {
            wb_table3_114_BM2e( false) ;
         }
      }

      protected void wb_table2_109_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_109_BM2e( true) ;
         }
         else
         {
            wb_table2_109_BM2e( false) ;
         }
      }

      protected void wb_table1_24_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCardlefticon1_moreinfoicon_Internalname, "<i class='CardMaterialMoreInfoIcon far fa-clock' style='font-size: 16px'></i>", "", "", lblCardlefticon1_moreinfoicon_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_WP_ProvisionedAppDashboard.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCardlefticon1_moreinfocaption_Internalname, "Just Updated", "", "", lblCardlefticon1_moreinfocaption_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockMoreInfoCard", 0, "", 1, 1, 0, 0, "HLP_WP_ProvisionedAppDashboard.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_BM2e( true) ;
         }
         else
         {
            wb_table1_24_BM2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418164350", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wp_provisionedappdashboard.js", "?202542418164351", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_312( )
      {
         ...
         /* Text block */
         Freestylegrid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {(string)lblCardcomponent1_icon_Internalname,(string)"<i class='ProgressCardIconBaseColor far fa-gem' style='font-size: 50px'></i>",(string)"",(string)"",(string)lblCardcomponent1_icon_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"font-family:'"+lblCardcomponent1_icon_Fontname+"';",(string)"TextBlock",(short)0,(string)"",(short)1,(short)1,(short)0,(short)2});
         ...
         /* Attribute/Variable Label */
         Freestylegrid1Row.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtavCardcomponent1_value_Internalname,(string)"Cardcomponent1_Value",(string)"gx-form-item DashboardNumberCardLabel",(short)0,(bool)true,(string)"width: 25%;"});
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 47,'',false,'" + sGXsfl_31_idx + "',31)\"";
         ROClassString = "DashboardNumberCard";
         Freestylegrid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCardcomponent1_value_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23Cardcomponent1_Value), 15, 0, ".", "")),StringUtil.LTrim( ((edtavCardcomponent1_value_Enabled!=0) ? context.localUtil.Format( (decimal)(AV23Cardcomponent1_Value), "ZZZ,ZZZ,ZZZ,ZZ9") : context.localUtil.Format( (decimal)(AV23Cardcomponent1_Value), "ZZZ,ZZZ,ZZZ,ZZ9"))),TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,47);\"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavCardcomponent1_value_Jsonclick,(short)0,(string)"DashboardNumberCard",(string)"",(string)ROClassString,(string)"",(string)"",(short)1,(int)edtavCardcomponent1_value_Enabled,(short)0,(string)"text",(string)"",(short)15,(string)"chr",(short)1,(string)"row",(short)15,(short)0,(short)0,(short)31,(short)0,(short)-1,(short)0,(bool)true,(string)"WorkWithPlus_Web\\KPINumericValue",(string)"end",(bool)false,(string)""});
         Freestylegrid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Freestylegrid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Freestylegrid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Freestylegrid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         ...
         /* Text block */
         Freestylegrid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {(string)lblCardcomponent1_moreinfoicon_Internalname,(string)"<i class='CardMaterialMoreInfoIcon far fa-clock' style='font-size: 16px'></i>",(string)"",(string)"",(string)lblCardcomponent1_moreinfoicon_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"TextBlock",(short)0,(string)"",(short)1,(short)1,(short)0,(short)2});
         if ( Freestylegrid1Container.GetWrapped() == 1 )
         {
         ...
         Freestylegrid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Text block */
         Freestylegrid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {(string)lblCardcomponent1_moreinfocaption_Internalname,(string)"Just Updated",(string)"",(string)"",(string)lblCardcomponent1_moreinfocaption_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"TextBlockMoreInfoCard",(short)0,(string)"",(short)1,(short)1,(short)0,(short)0});
         if ( Freestylegrid1Container.GetWrapped() == 1 )
         {
            Freestylegrid1Container.CloseTag("cell");
         }
      ...
      protected void SubsflControlProps_845( )
      {
         edtavSdt_residents__residentid_Internalname = "SDT_RESIDENTS__RESIDENTID_"+sGXsfl_84_idx;
         edtavSdt_residents__locationid_Internalname = "SDT_RESIDENTS__LOCATIONID_"+sGXsfl_84_idx;
         edtavSdt_residents__organisationid_Internalname = "SDT_RESIDENTS__ORGANISATIONID_"+sGXsfl_84_idx;
         edtavSdt_residents__residentbsnnumber_Internalname = "SDT_RESIDENTS__RESIDENTBSNNUMBER_"+sGXsfl_84_idx;
         cmbavSdt_residents__residentsalutation_Internalname = "SDT_RESIDENTS__RESIDENTSALUTATION_"+sGXsfl_84_idx;
         edtavSdt_residents__residentgivenname_Internalname = "SDT_RESIDENTS__RESIDENTGIVENNAME_"+sGXsfl_84_idx;
         edtavSdt_residents__residentlastname_Internalname = "SDT_RESIDENTS__RESIDENTLASTNAME_"+sGXsfl_84_idx;
         edtavSdt_residents__residentinitials_Internalname = "SDT_RESIDENTS__RESIDENTINITIALS_"+sGXsfl_84_idx;
         cmbavSdt_residents__residentgender_Internalname = "SDT_RESIDENTS__RESIDENTGENDER_"+sGXsfl_84_idx;
         edtavSdt_residents__residentbirthdate_Internalname = "SDT_RESIDENTS__RESIDENTBIRTHDATE_"+sGXsfl_84_idx;
         edtavSdt_residents__residentemail_Internalname = "SDT_RESIDENTS__RESIDENTEMAIL_"+sGXsfl_84_idx;
         edtavSdt_residents__residentphone_Internalname = "SDT_RESIDENTS__RESIDENTPHONE_"+sGXsfl_84_idx;
         edtavSdt_residents__residentguid_Internalname = "SDT_RESIDENTS__RESIDENTGUID_"+sGXsfl_84_idx;
         edtavSdt_residents__residenttypeid_Internalname = "SDT_RESIDENTS__RESIDENTTYPEID_"+sGXsfl_84_idx;
         edtavSdt_residents__residenttypename_Internalname = "SDT_RESIDENTS__RESIDENTTYPENAME_"+sGXsfl_84_idx;
         edtavSdt_residents__medicalindicationid_Internalname = "SDT_RESIDENTS__MEDICALINDICATIONID_"+sGXsfl_84_idx;
         edtavSdt_residents__medicalindicationname_Internalname = "SDT_RESIDENTS__MEDICALINDICATIONNAME_"+sGXsfl_84_idx;
         edtavSdt_residents__residentaddress_Internalname = "SDT_RESIDENTS__RESIDENTADDRESS_"+sGXsfl_84_idx;
         edtavAccountstatus_Internalname = "vACCOUNTSTATUS_"+sGXsfl_84_idx;
         cmbavActiongroup_Internalname = "vACTIONGROUP_"+sGXsfl_84_idx;
      }

      protected void SubsflControlProps_fel_845( )
      {
         edtavSdt_residents__residentid_Internalname = "SDT_RESIDENTS__RESIDENTID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__locationid_Internalname = "SDT_RESIDENTS__LOCATIONID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__organisationid_Internalname = "SDT_RESIDENTS__ORGANISATIONID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentbsnnumber_Internalname = "SDT_RESIDENTS__RESIDENTBSNNUMBER_"+sGXsfl_84_fel_idx;
         cmbavSdt_residents__residentsalutation_Internalname = "SDT_RESIDENTS__RESIDENTSALUTATION_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentgivenname_Internalname = "SDT_RESIDENTS__RESIDENTGIVENNAME_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentlastname_Internalname = "SDT_RESIDENTS__RESIDENTLASTNAME_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentinitials_Internalname = "SDT_RESIDENTS__RESIDENTINITIALS_"+sGXsfl_84_fel_idx;
         cmbavSdt_residents__residentgender_Internalname = "SDT_RESIDENTS__RESIDENTGENDER_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentbirthdate_Internalname = "SDT_RESIDENTS__RESIDENTBIRTHDATE_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentemail_Internalname = "SDT_RESIDENTS__RESIDENTEMAIL_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentphone_Internalname = "SDT_RESIDENTS__RESIDENTPHONE_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentguid_Internalname = "SDT_RESIDENTS__RESIDENTGUID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residenttypeid_Internalname = "SDT_RESIDENTS__RESIDENTTYPEID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residenttypename_Internalname = "SDT_RESIDENTS__RESIDENTTYPENAME_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__medicalindicationid_Internalname = "SDT_RESIDENTS__MEDICALINDICATIONID_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__medicalindicationname_Internalname = "SDT_RESIDENTS__MEDICALINDICATIONNAME_"+sGXsfl_84_fel_idx;
         edtavSdt_residents__residentaddress_Internalname = "SDT_RESIDENTS__RESIDENTADDRESS_"+sGXsfl_84_fel_idx;
         edtavAccountstatus_Internalname = "vACCOUNTSTATUS_"+sGXsfl_84_fel_idx;
         cmbavActiongroup_Internalname = "vACTIONGROUP_"+sGXsfl_84_fel_idx;
      }

      protected void sendrow_845( )
      {
         sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
         SubsflControlProps_845( ) ;
         WBBM0( ) ;
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__locationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Locationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Locationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__locationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__locationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)84,(short)0,(short)0,(short)0,(bool)false,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__organisationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Organisationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Organisationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__organisationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__organisationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)84,(short)0,(short)0,(short)0,(bool)false,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "SDT_RESIDENTS__RESIDENTSALUTATION_" + sGXsfl_84_idx;
               ...
               {
                  if ( ( AV48GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV48GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentsalutation)) )
                  {
                     ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentsalutation = cmbavSdt_residents__residentsalutation.getValidValue(((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentsalutation);
                  }
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_residents__residentsalutation,(string)cmbavSdt_residents__residentsalutation_Internalname,StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentsalutation),(short)1,(string)cmbavSdt_residents__residentsalutation_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"char",(string)"",(short)0,cmbavSdt_residents__residentsalutation.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"",(bool)false,(short)0});
            cmbavSdt_residents__residentsalutation.CurrentValue = StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentsalutation);
            AssignProp("", false, cmbavSdt_residents__residentsalutation_Internalname, "Values", (string)(cmbavSdt_residents__residentsalutation.ToJavascriptSource()), !bGXsfl_84_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__residentinitials_Internalname,StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentinitials),(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__residentinitials_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__residentinitials_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)84,(short)0,(short)-1,(short)-1,(bool)false,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            }
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 93,'',false,'" + sGXsfl_84_idx + "',84)\"";
            if ( ( cmbavSdt_residents__residentgender.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "SDT_RESIDENTS__RESIDENTGENDER_" + sGXsfl_84_idx;
               ...
               {
                  if ( ( AV48GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV48GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentgender)) )
                  {
                     ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentgender = cmbavSdt_residents__residentgender.getValidValue(((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentgender);
                  }
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_residents__residentgender,(string)cmbavSdt_residents__residentgender_Internalname,StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentgender),(short)1,(string)cmbavSdt_residents__residentgender_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,cmbavSdt_residents__residentgender.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,93);\"",(string)"",(bool)false,(short)0});
            cmbavSdt_residents__residentgender.CurrentValue = StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentgender);
            AssignProp("", false, cmbavSdt_residents__residentgender_Internalname, "Values", (string)(cmbavSdt_residents__residentgender.ToJavascriptSource()), !bGXsfl_84_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__residentguid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentguid,(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__residentguid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__residentguid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)84,(short)0,(short)0,(short)0,(bool)false,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__residenttypename_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residenttypename,(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__residenttypename_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__residenttypename_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)84,(short)0,(short)-1,(short)-1,(bool)false,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__medicalindicationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Medicalindicationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Medicalindicationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__medicalindicationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__medicalindicationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)84,(short)0,(short)0,(short)0,(bool)false,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__residentaddress_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV48GXV1)).gxTpr_Residentaddress,(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__residentaddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__residentaddress_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)84,(short)0,(short)-1,(short)0,(bool)false,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 103,'',false,'" + sGXsfl_84_idx + "',84)\"";
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavAccountstatus_Internalname,(string)AV29AccountStatus,(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,103);\"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavAccountstatus_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)edtavAccountstatus_Columnclass,(string)edtavAccountstatus_Columnheaderclass,(short)-1,(int)edtavAccountstatus_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)84,(short)0,(short)-1,(short)-1,(bool)false,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            }
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 104,'',false,'" + sGXsfl_84_idx + "',84)\"";
            if ( ( cmbavActiongroup.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "vACTIONGROUP_" + sGXsfl_84_idx;
               cmbavActiongroup.Name = GXCCtl;
               cmbavActiongroup.WebTags = "";
               if ( cmbavActiongroup.ItemCount > 0 )
               {
                  if ( ( AV48GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV48GXV1 ) && (0==AV32ActionGroup) )
                  {
                     AV32ActionGroup = (short)(Math.Round(NumberUtil.Val( cmbavActiongroup.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0))), "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, cmbavActiongroup_Internalname, StringUtil.LTrimStr( (decimal)(AV32ActionGroup), 4, 0));
                  }
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavActiongroup,(string)cmbavActiongroup_Internalname,StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0)),(short)1,(string)cmbavActiongroup_Jsonclick,(short)7,(string)"'"+""+"'"+",false,"+"'"+"e16bm5_client"+"'",(string)"int",(string)"",(short)-1,(short)1,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"ConvertToDDO",(string)"WWActionGroupColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,104);\"",(string)"",(bool)false,(short)0});
            cmbavActiongroup.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0));
            AssignProp("", false, cmbavActiongroup_Internalname, "Values", (string)(cmbavActiongroup.ToJavascriptSource()), !bGXsfl_84_Refreshing);
            send_integrity_lvl_hashesBM5( ) ;
            GridContainer.AddRow(GridRow);
            nGXsfl_84_idx = ((subGrid_Islastpage==1)&&(nGXsfl_84_idx+1>subGrid_fnc_Recordsperpage( )) ? 1 : nGXsfl_84_idx+1);
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_845( ) ;
         }
         /* End function sendrow_845 */
      }
      ...
      protected void StartGridControl84( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV29AccountStatus));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32ActionGroup), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCardcomponent1_value_Enabled = 0;
         lblCardcomponent1_description_Caption = "Sales";
         ...
         Dvelop_confirmpanel_udelete_Title = "Confirm delete action";
         ...
         Dvelop_confirmpanel_useractionblock_Title = "Block Resident";
         ...
         Dvelop_confirmpanel_useractionunblock_Title = "Unblock user";
         ...
         Form.Caption = "WP_Provisioned App Dashboard";
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FREESTYLEGRID1_nFirstRecordOnPage"},{"av":"FREESTYLEGRID1_nEOF"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("FREESTYLEGRID1.LOAD","""{"handler":"E14BM2","iparms":[{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"}]""");
         setEventMetadata("FREESTYLEGRID1.LOAD",""","oparms":[{"av":"AV23Cardcomponent1_Value","fld":"vCARDCOMPONENT1_VALUE","pic":"ZZZ,ZZZ,ZZZ,ZZ9"},{"av":"lblCardcomponent1_icon_Fontname","ctrl":"CARDCOMPONENT1_ICON","prop":"Fontname"},{"av":"lblCardcomponent1_description_Caption","ctrl":"CARDCOMPONENT1_DESCRIPTION","prop":"Caption"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E15BM5","iparms":[{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV29AccountStatus","fld":"vACCOUNTSTATUS"},{"av":"cmbavActiongroup"},{"av":"AV32ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"ctrl":"SDT_RESIDENTS__RESIDENTGIVENNAME","prop":"Link"},{"ctrl":"SDT_RESIDENTS__RESIDENTLASTNAME","prop":"Link"},{"av":"edtavAccountstatus_Columnclass","ctrl":"vACCOUNTSTATUS","prop":"Columnclass"}]}""");
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E16BM5","iparms":[{"av":"cmbavActiongroup"},{"av":"AV32ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV32ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]}""");
         setEventMetadata("COMBO_RESIDENTPACKAGEID.ONOPTIONCLICKED","""{"handler":"E11BM2","iparms":[{"av":"Combo_residentpackageid_Selectedvalue_get","ctrl":"COMBO_RESIDENTPACKAGEID","prop":"SelectedValue_get"},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"FREESTYLEGRID1_nFirstRecordOnPage"},{"av":"FREESTYLEGRID1_nEOF"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true}]""");
         setEventMetadata("COMBO_RESIDENTPACKAGEID.ONOPTIONCLICKED",""","oparms":[{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_FIRSTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_PREVPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_NEXTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV68Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV72Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV73Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV75Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_LASTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":84},{"av":"nGXsfl_84_idx","ctrl":"GRID","prop":"GridCurrRow","grid":84},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_84","ctrl":"GRID","prop":"GridRC","grid":84},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV72Udparg2 = Guid.Empty;
         A29LocationId = Guid.Empty;
         AV73Udparg3 = Guid.Empty;
         ...
         A71ResidentGUID = "";
         AV75Udparg4 = Guid.Empty;
         A527ResidentPackageId = Guid.Empty;
         A528SG_LocationId = Guid.Empty;
         AV68Udparg1 = Guid.Empty;
         A531ResidentPackageName = "";
         AV28SDT_Residents = new GXBaseCollection<SdtSDT_Resident>( context, "SDT_Resident", "Comforta_version20");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         AV35ResidentPackageId_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV29AccountStatus = "";
         AV24LocationId = Guid.Empty;
         GXt_guid1 = Guid.Empty;
         H00BM2_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00BM2_n527ResidentPackageId = new bool[] {false} ;
         H00BM2_A528SG_LocationId = new Guid[] {Guid.Empty} ;
         H00BM2_A531ResidentPackageName = new string[] {""} ;
         H00BM3_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BM3_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BM3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BM3_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00BM3_n527ResidentPackageId = new bool[] {false} ;
         AV25ResidentPackageName = "";
         Freestylegrid1Row = new GXWebRow();
         H00BM4_A528SG_LocationId = new Guid[] {Guid.Empty} ;
         H00BM4_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00BM4_n527ResidentPackageId = new bool[] {false} ;
         H00BM4_A531ResidentPackageName = new string[] {""} ;
         AV36Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         H00BM5_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BM5_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BM5_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BM5_A72ResidentSalutation = new string[] {""} ;
         H00BM5_A63ResidentBsnNumber = new string[] {""} ;
         H00BM5_A64ResidentGivenName = new string[] {""} ;
         H00BM5_A65ResidentLastName = new string[] {""} ;
         H00BM5_A66ResidentInitials = new string[] {""} ;
         H00BM5_A67ResidentEmail = new string[] {""} ;
         H00BM5_A68ResidentGender = new string[] {""} ;
         H00BM5_A312ResidentCountry = new string[] {""} ;
         H00BM5_A313ResidentCity = new string[] {""} ;
         H00BM5_A314ResidentZipCode = new string[] {""} ;
         H00BM5_A315ResidentAddressLine1 = new string[] {""} ;
         H00BM5_A316ResidentAddressLine2 = new string[] {""} ;
         H00BM5_A70ResidentPhone = new string[] {""} ;
         H00BM5_A97ResidentTypeName = new string[] {""} ;
         H00BM5_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H00BM5_n98MedicalIndicationId = new bool[] {false} ;
         H00BM5_A99MedicalIndicationName = new string[] {""} ;
         H00BM5_A73ResidentBirthDate = new DateTime[] {DateTime.MinValue} ;
         H00BM5_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H00BM5_n96ResidentTypeId = new bool[] {false} ;
         H00BM5_A71ResidentGUID = new string[] {""} ;
         AV45SDT_Resident = new SdtSDT_Resident(context);
         H00BM6_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00BM6_n527ResidentPackageId = new bool[] {false} ;
         H00BM6_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BM6_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BM6_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BM6_A72ResidentSalutation = new string[] {""} ;
         H00BM6_A63ResidentBsnNumber = new string[] {""} ;
         H00BM6_A64ResidentGivenName = new string[] {""} ;
         H00BM6_A65ResidentLastName = new string[] {""} ;
         H00BM6_A66ResidentInitials = new string[] {""} ;
         H00BM6_A67ResidentEmail = new string[] {""} ;
         H00BM6_A68ResidentGender = new string[] {""} ;
         H00BM6_A312ResidentCountry = new string[] {""} ;
         H00BM6_A313ResidentCity = new string[] {""} ;
         H00BM6_A314ResidentZipCode = new string[] {""} ;
         H00BM6_A315ResidentAddressLine1 = new string[] {""} ;
         H00BM6_A316ResidentAddressLine2 = new string[] {""} ;
         H00BM6_A70ResidentPhone = new string[] {""} ;
         H00BM6_A97ResidentTypeName = new string[] {""} ;
         H00BM6_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H00BM6_n98MedicalIndicationId = new bool[] {false} ;
         H00BM6_A99MedicalIndicationName = new string[] {""} ;
         H00BM6_A73ResidentBirthDate = new DateTime[] {DateTime.MinValue} ;
         H00BM6_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H00BM6_n96ResidentTypeId = new bool[] {false} ;
         H00BM6_A71ResidentGUID = new string[] {""} ;
         GXt_char2 = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_provisionedappdashboard__default(),
            new Object[][] {
                new Object[] {
               H00BM2_A527ResidentPackageId, H00BM2_A528SG_LocationId, H00BM2_A531ResidentPackageName
               }
               , new Object[] {
               H00BM3_A62ResidentId, H00BM3_A29LocationId, H00BM3_A11OrganisationId, H00BM3_A527ResidentPackageId, H00BM3_n527ResidentPackageId
               }
               , new Object[] {
               H00BM4_A528SG_LocationId, H00BM4_A527ResidentPackageId, H00BM4_A531ResidentPackageName
               }
               , new Object[] {
               H00BM5_A29LocationId, H00BM5_A11OrganisationId, H00BM5_A62ResidentId, H00BM5_A72ResidentSalutation, H00BM5_A63ResidentBsnNumber, H00BM5_A64ResidentGivenName, H00BM5_A65ResidentLastName, H00BM5_A66ResidentInitials, H00BM5_A67ResidentEmail, H00BM5_A68ResidentGender,
               H00BM5_A312ResidentCountry, H00BM5_A313ResidentCity, H00BM5_A314ResidentZipCode, H00BM5_A315ResidentAddressLine1, H00BM5_A316ResidentAddressLine2, H00BM5_A70ResidentPhone, H00BM5_A97ResidentTypeName, H00BM5_A98MedicalIndicationId, H00BM5_n98MedicalIndicationId, H00BM5_A99MedicalIndicationName,
               H00BM5_A73ResidentBirthDate, H00BM5_A96ResidentTypeId, H00BM5_n96ResidentTypeId, H00BM5_A71ResidentGUID
               }
               , new Object[] {
               H00BM6_A527ResidentPackageId, H00BM6_n527ResidentPackageId, H00BM6_A29LocationId, H00BM6_A62ResidentId, H00BM6_A11OrganisationId, H00BM6_A72ResidentSalutation, H00BM6_A63ResidentBsnNumber, H00BM6_A64ResidentGivenName, H00BM6_A65ResidentLastName, H00BM6_A66ResidentInitials,
               H00BM6_A67ResidentEmail, H00BM6_A68ResidentGender, H00BM6_A312ResidentCountry, H00BM6_A313ResidentCity, H00BM6_A314ResidentZipCode, H00BM6_A315ResidentAddressLine1, H00BM6_A316ResidentAddressLine2, H00BM6_A70ResidentPhone, H00BM6_A97ResidentTypeName, H00BM6_A98MedicalIndicationId,
               H00BM6_n98MedicalIndicationId, H00BM6_A99MedicalIndicationName, H00BM6_A73ResidentBirthDate, H00BM6_A96ResidentTypeId, H00BM6_n96ResidentTypeId, H00BM6_A71ResidentGUID
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int nGXsfl_84_fel_idx=1 ;
      private int nGXsfl_84_bak_idx=1 ;
      private int idxLst ;
      ...
      private long AV23Cardcomponent1_Value ;
      ...
      private bool AV31IsAuthorized_SDT_Residents ;
      ...
      private string AV26CardLeftIcon1_Value ;
      private string AV29AccountStatus ;
      private string AV25ResidentPackageName ;
      private Guid AV27ResidentPackageId ;
      private Guid A11OrganisationId ;
      private Guid AV72Udparg2 ;
      private Guid A29LocationId ;
      private Guid AV73Udparg3 ;
      private Guid A62ResidentId ;
      private Guid A98MedicalIndicationId ;
      private Guid A96ResidentTypeId ;
      private Guid AV75Udparg4 ;
      private Guid A527ResidentPackageId ;
      private Guid A528SG_LocationId ;
      private Guid AV68Udparg1 ;
      private Guid AV24LocationId ;
      ...
      private GXBaseCollection<SdtSDT_Resident> AV28SDT_Residents ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item> AV35ResidentPackageId_Data ;
      private IDataStoreProvider pr_default ;
      private Guid[] H00BM2_A527ResidentPackageId ;
      private bool[] H00BM2_n527ResidentPackageId ;
      private Guid[] H00BM2_A528SG_LocationId ;
      private string[] H00BM2_A531ResidentPackageName ;
      private Guid[] H00BM3_A62ResidentId ;
      private Guid[] H00BM3_A29LocationId ;
      private Guid[] H00BM3_A11OrganisationId ;
      private Guid[] H00BM3_A527ResidentPackageId ;
      private bool[] H00BM3_n527ResidentPackageId ;
      private Guid[] H00BM4_A528SG_LocationId ;
      private Guid[] H00BM4_A527ResidentPackageId ;
      private bool[] H00BM4_n527ResidentPackageId ;
      private string[] H00BM4_A531ResidentPackageName ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item AV36Combo_DataItem ;
      private Guid[] H00BM5_A29LocationId ;
      private Guid[] H00BM5_A11OrganisationId ;
      private Guid[] H00BM5_A62ResidentId ;
      private string[] H00BM5_A72ResidentSalutation ;
      private string[] H00BM5_A63ResidentBsnNumber ;
      private string[] H00BM5_A64ResidentGivenName ;
      private string[] H00BM5_A65ResidentLastName ;
      private string[] H00BM5_A66ResidentInitials ;
      private string[] H00BM5_A67ResidentEmail ;
      private string[] H00BM5_A68ResidentGender ;
      private string[] H00BM5_A312ResidentCountry ;
      private string[] H00BM5_A313ResidentCity ;
      private string[] H00BM5_A314ResidentZipCode ;
      private string[] H00BM5_A315ResidentAddressLine1 ;
      private string[] H00BM5_A316ResidentAddressLine2 ;
      private string[] H00BM5_A70ResidentPhone ;
      private string[] H00BM5_A97ResidentTypeName ;
      private Guid[] H00BM5_A98MedicalIndicationId ;
      private bool[] H00BM5_n98MedicalIndicationId ;
      private string[] H00BM5_A99MedicalIndicationName ;
      private DateTime[] H00BM5_A73ResidentBirthDate ;
      private Guid[] H00BM5_A96ResidentTypeId ;
      private bool[] H00BM5_n96ResidentTypeId ;
      private string[] H00BM5_A71ResidentGUID ;
      private SdtSDT_Resident AV45SDT_Resident ;
      private Guid[] H00BM6_A527ResidentPackageId ;
      private bool[] H00BM6_n527ResidentPackageId ;
      private Guid[] H00BM6_A29LocationId ;
      private Guid[] H00BM6_A62ResidentId ;
      private Guid[] H00BM6_A11OrganisationId ;
      private string[] H00BM6_A72ResidentSalutation ;
      private string[] H00BM6_A63ResidentBsnNumber ;
      private string[] H00BM6_A64ResidentGivenName ;
      private string[] H00BM6_A65ResidentLastName ;
      private string[] H00BM6_A66ResidentInitials ;
      private string[] H00BM6_A67ResidentEmail ;
      private string[] H00BM6_A68ResidentGender ;
      private string[] H00BM6_A312ResidentCountry ;
      private string[] H00BM6_A313ResidentCity ;
      private string[] H00BM6_A314ResidentZipCode ;
      private string[] H00BM6_A315ResidentAddressLine1 ;
      private string[] H00BM6_A316ResidentAddressLine2 ;
      private string[] H00BM6_A70ResidentPhone ;
      private string[] H00BM6_A97ResidentTypeName ;
      private Guid[] H00BM6_A98MedicalIndicationId ;
      private bool[] H00BM6_n98MedicalIndicationId ;
      private string[] H00BM6_A99MedicalIndicationName ;
      private DateTime[] H00BM6_A73ResidentBirthDate ;
      private Guid[] H00BM6_A96ResidentTypeId ;
      private bool[] H00BM6_n96ResidentTypeId ;
      private string[] H00BM6_A71ResidentGUID ;
   ...
   {
      protected Object[] conditional_H00BM6( IGxContext context ,
                                             Guid AV27ResidentPackageId ,
                                             Guid A527ResidentPackageId ,
                                             Guid AV75Udparg4 ,
                                             Guid A29LocationId )
      {
         ...
         AddWhere(sWhereString, "(T1.LocationId = :AV75Udparg4)");
         if ( ! (Guid.Empty==AV27ResidentPackageId) )
         {
            AddWhere(sWhereString, "(T1.ResidentPackageId = :AV27ResidentPackageId)");
         }
         else
         {
            GXv_int4[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 4 :
                     return conditional_H00BM6(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00BM4;
          prmH00BM4 = new Object[] {
          new ParDef("AV24LocationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BM5;
          prmH00BM5 = new Object[] {
          new ParDef("AV73Udparg3",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV44WWPC_1Organisationid",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV44WWPContext__Isrootadmin",GXType.Boolean,4,0) ,
          new ParDef("AV72Udparg2",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BM6;
          prmH00BM6 = new Object[] {
          new ParDef("AV75Udparg4",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV27ResidentPackageId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00BM2", "SELECT ResidentPackageId, SG_LocationId, ResidentPackageName FROM Trn_ResidentPackage WHERE SG_LocationId = :AV68Udparg1 ORDER BY SG_LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00BM3", "SELECT ResidentId, LocationId, OrganisationId, ResidentPackageId FROM Trn_Resident WHERE ResidentPackageId = :ResidentPackageId ORDER BY ResidentPackageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00BM4", "SELECT SG_LocationId, ResidentPackageId, ResidentPackageName FROM Trn_ResidentPackage WHERE SG_LocationId = :AV24LocationId ORDER BY ResidentPackageName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00BM5", "SELECT T1.LocationId, T1.OrganisationId, T1.ResidentId, T1.ResidentSalutation, T1.ResidentBsnNumber, T1.ResidentGivenName, T1.ResidentLastName, T1.ResidentInitials, T1.ResidentEmail, T1.ResidentGender, T1.ResidentCountry, T1.ResidentCity, T1.ResidentZipCode, T1.ResidentAddressLine1, T1.ResidentAddressLine2, T1.ResidentPhone, T3.ResidentTypeName, T1.MedicalIndicationId, T2.MedicalIndicationName, T1.ResidentBirthDate, T1.ResidentTypeId, T1.ResidentGUID FROM ((Trn_Resident T1 LEFT JOIN Trn_MedicalIndication T2 ON T2.MedicalIndicationId = T1.MedicalIndicationId) LEFT JOIN Trn_ResidentType T3 ON T3.ResidentTypeId = T1.ResidentTypeId) WHERE (T1.LocationId = :AV73Udparg3) AND (T1.OrganisationId = CASE  WHEN :AV44WWPContext__Isrootadmin THEN :AV44WWPC_1Organisationid ELSE :AV72Udparg2 END) ORDER BY T1.LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM5,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00BM6", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM6,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
