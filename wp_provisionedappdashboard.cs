...
namespace GeneXus.Programs {
   public class wp_provisionedappdashboard : GXDataArea
   {
      ...
      protected void gxgrFreestylegrid1_refresh_invoke( )
      {
         ...
         AV86Udparg2 = StringUtil.StrToGuid( GetPar( "Udparg2"));
         A29LocationId = StringUtil.StrToGuid( GetPar( "LocationId"));
         AV87Udparg3 = StringUtil.StrToGuid( GetPar( "Udparg3"));
         ...
         AV89Udparg4 = StringUtil.StrToGuid( GetPar( "Udparg4"));
         ...
         AV79Udparg1 = StringUtil.StrToGuid( GetPar( "Udparg1"));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV86Udparg2, A29LocationId, AV87Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV89Udparg4, A527ResidentPackageId, AV28SDT_Residents, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents, AV79Udparg1) ;
         AddString( context.getJSONResponse( )) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vUDPARG2", AV86Udparg2.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG2", GetSecureSignedToken( "", AV86Udparg2, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG3", AV87Udparg3.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG3", GetSecureSignedToken( "", AV87Udparg3, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG4", AV89Udparg4.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG4", GetSecureSignedToken( "", AV89Udparg4, context));
         GxWebStd.gx_hidden_field( context, "vUDPARG1", AV79Udparg1.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vUDPARG1", GetSecureSignedToken( "", AV79Udparg1, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_SDT_RESIDENTS", AV31IsAuthorized_SDT_Residents);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SDT_RESIDENTS", GetSecureSignedToken( "", AV31IsAuthorized_SDT_Residents, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISSENT", AV54isSent);
         GxWebStd.gx_hidden_field( context, "vERRDESCROPTION", StringUtil.RTrim( AV55ErrDescroption));
         ...
         GxWebStd.gx_hidden_field( context, "vHTTPREQUEST_Baseurl", StringUtil.RTrim( AV37HTTPRequest.BaseURL));
      ...
      protected void wb_table1_24_BM2e( bool wbgen )
      {
         ...
         if ( wbEnd == 82 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavResidentpackageid_Internalname, AV27ResidentPackageId.ToString(), AV27ResidentPackageId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,106);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResidentpackageid_Jsonclick, 0, "Attribute", "", "", "", "", edtavResidentpackageid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_ProvisionedAppDashboard.htm");
            wb_table2_107_BM2( true) ;
         }
         else
         {
            wb_table2_107_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table2_107_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_112_BM2( true) ;
         }
         else
         {
            wb_table3_112_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table3_112_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_117_BM2( true) ;
         }
         else
         {
            wb_table4_117_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table4_117_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table5_122_BM2( true) ;
         }
         else
         {
            wb_table5_122_BM2( false) ;
         }
         return  ;
      }

      protected void wb_table5_122_BM2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           else if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              AV59GXV1 = (int)(nGXsfl_82_idx+GRID_nFirstRecordOnPage);
                              if ( ( AV28SDT_Residents.Count >= AV59GXV1 ) && ( AV59GXV1 > 0 ) )
                              {
                                 AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1));
      ...
      protected void STRUPBM0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            while ( nGXsfl_82_fel_idx < nRC_GXsfl_82 )
            {
               ...
               AV59GXV1 = (int)(nGXsfl_82_fel_idx+GRID_nFirstRecordOnPage);
               if ( ( AV28SDT_Residents.Count >= AV59GXV1 ) && ( AV59GXV1 > 0 ) )
               {
                  AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1));
                  AV29AccountStatus = cgiGet( edtavAccountstatus_Internalname);
      ...
      private void E17BM2( )
      {
         ...
         returnInSub = false;
         AV79Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         /* Using cursor H00BM2 */
         pr_default.execute(0, new Object[] {AV79Udparg1});
      ...
      {
         AV59GXV1 = (int)(nGXsfl_82_idx+GRID_nFirstRecordOnPage);
         if ( ( AV59GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV59GXV1 ) )
         {
            AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1));
         }
         /* Actiongroup_Click Routine */
         returnInSub = false;
         if ( AV32ActionGroup == 1 )
         {
            /* Execute user subroutine: 'DO RESENDINVITE' */
            S152 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 2 )
         {
            /* Execute user subroutine: 'DO USERACTIONUNBLOCK' */
            S162 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 3 )
         {
            /* Execute user subroutine: 'DO USERACTIONBLOCK' */
            S172 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 4 )
         {
            /* Execute user subroutine: 'DO VIEWQRCODE' */
            S182 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 5 )
         {
            /* Execute user subroutine: 'DO DISPLAY' */
            S192 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 6 )
         {
            /* Execute user subroutine: 'DO UPDATE' */
            S202 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 7 )
         {
            /* Execute user subroutine: 'DO DELETE' */
            S212 ();
            if (returnInSub) return;
         }
         else if ( AV32ActionGroup == 8 )
         {
      ...
      protected void S232( )
      {
         ...
         returnInSub = false;
         AV48baseUrl = AV37HTTPRequest.BaseURL;
         AV49ResidentGuid_Selected = ((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid;
         AV50GAMUser_Resident.load( AV49ResidentGuid_Selected);
         ...
         AV52ActivactionKey = AV50GAMUser_Resident.getnewactivationkey(out  AV51GAMErrors);
         if ( AV51GAMErrors.Count > 0 )
         {
            AV81GXV20 = 1;
            while ( AV81GXV20 <= AV51GAMErrors.Count )
            {
               AV53GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV51GAMErrors.Item(AV81GXV20));
         ...
         else
         {
            ...
            new prc_senduseractivationlink(context).executeSubmit(  AV49ResidentGuid_Selected,  AV52ActivactionKey,  AV48baseUrl, ref  AV54isSent, ref  AV55ErrDescroption, ref  AV56GamErrorCollection) ;
      ...
      protected void S242( )
      {
         ...
         returnInSub = false;
         AV51GAMErrors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         new prc_unblockuser(context ).execute(  ((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid, out  AV57IsUnblocked, out  AV51GAMErrors) ;
         if ( AV57IsUnblocked )
         {
            gxgrGrid_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV86Udparg2, A29LocationId, AV87Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV89Udparg4, A527ResidentPackageId, AV28SDT_Residents, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents, AV79Udparg1) ;
         ...
         {
            AV82GXV21 = 1;
            while ( AV82GXV21 <= AV51GAMErrors.Count )
            {
               AV53GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV51GAMErrors.Item(AV82GXV21));
               GX_msglist.addItem(AV53GAMError.gxTpr_Message);
      ...
      protected void S252( )
      {
         ...
         returnInSub = false;
         AV51GAMErrors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         new prc_blockuser(context ).execute(  ((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid, out  AV58IsBlocked, out  AV51GAMErrors) ;
         if ( AV58IsBlocked )
         {
            gxgrGrid_refresh( subGrid_Rows, AV27ResidentPackageId, A11OrganisationId, AV44WWPContext, AV86Udparg2, A29LocationId, AV87Udparg3, A62ResidentId, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A66ResidentInitials, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A314ResidentZipCode, A315ResidentAddressLine1, A316ResidentAddressLine2, A70ResidentPhone, A97ResidentTypeName, A98MedicalIndicationId, A99MedicalIndicationName, A73ResidentBirthDate, A96ResidentTypeId, A71ResidentGUID, AV89Udparg4, A527ResidentPackageId, AV28SDT_Residents, AV33IsAuthorized_Delete, AV31IsAuthorized_SDT_Residents, AV79Udparg1) ;
         ...
         {
            AV83GXV22 = 1;
            while ( AV83GXV22 <= AV51GAMErrors.Count )
            {
               AV53GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV51GAMErrors.Item(AV83GXV22));
               GX_msglist.addItem(AV53GAMError.gxTpr_Message);
      ...
      protected void S182( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "wp_residentqrcode.aspx"+UrlEncode(StringUtil.RTrim(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentguid)) + "," + UrlEncode(StringUtil.RTrim(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentemail));
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_residentview.aspx"+UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Locationid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Organisationid.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
      ...
      protected void S202( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_resident.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Locationid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Organisationid.ToString());
      ...
      protected void S212( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_resident.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Residentid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Locationid.ToString()) + "," + UrlEncode(((SdtSDT_Resident)(AV28SDT_Residents.CurrentItem)).gxTpr_Organisationid.ToString());
         CallWebObject(formatLink("trn_resident.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S132( )
      {
         ...
         if ( (Guid.Empty==AV27ResidentPackageId) )
         {
            ...
            gx_BV82 = true;
            AV86Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
            AV87Udparg3 = new prc_getuserlocationid(context).executeUdp( );
            /* Using cursor H00BM5 */
            pr_default.execute(3, new Object[] {AV87Udparg3, AV44WWPContext.gxTpr_Organisationid, AV44WWPContext.gxTpr_Isrootadmin, AV86Udparg2});
         ...
         else
         {
            if ( ! (Guid.Empty==AV27ResidentPackageId) )
            {
               AV28SDT_Residents.Clear();
               gx_BV82 = true;
               AV89Udparg4 = new prc_getuserlocationid(context).executeUdp( );
               ...
               /* Using cursor H00BM6 */
               pr_default.execute(4, new Object[] {AV89Udparg4, AV27ResidentPackageId});
      ...
      private void E18BM5( )
      {
         ...
         returnInSub = false;
         AV59GXV1 = 1;
         while ( AV59GXV1 <= AV28SDT_Residents.Count )
         {
            AV28SDT_Residents.CurrentItem = ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1));
      ...
      protected void wb_table5_122_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_122_BM2e( true) ;
         }
         else
         {
            wb_table5_122_BM2e( false) ;
         }
      }

      protected void wb_table4_117_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_117_BM2e( true) ;
         }
         else
         {
            wb_table4_117_BM2e( false) ;
         }
      }

      protected void wb_table3_112_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_112_BM2e( true) ;
         }
         else
         {
            wb_table3_112_BM2e( false) ;
         }
      }

      protected void wb_table2_107_BM2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_107_BM2e( true) ;
         }
         else
         {
            wb_table2_107_BM2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255115131179", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wp_provisionedappdashboard.js", "?20255115131182", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_825( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_82_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__locationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Locationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Locationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__locationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__locationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)82,(short)0,(short)0,(short)0,(bool)true,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__organisationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Organisationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Organisationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__organisationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__organisationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)82,(short)0,(short)0,(short)0,(bool)true,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            if ( ( cmbavSdt_residents__residentsalutation.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV59GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV59GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentsalutation)) )
                  {
                     ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentsalutation = cmbavSdt_residents__residentsalutation.getValidValue(((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentsalutation);
                  }
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_residents__residentsalutation,(string)cmbavSdt_residents__residentsalutation_Internalname,StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentsalutation),(short)1,(string)cmbavSdt_residents__residentsalutation_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"char",(string)"",(short)0,cmbavSdt_residents__residentsalutation.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"",(bool)true,(short)0});
            cmbavSdt_residents__residentsalutation.CurrentValue = StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentsalutation);
            ...
            if ( ( cmbavSdt_residents__residentgender.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV59GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV59GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentgender)) )
                  {
                     ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentgender = cmbavSdt_residents__residentgender.getValidValue(((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentgender);
                  }
               }
            }
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_residents__residentgender,(string)cmbavSdt_residents__residentgender_Internalname,StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentgender),(short)1,(string)cmbavSdt_residents__residentgender_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,cmbavSdt_residents__residentgender.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,91);\"",(string)"",(bool)true,(short)0});
            cmbavSdt_residents__residentgender.CurrentValue = StringUtil.RTrim( ((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Residentgender);
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_residents__medicalindicationid_Internalname,((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Medicalindicationid.ToString(),((SdtSDT_Resident)AV28SDT_Residents.Item(AV59GXV1)).gxTpr_Medicalindicationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_residents__medicalindicationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_residents__medicalindicationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)82,(short)0,(short)0,(short)0,(bool)true,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            if ( ( cmbavActiongroup.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV59GXV1 > 0 ) && ( AV28SDT_Residents.Count >= AV59GXV1 ) && (0==AV32ActionGroup) )
                  {
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavActiongroup,(string)cmbavActiongroup_Internalname,StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0)),(short)1,(string)cmbavActiongroup_Jsonclick,(short)5,"'"+""+"'"+",false,"+"'"+"EVACTIONGROUP.CLICK."+sGXsfl_82_idx+"'",(string)"int",(string)"",(short)-1,(short)1,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"ConvertToDDO",(string)"WWActionGroupColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,102);\"",(string)"",(bool)true,(short)0});
            cmbavActiongroup.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV32ActionGroup), 4, 0));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18BM5","iparms":[{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E19BM2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV32ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV32ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_RESENDINVITE.CLOSE","""{"handler":"E12BM2","iparms":[{"av":"Dvelop_confirmpanel_resendinvite_Result","ctrl":"DVELOP_CONFIRMPANEL_RESENDINVITE","prop":"Result"},{"av":"AV37HTTPRequest.BaseURL","ctrl":"vHTTPREQUEST","prop":"Baseurl"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV54isSent","fld":"vISSENT"},{"av":"AV55ErrDescroption","fld":"vERRDESCROPTION"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_RESENDINVITE.CLOSE",""","oparms":[{"av":"AV55ErrDescroption","fld":"vERRDESCROPTION"},{"av":"AV54isSent","fld":"vISSENT"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTIONUNBLOCK.CLOSE","""{"handler":"E13BM2","iparms":[{"av":"Dvelop_confirmpanel_useractionunblock_Result","ctrl":"DVELOP_CONFIRMPANEL_USERACTIONUNBLOCK","prop":"Result"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"FREESTYLEGRID1_nFirstRecordOnPage"},{"av":"FREESTYLEGRID1_nEOF"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTIONUNBLOCK.CLOSE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTIONBLOCK.CLOSE","""{"handler":"E14BM2","iparms":[{"av":"Dvelop_confirmpanel_useractionblock_Result","ctrl":"DVELOP_CONFIRMPANEL_USERACTIONBLOCK","prop":"Result"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"FREESTYLEGRID1_nFirstRecordOnPage"},{"av":"FREESTYLEGRID1_nEOF"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_USERACTIONBLOCK.CLOSE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("COMBO_RESIDENTPACKAGEID.ONOPTIONCLICKED","""{"handler":"E11BM2","iparms":[{"av":"Combo_residentpackageid_Selectedvalue_get","ctrl":"COMBO_RESIDENTPACKAGEID","prop":"SelectedValue_get"},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"FREESTYLEGRID1_nFirstRecordOnPage"},{"av":"FREESTYLEGRID1_nEOF"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A531ResidentPackageName","fld":"RESIDENTPACKAGENAME"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true}]""");
         setEventMetadata("COMBO_RESIDENTPACKAGEID.ONOPTIONCLICKED",""","oparms":[{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_FIRSTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_PREVPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_NEXTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_SDT_Residents","fld":"vISAUTHORIZED_SDT_RESIDENTS","hsh":true},{"av":"AV79Udparg1","fld":"vUDPARG1","hsh":true},{"av":"AV27ResidentPackageId","fld":"vRESIDENTPACKAGEID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV44WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV86Udparg2","fld":"vUDPARG2","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV87Udparg3","fld":"vUDPARG3","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A72ResidentSalutation","fld":"RESIDENTSALUTATION"},{"av":"A63ResidentBsnNumber","fld":"RESIDENTBSNNUMBER"},{"av":"A64ResidentGivenName","fld":"RESIDENTGIVENNAME"},{"av":"A65ResidentLastName","fld":"RESIDENTLASTNAME"},{"av":"A66ResidentInitials","fld":"RESIDENTINITIALS"},{"av":"A67ResidentEmail","fld":"RESIDENTEMAIL"},{"av":"A68ResidentGender","fld":"RESIDENTGENDER"},{"av":"A312ResidentCountry","fld":"RESIDENTCOUNTRY"},{"av":"A313ResidentCity","fld":"RESIDENTCITY"},{"av":"A314ResidentZipCode","fld":"RESIDENTZIPCODE"},{"av":"A315ResidentAddressLine1","fld":"RESIDENTADDRESSLINE1"},{"av":"A316ResidentAddressLine2","fld":"RESIDENTADDRESSLINE2"},{"av":"A70ResidentPhone","fld":"RESIDENTPHONE"},{"av":"A97ResidentTypeName","fld":"RESIDENTTYPENAME"},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"A99MedicalIndicationName","fld":"MEDICALINDICATIONNAME"},{"av":"A73ResidentBirthDate","fld":"RESIDENTBIRTHDATE"},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID"},{"av":"A71ResidentGUID","fld":"RESIDENTGUID"},{"av":"AV89Udparg4","fld":"vUDPARG4","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("GRID_LASTPAGE",""","oparms":[{"av":"edtavAccountstatus_Columnheaderclass","ctrl":"vACCOUNTSTATUS","prop":"Columnheaderclass"},{"av":"AV28SDT_Residents","fld":"vSDT_RESIDENTS","grid":82},{"av":"nGXsfl_82_idx","ctrl":"GRID","prop":"GridCurrRow","grid":82},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_82","ctrl":"GRID","prop":"GridRC","grid":82},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV86Udparg2 = Guid.Empty;
         A29LocationId = Guid.Empty;
         AV87Udparg3 = Guid.Empty;
         ...
         AV48baseUrl = "";
         AV49ResidentGuid_Selected = "";
         AV50GAMUser_Resident = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
         AV51GAMErrors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV52ActivactionKey = "";
         AV53GAMError = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
         AV56GamErrorCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         GXEncryptionTmp = "";
      ...
      private string AV55ErrDescroption ;
      ...
      private bool AV57IsUnblocked ;
      private bool AV58IsBlocked ;
      ...
      private string AV48baseUrl ;
      private string AV49ResidentGuid_Selected ;
      private string AV52ActivactionKey ;
      private Guid AV27ResidentPackageId ;
      private Guid A11OrganisationId ;
      private Guid AV86Udparg2 ;
      private Guid A29LocationId ;
      private Guid AV87Udparg3 ;
      private Guid A62ResidentId ;
      private Guid A98MedicalIndicationId ;
      private Guid A96ResidentTypeId ;
      private Guid AV89Udparg4 ;
      private Guid A527ResidentPackageId ;
      private Guid A528SG_LocationId ;
      private Guid AV79Udparg1 ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV50GAMUser_Resident ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV56GamErrorCollection ;
...
public class wp_provisionedappdashboard__default : DataStoreHelperBase, IDataStoreHelper
{
                                          ...
                                          Guid A29LocationId )
   {
      ...
      AddWhere(sWhereString, "(T1.LocationId = :AV89Udparg4)");
      if ( ! (Guid.Empty==AV27ResidentPackageId) )
      {
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       new ParDef("AV79Udparg1",GXType.UniqueIdentifier,36,0)
       };
       Object[] prmH00BM3;
       ...
       new ParDef("AV87Udparg3",GXType.UniqueIdentifier,36,0) ,
       ...
       new ParDef("AV86Udparg2",GXType.UniqueIdentifier,36,0)
       };
       Object[] prmH00BM6;
       prmH00BM6 = new Object[] {
       new ParDef("AV89Udparg4",GXType.UniqueIdentifier,36,0) ,
       new ParDef("AV27ResidentPackageId",GXType.UniqueIdentifier,36,0)
       };
       def= new CursorDef[] {
           new CursorDef("H00BM2", "SELECT ResidentPackageId, SG_LocationId, ResidentPackageName FROM Trn_ResidentPackage WHERE SG_LocationId = :AV79Udparg1 ORDER BY SG_LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BM2,100, GxCacheFrequency.OFF ,true,false )
