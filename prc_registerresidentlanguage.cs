...
public class prc_registerresidentlanguage__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00DG2", "UPDATE Trn_Resident SET ResidentLanguage=:ResidentLanguage  WHERE ResidentGUID = ( :AV14UserId)", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00DG2)
       };
    }
 }
