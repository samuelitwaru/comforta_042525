...
namespace GeneXus.Programs {
   public class prc_getthemes : GXProcedure
   {
      ...
      {
         this.AV10SDT_ThemeCollection = new GXBaseCollection<SdtSDT_Theme>( context, "SDT_Theme", "Comforta_version20") ;
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV12SDT_Error.gxTpr_Status = "Error";
            AV12SDT_Error.gxTpr_Message = "Not Authenticated";
         }
         else
         {
            /* Using cursor P00B72 */
      ...
      {
         AV10SDT_ThemeCollection = new GXBaseCollection<SdtSDT_Theme>( context, "SDT_Theme", "Comforta_version20");
