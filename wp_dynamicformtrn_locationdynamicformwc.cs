   ...
   public class wp_dynamicformtrn_locationdynamicformwc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WP_Dynamic Form Trn_Location Dynamic Form WC") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV50OrderedBy), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_47", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_47), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV9WWPFormType", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV9WWPFormType), 1, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWPCONTEXT", GetSecureSignedToken( sPrefix, AV73WWPContext, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vMANAGEFILTERSEXECUTIONSTEP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV45ManageFiltersExecutionStep), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV78Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV78Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV50OrderedBy), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFWWPFORMVERSIONNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV67TFWWPFormVersionNumber), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFWWPFORMVERSIONNUMBER_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV68TFWWPFormVersionNumber_To), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFWWPFORMLATESTVERSIONNUMBER", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV61TFWWPFormLatestVersionNumber), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFWWPFORMLATESTVERSIONNUMBER_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV62TFWWPFormLatestVersionNumber_To), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPFORMTYPE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9WWPFormType), 1, 0, ".", "")));
      ...
      {
         return "WP_Dynamic Form Trn_Location Dynamic Form WC" ;
      }
      ...
      protected void WBBB0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV22FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV22FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Search", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_WP_DynamicFormTrn_LocationDynamicFormWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void STARTBB2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WP_Dynamic Form Trn_Location Dynamic Form WC", 0) ;
            context.wjLoc = "";
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( ( context.localUtil.CToN( cgiGet( sPrefix+"GXH_vORDEREDBY"), ".", ",") != Convert.ToDecimal( AV50OrderedBy )) )
                                             {
                                                Rfr0gs = true;
                                             }
      ...
      protected void STRUPBB0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV9WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV9WWPFormType"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            AV9WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vWWPFORMTYPE"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E15BB2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            {
               AV59TFWWPFormDate = context.localUtil.CToT( Ddo_grid_Filteredtext_get, 2);
               AssignAttri(sPrefix, false, "AV59TFWWPFormDate", context.localUtil.TToC( AV59TFWWPFormDate, 8, 5, 0, 3, "/", ":", " "));
               AV60TFWWPFormDate_To = context.localUtil.CToT( Ddo_grid_Filteredtextto_get, 2);
               AssignAttri(sPrefix, false, "AV60TFWWPFormDate_To", context.localUtil.TToC( AV60TFWWPFormDate_To, 8, 5, 0, 3, "/", ":", " "));
      ...
      protected void S232( )
      {
         ...
         else
         {
            ...
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error cloning a form",  AV56ResultMsg,  "error",  "",  "false",  ""));
         }
      }
      ...
      protected void S202( )
      {
         ...
         while ( AV89GXV7 <= AV28GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV59TFWWPFormDate = context.localUtil.CToT( AV29GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri(sPrefix, false, "AV59TFWWPFormDate", context.localUtil.TToC( AV59TFWWPFormDate, 8, 5, 0, 3, "/", ":", " "));
               AV60TFWWPFormDate_To = context.localUtil.CToT( AV29GridStateFilterValue.gxTpr_Valueto, 2);
               AssignAttri(sPrefix, false, "AV60TFWWPFormDate_To", context.localUtil.TToC( AV60TFWWPFormDate_To, 8, 5, 0, 3, "/", ":", " "));
         ...
         Ddo_grid_Filteredtext_set = GXt_char6+"|"+GXt_char3+"|"+((DateTime.MinValue==AV59TFWWPFormDate) ? "" : context.localUtil.DToC( AV16DDO_WWPFormDateAuxDate, 2, "/"))+"|"+((0==AV67TFWWPFormVersionNumber) ? "" : StringUtil.Str( (decimal)(AV67TFWWPFormVersionNumber), 4, 0))+"|"+((0==AV61TFWWPFormLatestVersionNumber) ? "" : StringUtil.Str( (decimal)(AV61TFWWPFormLatestVersionNumber), 4, 0));
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
         Ddo_grid_Filteredtextto_set = "||"+((DateTime.MinValue==AV60TFWWPFormDate_To) ? "" : context.localUtil.DToC( AV18DDO_WWPFormDateAuxDateTo, 2, "/"))+"|"+((0==AV68TFWWPFormVersionNumber_To) ? "" : StringUtil.Str( (decimal)(AV68TFWWPFormVersionNumber_To), 4, 0))+"|"+((0==AV62TFWWPFormLatestVersionNumber_To) ? "" : StringUtil.Str( (decimal)(AV62TFWWPFormLatestVersionNumber_To), 4, 0));
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "FilteredTextTo_set", Ddo_grid_Filteredtextto_set);
      }
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV28GridState,  "FILTERFULLTEXT",  "Main filter",  !String.IsNullOrEmpty(StringUtil.RTrim( AV22FilterFullText)),  0,  AV22FilterFullText,  AV22FilterFullText,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV28GridState,  "TFWWPFORMTITLE",  "Title",  !String.IsNullOrEmpty(StringUtil.RTrim( AV65TFWWPFormTitle)),  0,  AV65TFWWPFormTitle,  AV65TFWWPFormTitle,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV66TFWWPFormTitle_Sel)),  AV66TFWWPFormTitle_Sel,  AV66TFWWPFormTitle_Sel) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV28GridState,  "TFWWPFORMREFERENCENAME",  "Reference Name",  !String.IsNullOrEmpty(StringUtil.RTrim( AV63TFWWPFormReferenceName)),  0,  AV63TFWWPFormReferenceName,  AV63TFWWPFormReferenceName,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV64TFWWPFormReferenceName_Sel)),  AV64TFWWPFormReferenceName_Sel,  AV64TFWWPFormReferenceName_Sel) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV28GridState,  "TFWWPFORMDATE",  "Date",  !((DateTime.MinValue==AV59TFWWPFormDate)&&(DateTime.MinValue==AV60TFWWPFormDate_To)),  0,  StringUtil.Trim( context.localUtil.TToC( AV59TFWWPFormDate, 8, 5, 0, 3, "/", ":", " ")),  ((DateTime.MinValue==AV59TFWWPFormDate) ? "" : StringUtil.Trim( context.localUtil.Format( AV59TFWWPFormDate, "99/99/99 99:99"))),  true,  StringUtil.Trim( context.localUtil.TToC( AV60TFWWPFormDate_To, 8, 5, 0, 3, "/", ":", " ")),  ((DateTime.MinValue==AV60TFWWPFormDate_To) ? "" : StringUtil.Trim( context.localUtil.Format( AV60TFWWPFormDate_To, "99/99/99 99:99")))) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV28GridState,  "TFWWPFORMVERSIONNUMBER",  "Form Version #",  !((0==AV67TFWWPFormVersionNumber)&&(0==AV68TFWWPFormVersionNumber_To)),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV67TFWWPFormVersionNumber), 4, 0)),  ((0==AV67TFWWPFormVersionNumber) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV67TFWWPFormVersionNumber), "ZZZ9"))),  true,  StringUtil.Trim( StringUtil.Str( (decimal)(AV68TFWWPFormVersionNumber_To), 4, 0)),  ((0==AV68TFWWPFormVersionNumber_To) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV68TFWWPFormVersionNumber_To), "ZZZ9")))) ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV28GridState,  "TFWWPFORMLATESTVERSIONNUMBER",  "Latest Version",  !((0==AV61TFWWPFormLatestVersionNumber)&&(0==AV62TFWWPFormLatestVersionNumber_To)),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV61TFWWPFormLatestVersionNumber), 4, 0)),  ((0==AV61TFWWPFormLatestVersionNumber) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV61TFWWPFormLatestVersionNumber), "ZZZ9"))),  true,  StringUtil.Trim( StringUtil.Str( (decimal)(AV62TFWWPFormLatestVersionNumber_To), 4, 0)),  ((0==AV62TFWWPFormLatestVersionNumber_To) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV62TFWWPFormLatestVersionNumber_To), "ZZZ9")))) ;
         if ( ! (0==AV9WWPFormType) )
         {
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV9WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV9WWPFormType), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV9WWPFormType", StringUtil.Str( (decimal)(AV9WWPFormType), 1, 0));
         }
         else
         {
            AV9WWPFormType = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV9WWPFormType_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV9WWPFormType_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9WWPFormType), 1, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418131567", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_dynamicformtrn_locationdynamicformwc.js", "?202542418131571", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
