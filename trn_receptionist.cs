...
namespace GeneXus.Programs {
   public class trn_receptionist : GXDataArea
   {
      ...
      protected void E120C2( )
      {
         ...
         {
            AV38Session.Set("NotificationMessage", "Receptionist Updated successfully");
         ...
         {
            AV38Session.Set("NotificationMessage", "Receptionist Deleted successfully");
            context.setWebReturnParms(new Object[] {});
            context.setWebReturnParmsMetadata(new Object[] {});
            context.wjLocDisableFrm = 1;
            context.nUserReturn = 1;
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV38Session.Set("NotificationMessage", "Receptionist Inserted successfully");
            context.setWebReturnParms(new Object[] {});
            context.setWebReturnParmsMetadata(new Object[] {});
            context.wjLocDisableFrm = 1;
            context.nUserReturn = 1;
      ...
      protected void CheckExtendedTable0C63( )
      {
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "RECEPTIONISTEMAIL");
            AnyError = 1;
         ...
         A94ReceptionistPhone = GXt_char3;
         AssignAttri("", false, "A94ReceptionistPhone", A94ReceptionistPhone);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A346ReceptionistPhoneNumber)) && ! GxRegex.IsMatch(A346ReceptionistPhoneNumber,"^\\d{9}$") )
         {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_receptionist.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV23ReceptionistId.ToString()),UrlEncode(AV21OrganisationId.ToString()),UrlEncode(AV19LocationId.ToString())}, new string[] {"Gx_mode","ReceptionistId","OrganisationId","LocationId"}) +"\">") ;
      ...
      {
         return formatLink("trn_receptionist.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV23ReceptionistId.ToString()),UrlEncode(AV21OrganisationId.ToString()),UrlEncode(AV19LocationId.ToString())}, new string[] {"Gx_mode","ReceptionistId","OrganisationId","LocationId"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411485634", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_receptionist.js", "?202542411485637", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
