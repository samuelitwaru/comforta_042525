...
namespace GeneXus.Programs {
   public class trn_mediaview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_mediaview.aspx", new object[] {UrlEncode(AV10MediaId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MediaId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_mediaview.aspx", new object[] {UrlEncode(AV10MediaId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MediaId","TabCode"})  ;
      }
      ...
      protected void E126X2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Media",StringUtil.Trim( A413MediaId.ToString()),(string)AV14RecordDescription,formatLink("trn_mediaview.aspx", new object[] {UrlEncode(A413MediaId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"MediaId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542718161966", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_mediaview.js", "?202542718161967", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
