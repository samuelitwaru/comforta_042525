...
namespace GeneXus.Programs {
   public class atrn_theme_dataprovider : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm1trn_theme.gxTpr_Trn_themeid = StringUtil.StrToGuid( "25b80e4f-effe-4d46-afbd-7c72da5a4afc");
         Gxm1trn_theme.gxTpr_Trn_themename = "Minimalistic";
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Inter";
         ...
         Gxm3trn_theme_color.gxTpr_Colorname = "accentColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#554940";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "backgroundColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#7f3e3a";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "borderColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#c8653e";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "buttonBGColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#b3783e";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "buttonTextColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#d99e80";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "cardBgColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#c8ad94";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "cardTextColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#668d63";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "primaryColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#7a8f92";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "secondaryColor";
         Gxm3trn_theme_color.gxTpr_Colorcode = "#a2ad9f";
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         Gxm3trn_theme_color.gxTpr_Colorname = "textColor";
         ...
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Segoe UI";
         Gxm1trn_theme.gxTpr_Trn_themefontsize = 1;
         Gxm1trn_theme.gxTpr_Themeispredefined = true;
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
         ...
         Gxm1trn_theme = new SdtTrn_Theme(context);
         Gxm2rootcol.Add(Gxm1trn_theme, 0);
         Gxm1trn_theme.gxTpr_Trn_themeid = StringUtil.StrToGuid( "2db8170b-2e22-4522-870f-d0d8b3ea0ed3");
         Gxm1trn_theme.gxTpr_Trn_themename = "Retro";
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Roboto";
         Gxm1trn_theme.gxTpr_Trn_themefontsize = 1;
         Gxm1trn_theme.gxTpr_Themeispredefined = true;
         Gxm3trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm3trn_theme_color, 0);
