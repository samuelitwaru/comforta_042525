   ...
   public class trn_organisation_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CONFIRM_010( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( IsDlt( ) )
            {
               OnDeleteControls01102( ) ;
            }
            else
            {
               CheckExtendedTable01102( ) ;
               if ( AnyError == 0 )
               {
                  ZM01102( 16) ;
               }
               CloseExtendedTableCursors01102( ) ;
            }
         }
         if ( AnyError == 0 )
         {
      ...
      protected void ZM01102( short GX_JID )
      {
      ...
      protected void OnLoadActions01102( )
      {
      ...
      protected void CheckExtendedTable01102( )
      {
         standaloneModal( ) ;
         ...
         new prc_concatenateintlphone(context ).execute(  A361OrganisationPhoneCode,  A362OrganisationPhoneNumber, out  GXt_char1) ;
         A17OrganisationPhone = GXt_char1;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A362OrganisationPhoneNumber)) && ! GxRegex.IsMatch(A362OrganisationPhoneNumber,"^\\d{9}$") )
         {
         ...
         A251OrganisationAddressZipCode = StringUtil.Upper( A251OrganisationAddressZipCode);
         if ( ! GxRegex.IsMatch(A251OrganisationAddressZipCode,"^\\d{4}\\s?[A-Z]{2}$") && ! String.IsNullOrEmpty(StringUtil.RTrim( A251OrganisationAddressZipCode)) )
         {
      ...
      protected void CloseExtendedTableCursors01102( )
      {
         pr_default.close(2);
      }
      ...
      protected void CheckOptimisticConcurrency01102( )
      {
         if ( ! IsIns( ) )
         {
      ...
      protected void Insert01102( )
      {
         ...
         {
            ZM01102( 0) ;
            CheckOptimisticConcurrency01102( ) ;
            if ( AnyError == 0 )
            {
               AfterConfirm01102( ) ;
               if ( AnyError == 0 )
      ...
      protected void DeferredUpdate01102( )
      {
         if ( AnyError == 0 )
         {
      ...
      protected void OnDeleteControls01102( )
      {
         standaloneModal( ) ;
         if ( AnyError == 0 )
         {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"General Suppliers"+" ("+"SG_Organisation Supplier"+")"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(10);
      ...
      protected void ScanKeyNext01102( )
      {
         /* Scan next routine */
      ...
      protected void ScanKeyLoad01102( )
      {
         sMode102 = Gx_mode;
         Gx_mode = "DSP";
         if ( (pr_default.getStatus(16) != 101) )
      ...
      protected void ScanKeyEnd01102( )
      {
         pr_default.close(16);
      }

      protected void AfterConfirm01102( )
      {
         /* After Confirm Rules */
      }

      protected void BeforeInsert01102( )
      {
         /* Before Insert Rules */
      }

      protected void BeforeUpdate01102( )
      {
         /* Before Update Rules */
      }

      protected void BeforeDelete01102( )
      {
         /* Before Delete Rules */
      }

      protected void BeforeComplete01102( )
      {
         /* Before Complete Rules */
      }

      protected void BeforeValidate01102( )
      {
         /* Before Validate Rules */
      }

      protected void DisableAttributes01102( )
      {
      }

      protected void send_integrity_lvl_hashes01102( )
      {
      }

      protected void AddRow01102( )
      {
         VarsToRow102( bcTrn_Organisation) ;
      }

      protected void ReadRow01102( )
      {
         RowToVars102( bcTrn_Organisation, 1) ;
      }

      protected void InitializeNonKey01102( )
      {
      ...
      public void VarsToRow102( SdtTrn_Organisation obj102 )
      {
         obj102.gxTpr_Mode = Gx_mode;
         obj102.gxTpr_Organisationphone = A17OrganisationPhone;
         obj102.gxTpr_Organisationaddresszipcode = A251OrganisationAddressZipCode;
         obj102.gxTpr_Organisationname = A13OrganisationName;
         obj102.gxTpr_Organisationkvknumber = A12OrganisationKvkNumber;
         obj102.gxTpr_Organisationemail = A16OrganisationEmail;
         obj102.gxTpr_Organisationphonecode = A361OrganisationPhoneCode;
         obj102.gxTpr_Organisationphonenumber = A362OrganisationPhoneNumber;
         obj102.gxTpr_Organisationvatnumber = A18OrganisationVATNumber;
         obj102.gxTpr_Organisationlogo = A506OrganisationLogo;
         obj102.gxTpr_Organisationlogo_gxi = A40000OrganisationLogo_GXI;
         obj102.gxTpr_Organisationaddresscountry = A303OrganisationAddressCountry;
         obj102.gxTpr_Organisationaddresscity = A252OrganisationAddressCity;
         obj102.gxTpr_Organisationaddressline1 = A304OrganisationAddressLine1;
         obj102.gxTpr_Organisationaddressline2 = A305OrganisationAddressLine2;
         obj102.gxTpr_Organisationtypeid = A19OrganisationTypeId;
         obj102.gxTpr_Organisationtypename = A20OrganisationTypeName;
         obj102.gxTpr_Organisationid = A11OrganisationId;
         obj102.gxTpr_Organisationid_Z = Z11OrganisationId;
         obj102.gxTpr_Organisationname_Z = Z13OrganisationName;
         obj102.gxTpr_Organisationkvknumber_Z = Z12OrganisationKvkNumber;
         obj102.gxTpr_Organisationemail_Z = Z16OrganisationEmail;
         obj102.gxTpr_Organisationphone_Z = Z17OrganisationPhone;
         obj102.gxTpr_Organisationphonecode_Z = Z361OrganisationPhoneCode;
         obj102.gxTpr_Organisationphonenumber_Z = Z362OrganisationPhoneNumber;
         obj102.gxTpr_Organisationvatnumber_Z = Z18OrganisationVATNumber;
         obj102.gxTpr_Organisationaddresscountry_Z = Z303OrganisationAddressCountry;
         obj102.gxTpr_Organisationaddresscity_Z = Z252OrganisationAddressCity;
         obj102.gxTpr_Organisationaddresszipcode_Z = Z251OrganisationAddressZipCode;
         obj102.gxTpr_Organisationaddressline1_Z = Z304OrganisationAddressLine1;
         obj102.gxTpr_Organisationaddressline2_Z = Z305OrganisationAddressLine2;
         obj102.gxTpr_Organisationtypeid_Z = Z19OrganisationTypeId;
         obj102.gxTpr_Organisationtypename_Z = Z20OrganisationTypeName;
         obj102.gxTpr_Organisationlogo_gxi_Z = Z40000OrganisationLogo_GXI;
         obj102.gxTpr_Organisationid_N = (short)(Convert.ToInt16(n11OrganisationId));
         obj102.gxTpr_Mode = Gx_mode;
         return  ;
      }

      public void KeyVarsToRow102( SdtTrn_Organisation obj102 )
      {
         obj102.gxTpr_Organisationid = A11OrganisationId;
         return  ;
      }

      public void RowToVars102( SdtTrn_Organisation obj102 ,
                                int forceLoad )
      {
         Gx_mode = obj102.gxTpr_Mode;
         A17OrganisationPhone = obj102.gxTpr_Organisationphone;
         A251OrganisationAddressZipCode = obj102.gxTpr_Organisationaddresszipcode;
         A13OrganisationName = obj102.gxTpr_Organisationname;
         A12OrganisationKvkNumber = obj102.gxTpr_Organisationkvknumber;
         A16OrganisationEmail = obj102.gxTpr_Organisationemail;
         A361OrganisationPhoneCode = obj102.gxTpr_Organisationphonecode;
         A362OrganisationPhoneNumber = obj102.gxTpr_Organisationphonenumber;
         A18OrganisationVATNumber = obj102.gxTpr_Organisationvatnumber;
         A506OrganisationLogo = obj102.gxTpr_Organisationlogo;
         A40000OrganisationLogo_GXI = obj102.gxTpr_Organisationlogo_gxi;
         A303OrganisationAddressCountry = obj102.gxTpr_Organisationaddresscountry;
         A252OrganisationAddressCity = obj102.gxTpr_Organisationaddresscity;
         A304OrganisationAddressLine1 = obj102.gxTpr_Organisationaddressline1;
         A305OrganisationAddressLine2 = obj102.gxTpr_Organisationaddressline2;
         A19OrganisationTypeId = obj102.gxTpr_Organisationtypeid;
         A20OrganisationTypeName = obj102.gxTpr_Organisationtypename;
         A11OrganisationId = obj102.gxTpr_Organisationid;
         n11OrganisationId = false;
         Z11OrganisationId = obj102.gxTpr_Organisationid_Z;
         Z13OrganisationName = obj102.gxTpr_Organisationname_Z;
         Z12OrganisationKvkNumber = obj102.gxTpr_Organisationkvknumber_Z;
         Z16OrganisationEmail = obj102.gxTpr_Organisationemail_Z;
         Z17OrganisationPhone = obj102.gxTpr_Organisationphone_Z;
         Z361OrganisationPhoneCode = obj102.gxTpr_Organisationphonecode_Z;
         Z362OrganisationPhoneNumber = obj102.gxTpr_Organisationphonenumber_Z;
         Z18OrganisationVATNumber = obj102.gxTpr_Organisationvatnumber_Z;
         Z303OrganisationAddressCountry = obj102.gxTpr_Organisationaddresscountry_Z;
         Z252OrganisationAddressCity = obj102.gxTpr_Organisationaddresscity_Z;
         Z251OrganisationAddressZipCode = obj102.gxTpr_Organisationaddresszipcode_Z;
         Z304OrganisationAddressLine1 = obj102.gxTpr_Organisationaddressline1_Z;
         Z305OrganisationAddressLine2 = obj102.gxTpr_Organisationaddressline2_Z;
         Z19OrganisationTypeId = obj102.gxTpr_Organisationtypeid_Z;
         Z20OrganisationTypeName = obj102.gxTpr_Organisationtypename_Z;
         Z40000OrganisationLogo_GXI = obj102.gxTpr_Organisationlogo_gxi_Z;
         n11OrganisationId = (bool)(Convert.ToBoolean(obj102.gxTpr_Organisationid_N));
         Gx_mode = obj102.gxTpr_Mode;
         return  ;
      }
      ...
      public void Load( )
      {
         ...
         BackMsgLst = context.GX_msglist;
         context.GX_msglist = LclMsgLst;
         RowToVars102( bcTrn_Organisation, 0) ;
         ScanKeyStart01102( ) ;
         if ( RcdFound102 == 0 )
         {
            Gx_mode = "INS";
