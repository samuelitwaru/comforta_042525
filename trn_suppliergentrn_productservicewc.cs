...
namespace GeneXus.Programs {
   public class trn_suppliergentrn_productservicewc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV26OrderedBy, AV27OrderedDsc, AV9FilterFullText, AV32SupplierGenId, AV24ManageFiltersExecutionStep, AV39Pgmname, AV18IsAuthorized_Display, AV22IsAuthorized_Update, AV17IsAuthorized_Delete, AV20IsAuthorized_ProductServiceName, AV19IsAuthorized_Insert, A11OrganisationId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_suppliergentrn_productservicewc.aspx", new object[] {UrlEncode(AV32SupplierGenId.ToString())}, new string[] {"SupplierGenId"}) +"\">") ;
      ...
      protected void E119G2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_SupplierGenTrn_ProductServiceWCFilters")),UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_SupplierGenTrn_ProductServiceWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "FILTERFULLTEXT",  "Main filter",  !String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterFullText)),  0,  AV9FilterFullText,  AV9FilterFullText,  false,  "",  "") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418124853", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_suppliergentrn_productservicewc.js", "?202542418124853", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class trn_suppliergentrn_productservicewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV32SupplierGenId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.OrganisationId, T2.LocationName, T1.LocationId, T1.SupplierGenId, T3.SupplierAgbName, T1.SupplierAgbId, T1.ProductServiceGroup, T1.ProductServiceImage_GXI, T1.ProductServiceClass, T1.ProductServiceDescription, T1.ProductServiceTileName, T1.ProductServiceName, T1.ProductServiceId, T1.ProductServiceImage";
         sFromString = " FROM ((Trn_ProductService T1 INNER JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId) LEFT JOIN Trn_SupplierAGB T3 ON T3.SupplierAgbId = T1.SupplierAgbId)";
         sOrderString = "";
                                             ...
                                             Guid AV32SupplierGenId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((Trn_ProductService T1 INNER JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId) LEFT JOIN Trn_SupplierAGB T3 ON T3.SupplierAgbId = T1.SupplierAgbId)";
         AddWhere(sWhereString, "(T1.SupplierGenId = :AV32SupplierGenId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterFullText)) )
         {
            AddWhere(sWhereString, "(( LOWER(T1.ProductServiceName) like '%' || LOWER(:lV9FilterFullText)) or ( LOWER(T1.ProductServiceTileName) like '%' || LOWER(:lV9FilterFullText)) or ( 'select category' like '%' || LOWER(:lV9FilterFullText) and (char_length(trim(trailing ' ' from T1.ProductServiceClass))=0)) or ( 'my living' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Living')) or ( 'my care' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Care')) or ( 'my services' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Services')))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H009G2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H009G3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
