...
namespace GeneXus.Programs {
   public class trn_dynamicformtranslationgeneral : GXWebComponent
   {
      ...
      {
         this.A587DynamicFormTranslationId = aP0_DynamicFormTranslationId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A587DynamicFormTranslationId", A587DynamicFormTranslationId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A587DynamicFormTranslationId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_dynamicformtranslationgeneral.aspx"+UrlEncode(A587DynamicFormTranslationId.ToString());
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA587DynamicFormTranslationId", wcpOA587DynamicFormTranslationId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WBBJ0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDynamicFormTranslationTrnName_Internalname, A591DynamicFormTranslationTrnName, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", 0, 1, edtDynamicFormTranslationTrnName_Enabled, 0, 80, "chr", 5, "row", 0, StyleString, ClassString, "", "", "400", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_DynamicFormTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtDynamicFormTranslationAttribut_Internalname, A592DynamicFormTranslationAttribut, StringUtil.RTrim( context.localUtil.Format( A592DynamicFormTranslationAttribut, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDynamicFormTranslationAttribut_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDynamicFormTranslationAttribut_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_DynamicFormTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDynamicFormTranslationDutch_Internalname, A594DynamicFormTranslationDutch, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", 0, 1, edtDynamicFormTranslationDutch_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_DynamicFormTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RFBJ2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A594DynamicFormTranslationDutch = H00BJ2_A594DynamicFormTranslationDutch[0];
               AssignAttri(sPrefix, false, "A594DynamicFormTranslationDutch", A594DynamicFormTranslationDutch);
               A593DynamicFormTranslationEnglish = H00BJ2_A593DynamicFormTranslationEnglish[0];
               AssignAttri(sPrefix, false, "A593DynamicFormTranslationEnglish", A593DynamicFormTranslationEnglish);
               A592DynamicFormTranslationAttribut = H00BJ2_A592DynamicFormTranslationAttribut[0];
               AssignAttri(sPrefix, false, "A592DynamicFormTranslationAttribut", A592DynamicFormTranslationAttribut);
               A591DynamicFormTranslationTrnName = H00BJ2_A591DynamicFormTranslationTrnName[0];
               AssignAttri(sPrefix, false, "A591DynamicFormTranslationTrnName", A591DynamicFormTranslationTrnName);
               A590DynamicFormTranslationWWPFormE = H00BJ2_A590DynamicFormTranslationWWPFormE[0];
               ...
               A589DynamicFormTranslationWWPFormV = H00BJ2_A589DynamicFormTranslationWWPFormV[0];
               ...
               A588DynamicFormTranslationWWpFormI = H00BJ2_A588DynamicFormTranslationWWpFormI[0];
      ...
      protected void STRUPBJ0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA587DynamicFormTranslationId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA587DynamicFormTranslationId"));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A587DynamicFormTranslationId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "A587DynamicFormTranslationId", A587DynamicFormTranslationId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA587DynamicFormTranslationId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A587DynamicFormTranslationId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A587DynamicFormTranslationId", A587DynamicFormTranslationId.ToString());
         }
         wcpOA587DynamicFormTranslationId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA587DynamicFormTranslationId"));
         if ( ! GetJustCreated( ) && ( ( A587DynamicFormTranslationId != wcpOA587DynamicFormTranslationId ) ) )
         {
            setjustcreated();
         }
         wcpOA587DynamicFormTranslationId = A587DynamicFormTranslationId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA587DynamicFormTranslationId = cgiGet( sPrefix+"A587DynamicFormTranslationId_CTRL");
         if ( StringUtil.Len( sCtrlA587DynamicFormTranslationId) > 0 )
         {
            A587DynamicFormTranslationId = StringUtil.StrToGuid( cgiGet( sCtrlA587DynamicFormTranslationId));
            AssignAttri(sPrefix, false, "A587DynamicFormTranslationId", A587DynamicFormTranslationId.ToString());
         }
         else
         {
            A587DynamicFormTranslationId = StringUtil.StrToGuid( cgiGet( sPrefix+"A587DynamicFormTranslationId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A587DynamicFormTranslationId_PARM", A587DynamicFormTranslationId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA587DynamicFormTranslationId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A587DynamicFormTranslationId_CTRL", StringUtil.RTrim( sCtrlA587DynamicFormTranslationId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254281333420", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_dynamicformtranslationgeneral.js", "?20254281333420", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A587DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E13BJ2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A587DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E14BJ2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A587DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"}]""");
      ...
      {
         wcpOA587DynamicFormTranslationId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV14Pgmname = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00BJ2_A587DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         H00BJ2_A594DynamicFormTranslationDutch = new string[] {""} ;
         H00BJ2_A593DynamicFormTranslationEnglish = new string[] {""} ;
         H00BJ2_A592DynamicFormTranslationAttribut = new string[] {""} ;
         H00BJ2_A591DynamicFormTranslationTrnName = new string[] {""} ;
         H00BJ2_A590DynamicFormTranslationWWPFormE = new int[1] ;
         H00BJ2_A589DynamicFormTranslationWWPFormV = new int[1] ;
         H00BJ2_A588DynamicFormTranslationWWpFormI = new int[1] ;
         ...
         sCtrlA587DynamicFormTranslationId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_dynamicformtranslationgeneral__default(),
            new Object[][] {
                new Object[] {
               H00BJ2_A587DynamicFormTranslationId, H00BJ2_A594DynamicFormTranslationDutch, H00BJ2_A593DynamicFormTranslationEnglish, H00BJ2_A592DynamicFormTranslationAttribut, H00BJ2_A591DynamicFormTranslationTrnName, H00BJ2_A590DynamicFormTranslationWWPFormE, H00BJ2_A589DynamicFormTranslationWWPFormV, H00BJ2_A588DynamicFormTranslationWWpFormI
               }
            }
         );
         AV14Pgmname = "Trn_DynamicFormTranslationGeneral";
      ...
      private string sCtrlA587DynamicFormTranslationId ;
      ...
      private Guid wcpOA587DynamicFormTranslationId ;
      ...
      private Guid[] H00BJ2_A587DynamicFormTranslationId ;
      private string[] H00BJ2_A594DynamicFormTranslationDutch ;
      private string[] H00BJ2_A593DynamicFormTranslationEnglish ;
      private string[] H00BJ2_A592DynamicFormTranslationAttribut ;
      private string[] H00BJ2_A591DynamicFormTranslationTrnName ;
      private int[] H00BJ2_A590DynamicFormTranslationWWPFormE ;
      private int[] H00BJ2_A589DynamicFormTranslationWWPFormV ;
      private int[] H00BJ2_A588DynamicFormTranslationWWpFormI ;
   ...
   public class trn_dynamicformtranslationgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00BJ2;
          prmH00BJ2 = new Object[] {
          new ParDef("DynamicFormTranslationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00BJ2", "SELECT DynamicFormTranslationId, DynamicFormTranslationDutch, DynamicFormTranslationEnglish, DynamicFormTranslationAttribut, DynamicFormTranslationTrnName, DynamicFormTranslationWWPFormE, DynamicFormTranslationWWPFormV, DynamicFormTranslationWWpFormI FROM Trn_DynamicFormTranslation WHERE DynamicFormTranslationId = :DynamicFormTranslationId ORDER BY DynamicFormTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BJ2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
