...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_AppPreviewVersion.PagesItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_AppPreviewVersion.PagesItem", Namespace="Comforta_version20")]
