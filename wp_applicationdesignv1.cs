...
namespace GeneXus.Programs {
   public class wp_applicationdesignv1 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_applicationdesignv1.aspx", new object[] {UrlEncode(AV41Trn_PageId.ToString())}, new string[] {"Trn_PageId"}) +"\">") ;
      ...
      {
         return formatLink("wp_applicationdesignv1.aspx", new object[] {UrlEncode(AV41Trn_PageId.ToString())}, new string[] {"Trn_PageId"})  ;
      }
      ...
      protected void STARTAJ2( )
      {
         ...
         Form.Meta.addItem("description", "App Builder V1", 0) ;
         context.wjLoc = "";
      ...
      protected void E12AJ2( )
      {
         ...
         while ( (pr_default.getStatus(5) != 101) )
         {
            ...
            AV46MediaPath = "media/" + A414MediaName;
            AV45File = new GxFile(context.GetPhysicalPath());
            AV45File.Source = "media/"+A414MediaName;
            if ( AV45File.Exists() )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254251334217", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesignv1.js", "?20254251334218", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBoxRender.js", "", false, true);
