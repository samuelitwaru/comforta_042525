...
namespace GeneXus.Programs {
   public class trn_calltoaction_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable1572( )
      {
         ...
         A206WWPFormId = BC00154_A206WWPFormId[0];
         A207WWPFormVersionNumber = BC00154_A207WWPFormVersionNumber[0];
         pr_default.close(2);
         GXt_int1 = A219WWPFormLatestVersionNumber;
         new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_getlatestversionofform(context ).execute(  A206WWPFormId, out  GXt_int1) ;
         A219WWPFormLatestVersionNumber = GXt_int1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A500CallToActionPhoneNumber)) && ! GxRegex.IsMatch(A500CallToActionPhoneNumber,"^\\d{9}$") )
         {
      ...
      protected void CheckOptimisticConcurrency1572( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z500CallToActionPhoneNumber, BC00152_A500CallToActionPhoneNumber[0]) != 0 ) || ( StringUtil.StrCmp(Z341CallToActionEmail, BC00152_A341CallToActionEmail[0]) != 0 ) || ( Z366LocationDynamicFormId != BC00152_A366LocationDynamicFormId[0] ) || ( Z11OrganisationId != BC00152_A11OrganisationId[0] ) || ( Z29LocationId != BC00152_A29LocationId[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z58ProductServiceId != BC00152_A58ProductServiceId[0] ) )
            {
      ...
      public override void initialize( )
      {
         ...
         BC00155_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         BC00154_A206WWPFormId = new short[1] ;
         BC00154_A207WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_calltoaction_bc__default(),
            new Object[][] {
                new Object[] {
               BC00152_A339CallToActionId, BC00152_A367CallToActionUrl, BC00152_A368CallToActionName, BC00152_A340CallToActionType, BC00152_A342CallToActionPhone, BC00152_A499CallToActionPhoneCode, BC00152_A500CallToActionPhoneNumber, BC00152_A341CallToActionEmail, BC00152_A366LocationDynamicFormId, BC00152_n366LocationDynamicFormId,
               BC00152_A11OrganisationId, BC00152_A29LocationId, BC00152_A58ProductServiceId
               }
               , new Object[] {
               BC00153_A339CallToActionId, BC00153_A367CallToActionUrl, BC00153_A368CallToActionName, BC00153_A340CallToActionType, BC00153_A342CallToActionPhone, BC00153_A499CallToActionPhoneCode, BC00153_A500CallToActionPhoneNumber, BC00153_A341CallToActionEmail, BC00153_A366LocationDynamicFormId, BC00153_n366LocationDynamicFormId,
               BC00153_A11OrganisationId, BC00153_A29LocationId, BC00153_A58ProductServiceId
               }
               , new Object[] {
               BC00154_A206WWPFormId, BC00154_A207WWPFormVersionNumber
               }
               , new Object[] {
               BC00155_A58ProductServiceId
               }
               , new Object[] {
      ...
      private Guid[] BC00155_A58ProductServiceId ;
      private short[] BC00154_A206WWPFormId ;
      private short[] BC00154_A207WWPFormVersionNumber ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("BC00154", "SELECT WWPFormId, WWPFormVersionNumber FROM Trn_LocationDynamicForm WHERE LocationDynamicFormId = :LocationDynamicFormId AND OrganisationId = :OrganisationId AND LocationId = :LocationId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC00154,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("BC00155", "SELECT ProductServiceId FROM Trn_ProductService WHERE ProductServiceId = :ProductServiceId AND LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC00155,1, GxCacheFrequency.OFF ,true,false )
