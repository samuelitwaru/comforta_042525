...
namespace GeneXus.Programs {
   public class wp_dynamicformtrn_locationdynamicformwcgetfilterdata : GXProcedure
   {
      ...
      protected void S121( )
      {
         ...
         /* Using cursor P00E02 */
         pr_default.execute(0, new Object[] {AV46WWPFormType, AV48LocationId, lV11TFWWPFormTitle, AV12TFWWPFormTitle_Sel, lV13TFWWPFormReferenceName, AV14TFWWPFormReferenceName_Sel, AV15TFWWPFormDate, AV16TFWWPFormDate_To, AV17TFWWPFormVersionNumber, AV18TFWWPFormVersionNumber_To});
         while ( (pr_default.getStatus(0) != 101) )
         {
            BRKE02 = false;
            A240WWPFormType = P00E02_A240WWPFormType[0];
            A29LocationId = P00E02_A29LocationId[0];
            A209WWPFormTitle = P00E02_A209WWPFormTitle[0];
            A231WWPFormDate = P00E02_A231WWPFormDate[0];
            A207WWPFormVersionNumber = P00E02_A207WWPFormVersionNumber[0];
            A208WWPFormReferenceName = P00E02_A208WWPFormReferenceName[0];
            A206WWPFormId = P00E02_A206WWPFormId[0];
            A366LocationDynamicFormId = P00E02_A366LocationDynamicFormId[0];
               ...
               if ( (0==AV19TFWWPFormLatestVersionNumber) || ( ( A219WWPFormLatestVersionNumber >= AV19TFWWPFormLatestVersionNumber ) ) )
               {
                  if ( (0==AV20TFWWPFormLatestVersionNumber_To) || ( ( A219WWPFormLatestVersionNumber <= AV20TFWWPFormLatestVersionNumber_To ) ) )
                  {
                     if ( A207WWPFormVersionNumber == A219WWPFormLatestVersionNumber )
                     {
                        ...
                        AV31count = 0;
                        while ( (pr_default.getStatus(0) != 101) && ( P00E02_A240WWPFormType[0] == A240WWPFormType ) && ( StringUtil.StrCmp(P00E02_A209WWPFormTitle[0], A209WWPFormTitle) == 0 ) )
                        {
                           BRKE02 = false;
                           A29LocationId = P00E02_A29LocationId[0];
                           A207WWPFormVersionNumber = P00E02_A207WWPFormVersionNumber[0];
      ...
      protected void S131( )
      {
         ...
         lV13TFWWPFormReferenceName = StringUtil.Concat( StringUtil.RTrim( AV13TFWWPFormReferenceName), "%", "");
         /* Using cursor P00E03 */
         pr_default.execute(1, new Object[] {AV46WWPFormType, AV48LocationId, lV11TFWWPFormTitle, AV12TFWWPFormTitle_Sel, lV13TFWWPFormReferenceName, AV14TFWWPFormReferenceName_Sel, AV15TFWWPFormDate, AV16TFWWPFormDate_To, AV17TFWWPFormVersionNumber, AV18TFWWPFormVersionNumber_To});
         while ( (pr_default.getStatus(1) != 101) )
         {
            BRKE04 = false;
            A240WWPFormType = P00E03_A240WWPFormType[0];
            A29LocationId = P00E03_A29LocationId[0];
            A207WWPFormVersionNumber = P00E03_A207WWPFormVersionNumber[0];
            A231WWPFormDate = P00E03_A231WWPFormDate[0];
            A208WWPFormReferenceName = P00E03_A208WWPFormReferenceName[0];
            A209WWPFormTitle = P00E03_A209WWPFormTitle[0];
            A206WWPFormId = P00E03_A206WWPFormId[0];
            A366LocationDynamicFormId = P00E03_A366LocationDynamicFormId[0];
               ...
               if ( (0==AV19TFWWPFormLatestVersionNumber) || ( ( A219WWPFormLatestVersionNumber >= AV19TFWWPFormLatestVersionNumber ) ) )
               {
                  if ( (0==AV20TFWWPFormLatestVersionNumber_To) || ( ( A219WWPFormLatestVersionNumber <= AV20TFWWPFormLatestVersionNumber_To ) ) )
                  {
                     if ( A207WWPFormVersionNumber == A219WWPFormLatestVersionNumber )
                     {
                        W240WWPFormType = A240WWPFormType;
                        AV31count = 0;
                        while ( (pr_default.getStatus(1) != 101) && ( P00E03_A240WWPFormType[0] == A240WWPFormType ) && ( P00E03_A206WWPFormId[0] == A206WWPFormId ) && ( P00E03_A207WWPFormVersionNumber[0] == A207WWPFormVersionNumber ) )
                        {
                           BRKE04 = false;
                           A29LocationId = P00E03_A29LocationId[0];
                           A366LocationDynamicFormId = P00E03_A366LocationDynamicFormId[0];
      ...
      public override void initialize( )
      {
         ...
         P00E02_A240WWPFormType = new short[1] ;
         P00E02_A29LocationId = new Guid[] {Guid.Empty} ;
         P00E02_A209WWPFormTitle = new string[] {""} ;
         P00E02_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         P00E02_A207WWPFormVersionNumber = new short[1] ;
         P00E02_A208WWPFormReferenceName = new string[] {""} ;
         P00E02_A206WWPFormId = new short[1] ;
         P00E02_A366LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         P00E02_A11OrganisationId = new Guid[] {Guid.Empty} ;
         A366LocationDynamicFormId = Guid.Empty;
         A11OrganisationId = Guid.Empty;
         AV26Option = "";
         P00E03_A240WWPFormType = new short[1] ;
         P00E03_A29LocationId = new Guid[] {Guid.Empty} ;
         P00E03_A207WWPFormVersionNumber = new short[1] ;
         P00E03_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         P00E03_A208WWPFormReferenceName = new string[] {""} ;
         P00E03_A209WWPFormTitle = new string[] {""} ;
         P00E03_A206WWPFormId = new short[1] ;
         P00E03_A366LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_dynamicformtrn_locationdynamicformwcgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00E02_A240WWPFormType, P00E02_A29LocationId, P00E02_A209WWPFormTitle, P00E02_A231WWPFormDate, P00E02_A207WWPFormVersionNumber, P00E02_A208WWPFormReferenceName, P00E02_A206WWPFormId, P00E02_A366LocationDynamicFormId, P00E02_A11OrganisationId
               }
               , new Object[] {
               P00E03_A240WWPFormType, P00E03_A29LocationId, P00E03_A207WWPFormVersionNumber, P00E03_A231WWPFormDate, P00E03_A208WWPFormReferenceName, P00E03_A209WWPFormTitle, P00E03_A206WWPFormId, P00E03_A366LocationDynamicFormId, P00E03_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00E02_A240WWPFormType ;
      private Guid[] P00E02_A29LocationId ;
      private string[] P00E02_A209WWPFormTitle ;
      private DateTime[] P00E02_A231WWPFormDate ;
      private short[] P00E02_A207WWPFormVersionNumber ;
      private string[] P00E02_A208WWPFormReferenceName ;
      private short[] P00E02_A206WWPFormId ;
      private Guid[] P00E02_A366LocationDynamicFormId ;
      private Guid[] P00E02_A11OrganisationId ;
      private short[] P00E03_A240WWPFormType ;
      private Guid[] P00E03_A29LocationId ;
      private short[] P00E03_A207WWPFormVersionNumber ;
      private DateTime[] P00E03_A231WWPFormDate ;
      private string[] P00E03_A208WWPFormReferenceName ;
      private string[] P00E03_A209WWPFormTitle ;
      private short[] P00E03_A206WWPFormId ;
      private Guid[] P00E03_A366LocationDynamicFormId ;
