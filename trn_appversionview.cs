...
namespace GeneXus.Programs {
   public class trn_appversionview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_appversionview.aspx", new object[] {UrlEncode(AV10AppVersionId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"AppVersionId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_appversionview.aspx", new object[] {UrlEncode(AV10AppVersionId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"AppVersionId","TabCode"})  ;
      }
      ...
      protected void WBBD0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Trn_App Version", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_AppVersionView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPage_title_Internalname, "Page", "", "", lblPage_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_AppVersionView.htm");
            /* Div Control */
      ...
      protected void STARTBD2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_App Version View", 0) ;
         context.wjLoc = "";
      ...
      protected void RFBD2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A523AppVersionId = H00BD2_A523AppVersionId[0];
               /* Execute user event: Load */
               E15BD2 ();
      ...
      protected void STRUPBD0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10AppVersionId = StringUtil.StrToGuid( cgiGet( "vAPPVERSIONID"));
      ...
      protected void E13BD2( )
      {
         ...
         {
            A523AppVersionId = H00BD3_A523AppVersionId[0];
            A524AppVersionName = H00BD3_A524AppVersionName[0];
            AV17GXLvl9 = 1;
      ...
      protected void E12BD2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_AppVersion",StringUtil.Trim( A523AppVersionId.ToString()),(string)AV14RecordDescription,formatLink("trn_appversionview.aspx", new object[] {UrlEncode(A523AppVersionId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"AppVersionId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241212044", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_appversionview.js", "?20254241212044", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_App Version View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BD2","iparms":[{"av":"A523AppVersionId","fld":"APPVERSIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BD2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H00BD2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00BD3_A523AppVersionId = new Guid[] {Guid.Empty} ;
         H00BD3_A524AppVersionName = new string[] {""} ;
         A524AppVersionName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionview__default(),
            new Object[][] {
                new Object[] {
               H00BD2_A523AppVersionId
               }
               , new Object[] {
               H00BD3_A523AppVersionId, H00BD3_A524AppVersionName
               }
            }
         );
      ...
      private Guid[] H00BD2_A523AppVersionId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00BD3_A523AppVersionId ;
      private string[] H00BD3_A524AppVersionName ;
   ...
   public class trn_appversionview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00BD2", "SELECT AppVersionId FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BD2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00BD3", "SELECT AppVersionId, AppVersionName FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BD3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
