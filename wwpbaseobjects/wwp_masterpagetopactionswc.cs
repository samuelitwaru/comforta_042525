...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpagetopactionswc : GXWebComponent
   {
      ...
      protected void S112( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MYPROFILE", GetSecureSignedToken( sPrefix, AV16IsAuthorized_MyProfile, context));
         if ( ! ( AV16IsAuthorized_MyProfile && ( StringUtil.Contains( AV12RolesDescriptions, "Organisation Manager") || StringUtil.Contains( AV12RolesDescriptions, "Receptionist") ) ) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411441242", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202542411441247", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
