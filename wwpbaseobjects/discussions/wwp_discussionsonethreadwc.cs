   ...
   public class wwp_discussionsonethreadwc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wwpbaseobjects.discussions.wwp_discussionsonethreadwc.aspx"+UrlEncode(StringUtil.LTrimStr(AV40WWPDiscussionMessageThreadId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV44WWPSubscriptionEntityRecordDescription)) + "," + UrlEncode(StringUtil.RTrim(AV42WWPNotificationLink));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542812581759", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/discussions/wwp_discussionsonethreadwc.js", "?202542812581763", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Suggest/SuggestRender.js", "", false, true);
