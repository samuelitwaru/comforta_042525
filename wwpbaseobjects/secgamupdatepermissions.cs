...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secgamupdatepermissions : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV27SecGAMFunctionalitiesToLoadCollection = new GXBaseCollection<WorkWithPlus.workwithplus_commongam.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "Comforta_version20");
         GXt_objcol_SdtSecGAMFunctionalitiesToLoad1 = new GXBaseCollection<WorkWithPlus.workwithplus_commongam.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "Comforta_version20");
