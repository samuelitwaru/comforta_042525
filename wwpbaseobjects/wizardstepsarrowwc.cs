   ...
   public class wizardstepsarrowwc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("wwpbaseobjects.wizardstepsarrowwc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV22WebSessionKey)),UrlEncode(StringUtil.RTrim(AV11SelectedStep))}, new string[] {"WebSessionKey","WizardSteps","SelectedStep"}) +"\">") ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV25GXV1 = nGXsfl_5_idx;
                              if ( ( AV19WizardStepsAux.Count >= AV25GXV1 ) && ( AV25GXV1 > 0 ) )
                              {
                                 AV19WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV25GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void E12162( )
      {
         ...
         if ( AV19WizardStepsAux.Count > AV7MaxStepsToShow )
         {
            ...
            AV27GXV3 = 1;
            while ( AV27GXV3 <= AV19WizardStepsAux.Count )
            {
               AV17WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV27GXV3));
      ...
      private void E13162( )
      {
         ...
         returnInSub = false;
         AV25GXV1 = 1;
         while ( AV25GXV1 <= AV19WizardStepsAux.Count )
         {
            AV19WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV25GXV1));
      ...
      {
         AV25GXV1 = nGXsfl_5_idx;
         if ( ( AV25GXV1 > 0 ) && ( AV19WizardStepsAux.Count >= AV25GXV1 ) )
         {
            AV19WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV25GXV1));
         }
         ...
         if ( ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) != 0 ) && ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Allowclick )
         {
            AV23ClickedIndex = 1;
            AV28GXV4 = 1;
            while ( AV28GXV4 <= AV18WizardSteps.Count )
            {
               AV17WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV28GXV4));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542717553874", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?202542717553875", false, true);
         }
