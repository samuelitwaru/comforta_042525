...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_automaticnotificationdefinitionstoload : GXProcedure
   {
      ...
      {
         this.Gxm3rootcol = new GXBCCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_NotificationDefinition>( context, "WWP_NotificationDefinition", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
