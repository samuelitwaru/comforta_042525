...
namespace GeneXus.Programs {
   public class trn_pageview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_pageview.aspx", new object[] {UrlEncode(AV10Trn_PageId.ToString()),UrlEncode(AV12LocationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Trn_PageId","LocationId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_pageview.aspx", new object[] {UrlEncode(AV10Trn_PageId.ToString()),UrlEncode(AV12LocationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Trn_PageId","LocationId","TabCode"})  ;
      }
      ...
      protected void WB9C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to App builder pages", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_PageView.htm");
      ...
      protected void E129C2( )
      {
         ...
         if ( AV18IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Page",StringUtil.Trim( A392Trn_PageId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV16RecordDescription,formatLink("trn_pageview.aspx", new object[] {UrlEncode(A392Trn_PageId.ToString()),UrlEncode(A29LocationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_PageId","LocationId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418154828", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_pageview.js", "?202542418154828", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
