...
namespace GeneXus.Programs {
   public class trn_themeview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_themeview.aspx", new object[] {UrlEncode(AV10Trn_ThemeId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Trn_ThemeId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_themeview.aspx", new object[] {UrlEncode(AV10Trn_ThemeId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Trn_ThemeId","TabCode"})  ;
      }
      ...
      protected void WB6V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCtacolor_title_Internalname, "Cta Color", "", "", lblCtacolor_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ThemeView.htm");
            /* Div Control */
      ...
      protected void STRUP6V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10Trn_ThemeId = StringUtil.StrToGuid( cgiGet( "vTRN_THEMEID"));
      ...
      protected void E126V2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0058",(string)"",(string)"Trn_Theme",StringUtil.Trim( A273Trn_ThemeId.ToString()),(string)AV14RecordDescription,formatLink("trn_themeview.aspx", new object[] {UrlEncode(A273Trn_ThemeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_ThemeId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411552810", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_themeview.js", "?202542411552810", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
