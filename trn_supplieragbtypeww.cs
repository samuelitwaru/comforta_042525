...
namespace GeneXus.Programs {
   public class trn_supplieragbtypeww : GXDataArea
   {
      ...
      private void E194B2( )
      {
         ...
         {
            edtSupplierAgbTypeName_Link = formatLink("trn_supplieragbtypeview.aspx", new object[] {UrlEncode(A255SupplierAgbTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"SupplierAgbTypeId","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E114B2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_SupplierAgbTypeWWFilters")),UrlEncode(StringUtil.RTrim(AV42Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV18ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV18ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV18ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_SupplierAgbTypeWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV18ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV18ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV18ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void E164B2( )
      {
         ...
         {
            context.PopUp(formatLink("trn_supplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","SupplierAgbTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV40ColumnsSelector,  "SupplierAgbTypeName",  "",  "Type Name",  true,  "") ;
      ...
      protected void S202( )
      {
         ...
         if ( AV30IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_supplieragbtypeview.aspx", new object[] {UrlEncode(A255SupplierAgbTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"SupplierAgbTypeId","TabCode"}) );
      ...
      protected void S212( )
      {
         ...
         if ( AV32IsAuthorized_Update )
         {
            context.PopUp(formatLink("trn_supplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A255SupplierAgbTypeId.ToString())}, new string[] {"Mode","SupplierAgbTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV34IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_supplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A255SupplierAgbTypeId.ToString())}, new string[] {"Mode","SupplierAgbTypeId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411544863", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbtypeww.js", "?202542411544866", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E164B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierAgbTypeName","fld":"vTFSUPPLIERAGBTYPENAME"},{"av":"AV20TFSupplierAgbTypeName_Sel","fld":"vTFSUPPLIERAGBTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierAgbTypeName","fld":"vISAUTHORIZED_SUPPLIERAGBTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID","hsh":true}]""");
