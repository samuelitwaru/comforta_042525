...
namespace GeneXus.Programs {
   public class prc_getlocationimages : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSDT_FileUploadData> aP1_SDT_FileUploadDataCollection )
      {
         ...
         this.AV13SDT_FileUploadDataCollection = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A614OrganisationLocationId = P00FW2_A614OrganisationLocationId[0];
            A40000OrganisationLocationImage_GXI = P00FW2_A40000OrganisationLocationImage_GXI[0];
            A613LocationImageId = P00FW2_A613LocationImageId[0];
            A615OrganisationLocationImage = P00FW2_A615OrganisationLocationImage[0];
      ...
      {
         AV13SDT_FileUploadDataCollection = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         P00FW2_A614OrganisationLocationId = new Guid[] {Guid.Empty} ;
         P00FW2_A40000OrganisationLocationImage_GXI = new string[] {""} ;
         P00FW2_A613LocationImageId = new Guid[] {Guid.Empty} ;
         P00FW2_A615OrganisationLocationImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getlocationimages__default(),
            new Object[][] {
                new Object[] {
               P00FW2_A614OrganisationLocationId, P00FW2_A40000OrganisationLocationImage_GXI, P00FW2_A613LocationImageId, P00FW2_A615OrganisationLocationImage
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00FW2_A614OrganisationLocationId ;
      private string[] P00FW2_A40000OrganisationLocationImage_GXI ;
      private Guid[] P00FW2_A613LocationImageId ;
      private string[] P00FW2_A615OrganisationLocationImage ;
   ...
   public class prc_getlocationimages__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00FW2", "SELECT OrganisationLocationId, OrganisationLocationImage_GXI, LocationImageId, OrganisationLocationImage FROM Trn_LocationImage WHERE OrganisationLocationId = :AV14LocationId ORDER BY LocationImageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00FW2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
