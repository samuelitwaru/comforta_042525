...
namespace GeneXus.Programs {
   public class prc_getserviceimages : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A609ServiceId = P00FZ2_A609ServiceId[0];
            A40000ServiceImage_GXI = P00FZ2_A40000ServiceImage_GXI[0];
            A608ServiceImageId = P00FZ2_A608ServiceImageId[0];
            A611ServiceImage = P00FZ2_A611ServiceImage[0];
      ...
      public override void initialize( )
      {
         ...
         P00FZ2_A609ServiceId = new Guid[] {Guid.Empty} ;
         P00FZ2_A40000ServiceImage_GXI = new string[] {""} ;
         P00FZ2_A608ServiceImageId = new Guid[] {Guid.Empty} ;
         P00FZ2_A611ServiceImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getserviceimages__default(),
            new Object[][] {
                new Object[] {
               P00FZ2_A609ServiceId, P00FZ2_A40000ServiceImage_GXI, P00FZ2_A608ServiceImageId, P00FZ2_A611ServiceImage
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00FZ2_A609ServiceId ;
      private string[] P00FZ2_A40000ServiceImage_GXI ;
      private Guid[] P00FZ2_A608ServiceImageId ;
      private string[] P00FZ2_A611ServiceImage ;
   ...
   public class prc_getserviceimages__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00FZ2", "SELECT ServiceId, ServiceImage_GXI, ServiceImageId, ServiceImage FROM Trn_ServiceImage WHERE ServiceId = :AV10ProductServiceId ORDER BY ServiceId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00FZ2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
