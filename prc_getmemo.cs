   ...
   public class prc_getmemo : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A542MemoCategoryId = P00CV2_A542MemoCategoryId[0];
            A543MemoCategoryName = P00CV2_A543MemoCategoryName[0];
      ...
      public override void initialize( )
      {
         ...
         P00CV2_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00CV2_A543MemoCategoryName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getmemo__default(),
            new Object[][] {
                new Object[] {
               P00CV2_A528SG_LocationId, P00CV2_A29LocationId, P00CV2_A529SG_OrganisationId, P00CV2_A11OrganisationId, P00CV2_A549MemoId, P00CV2_A542MemoCategoryId, P00CV2_A543MemoCategoryName, P00CV2_A550MemoTitle, P00CV2_A551MemoDescription, P00CV2_A552MemoImage,
               P00CV2_n552MemoImage, P00CV2_A553MemoDocument, P00CV2_n553MemoDocument, P00CV2_A561MemoStartDateTime, P00CV2_n561MemoStartDateTime, P00CV2_A562MemoEndDateTime, P00CV2_n562MemoEndDateTime, P00CV2_A563MemoDuration, P00CV2_n563MemoDuration, P00CV2_A564MemoRemoveDate,
               P00CV2_A62ResidentId, P00CV2_A72ResidentSalutation, P00CV2_A64ResidentGivenName, P00CV2_A65ResidentLastName, P00CV2_A71ResidentGUID, P00CV2_A566MemoBgColorCode, P00CV2_A567MemoForm
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00CV2_A542MemoCategoryId ;
      private string[] P00CV2_A543MemoCategoryName ;
