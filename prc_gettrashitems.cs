...
namespace GeneXus.Programs {
   public class prc_gettrashitems : GXProcedure
   {
      ...
      {
         this.AV9SDT_TrashItems = new GXBaseCollection<SdtSDT_TrashItem>( context, "SDT_TrashItem", "Comforta_version20") ;
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A620IsVersionDeleted = P00GD2_A620IsVersionDeleted[0];
            A29LocationId = P00GD2_A29LocationId[0];
            n29LocationId = P00GD2_n29LocationId[0];
            A523AppVersionId = P00GD2_A523AppVersionId[0];
            A622VersionDeletedAt = P00GD2_A622VersionDeletedAt[0];
            n622VersionDeletedAt = P00GD2_n622VersionDeletedAt[0];
         ...
         {
            A523AppVersionId = P00GD3_A523AppVersionId[0];
            A535IsActive = P00GD3_A535IsActive[0];
            /* Using cursor P00GD4 */
            pr_default.execute(2, new Object[] {A523AppVersionId});
            while ( (pr_default.getStatus(2) != 101) )
            {
               A621IsPageDeleted = P00GD4_A621IsPageDeleted[0];
               A516PageId = P00GD4_A516PageId[0];
               A517PageName = P00GD4_A517PageName[0];
               A525PageType = P00GD4_A525PageType[0];
               A518PageStructure = P00GD4_A518PageStructure[0];
               A623PageDeletedAt = P00GD4_A623PageDeletedAt[0];
               n623PageDeletedAt = P00GD4_n623PageDeletedAt[0];
               AV8TrashItem = new SdtSDT_TrashItem(context);
      ...
      {
         AV9SDT_TrashItems = new GXBaseCollection<SdtSDT_TrashItem>( context, "SDT_TrashItem", "Comforta_version20");
         AV15SDT_Error = new SdtSDT_Error(context);
         AV12LocationId = Guid.Empty;
         GXt_guid1 = Guid.Empty;
         P00GD2_A620IsVersionDeleted = new bool[] {false} ;
         P00GD2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00GD2_n29LocationId = new bool[] {false} ;
         P00GD2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00GD2_A622VersionDeletedAt = new DateTime[] {DateTime.MinValue} ;
         P00GD2_n622VersionDeletedAt = new bool[] {false} ;
         ...
         P00GD3_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00GD3_A535IsActive = new bool[] {false} ;
         P00GD4_A523AppVersionId = new Guid[] {Guid.Empty} ;
         P00GD4_A621IsPageDeleted = new bool[] {false} ;
         P00GD4_A516PageId = new Guid[] {Guid.Empty} ;
         P00GD4_A517PageName = new string[] {""} ;
         P00GD4_A525PageType = new string[] {""} ;
         P00GD4_A518PageStructure = new string[] {""} ;
         P00GD4_A623PageDeletedAt = new DateTime[] {DateTime.MinValue} ;
         P00GD4_n623PageDeletedAt = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_gettrashitems__default(),
            new Object[][] {
                new Object[] {
               P00GD2_A620IsVersionDeleted, P00GD2_A29LocationId, P00GD2_n29LocationId, P00GD2_A523AppVersionId, P00GD2_A622VersionDeletedAt, P00GD2_n622VersionDeletedAt
               }
               , new Object[] {
               P00GD3_A523AppVersionId, P00GD3_A535IsActive
               }
               , new Object[] {
               P00GD4_A523AppVersionId, P00GD4_A621IsPageDeleted, P00GD4_A516PageId, P00GD4_A517PageName, P00GD4_A525PageType, P00GD4_A518PageStructure, P00GD4_A623PageDeletedAt, P00GD4_n623PageDeletedAt
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P00GD2_A620IsVersionDeleted ;
      private Guid[] P00GD2_A29LocationId ;
      private bool[] P00GD2_n29LocationId ;
      private Guid[] P00GD2_A523AppVersionId ;
      private DateTime[] P00GD2_A622VersionDeletedAt ;
      private bool[] P00GD2_n622VersionDeletedAt ;
      ...
      private Guid[] P00GD3_A523AppVersionId ;
      private bool[] P00GD3_A535IsActive ;
      private Guid[] P00GD4_A523AppVersionId ;
      private bool[] P00GD4_A621IsPageDeleted ;
      private Guid[] P00GD4_A516PageId ;
      private string[] P00GD4_A517PageName ;
      private string[] P00GD4_A525PageType ;
      private string[] P00GD4_A518PageStructure ;
      private DateTime[] P00GD4_A623PageDeletedAt ;
      private bool[] P00GD4_n623PageDeletedAt ;
   ...
   public class prc_gettrashitems__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00GD2", "SELECT IsVersionDeleted, LocationId, AppVersionId, VersionDeletedAt FROM Trn_AppVersion WHERE (LocationId = :AV12LocationId) AND (IsVersionDeleted = TRUE) ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GD2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00GD3", "SELECT AppVersionId, IsActive FROM Trn_AppVersion WHERE IsActive = TRUE ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GD3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00GD4", "SELECT AppVersionId, IsPageDeleted, PageId, PageName, PageType, PageStructure, PageDeletedAt FROM Trn_AppVersionPage WHERE (AppVersionId = :AppVersionId) AND (IsPageDeleted = TRUE) ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GD4,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
