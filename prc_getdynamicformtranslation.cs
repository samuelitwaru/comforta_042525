...
namespace GeneXus.Programs {
   public class prc_getdynamicformtranslation : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A590DynamicFormTranslationWWPFormE = P00EJ2_A590DynamicFormTranslationWWPFormE[0];
            A589DynamicFormTranslationWWPFormV = P00EJ2_A589DynamicFormTranslationWWPFormV[0];
            A588DynamicFormTranslationWWpFormI = P00EJ2_A588DynamicFormTranslationWWpFormI[0];
            A593DynamicFormTranslationEnglish = P00EJ2_A593DynamicFormTranslationEnglish[0];
            A594DynamicFormTranslationDutch = P00EJ2_A594DynamicFormTranslationDutch[0];
            A587DynamicFormTranslationId = P00EJ2_A587DynamicFormTranslationId[0];
            if ( StringUtil.StrCmp(AV11Language, "English") == 0 )
            {
               AV10SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue = A593DynamicFormTranslationEnglish;
            }
            else if ( StringUtil.StrCmp(AV11Language, "Dutch") == 0 )
            {
               AV10SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue = A594DynamicFormTranslationDutch;
            }
      ...
      {
         AV11Language = "";
         P00EJ2_A590DynamicFormTranslationWWPFormE = new int[1] ;
         P00EJ2_A589DynamicFormTranslationWWPFormV = new int[1] ;
         P00EJ2_A588DynamicFormTranslationWWpFormI = new int[1] ;
         P00EJ2_A593DynamicFormTranslationEnglish = new string[] {""} ;
         P00EJ2_A594DynamicFormTranslationDutch = new string[] {""} ;
         P00EJ2_A587DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getdynamicformtranslation__default(),
            new Object[][] {
                new Object[] {
               P00EJ2_A590DynamicFormTranslationWWPFormE, P00EJ2_A589DynamicFormTranslationWWPFormV, P00EJ2_A588DynamicFormTranslationWWpFormI, P00EJ2_A593DynamicFormTranslationEnglish, P00EJ2_A594DynamicFormTranslationDutch, P00EJ2_A587DynamicFormTranslationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] P00EJ2_A590DynamicFormTranslationWWPFormE ;
      private int[] P00EJ2_A589DynamicFormTranslationWWPFormV ;
      private int[] P00EJ2_A588DynamicFormTranslationWWpFormI ;
      private string[] P00EJ2_A593DynamicFormTranslationEnglish ;
      private string[] P00EJ2_A594DynamicFormTranslationDutch ;
      private Guid[] P00EJ2_A587DynamicFormTranslationId ;
   }
