   ...
   public class prc_countlocationfilledforms : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            cV13LocationFilledFormsCount = P00EY3_AV13LocationFilledFormsCount[0];
            pr_default.close(1);
      ...
      public override void initialize( )
      {
         ...
         P00EY3_AV13LocationFilledFormsCount = new short[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_countlocationfilledforms__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00EY3_AV13LocationFilledFormsCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00EY3_AV13LocationFilledFormsCount ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00EY3", "SELECT COUNT(*) FROM Trn_Resident WHERE (LocationId = :AV16Udparg1) AND (ResidentGUID = ( :AV12WWPUserExtendedId)) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EY3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
