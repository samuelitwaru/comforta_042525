...
namespace GeneXus.Programs {
   public class trn_supplieragbloaddvcombo : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         AV32GXV1 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
         ...
         AV38GXV4 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version20");
