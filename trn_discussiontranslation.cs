...
namespace GeneXus.Programs {
   public class trn_discussiontranslation : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Discussion Translation", 0) ;
         context.wjLoc = "";
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, "General Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_DiscussionTranslation.htm");
         /* Div Control */
         ...
         GxWebStd.gx_label_element( context, edtTrn_DiscussionTranslationId_Internalname, "Translation Id", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtTrn_DiscussionTranslationId_Internalname, A585Trn_DiscussionTranslationId.ToString(), A585Trn_DiscussionTranslationId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_DiscussionTranslationId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTrn_DiscussionTranslationId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_DiscussionTranslation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtDiscussionTranslationWWPDiscus_Internalname, "Message Id", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtDiscussionTranslationWWPDiscus_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0, ".", "")), StringUtil.LTrim( ((edtDiscussionTranslationWWPDiscus_Enabled!=0) ? context.localUtil.Format( (decimal)(A586DiscussionTranslationWWPDiscus), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A586DiscussionTranslationWWPDiscus), "ZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDiscussionTranslationWWPDiscus_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDiscussionTranslationWWPDiscus_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Trn_DiscussionTranslation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtDiscussionTranslationEnglish_Internalname, "Translation English", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Multiple line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtDiscussionTranslationDutch_Internalname, "Translation Dutch", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Multiple line edit */
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_enter_Internalname, "", "Confirm", bttBtntrn_enter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtntrn_enter_Visible, bttBtntrn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_DiscussionTranslation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_cancel_Internalname, "", "Cancel", bttBtntrn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, bttBtntrn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_DiscussionTranslation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "ButtonMaterialDefault";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_delete_Internalname, "", "Delete", bttBtntrn_delete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtntrn_delete_Visible, bttBtntrn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_DiscussionTranslation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               /* Read saved SDTs. */
               /* Read saved values. */
               Z585Trn_DiscussionTranslationId = StringUtil.StrToGuid( cgiGet( "Z585Trn_DiscussionTranslationId"));
               Z586DiscussionTranslationWWPDiscus = (long)(Math.Round(context.localUtil.CToN( cgiGet( "Z586DiscussionTranslationWWPDiscus"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               {
                  A585Trn_DiscussionTranslationId = Guid.Empty;
                  AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
               }
               else
               {
                  try
                  {
                     A585Trn_DiscussionTranslationId = StringUtil.StrToGuid( cgiGet( edtTrn_DiscussionTranslationId_Internalname));
                     AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
                  }
                  catch ( Exception  )
                  {
               ...
               if ( ( ( context.localUtil.CToN( cgiGet( edtDiscussionTranslationWWPDiscus_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtDiscussionTranslationWWPDiscus_Internalname), ".", ",") > Convert.ToDecimal( 9999999999L )) ) )
               {
                  ...
                  AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
                  A586DiscussionTranslationWWPDiscus = 0;
                  AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrimStr( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0));
               }
               else
               {
                  A586DiscussionTranslationWWPDiscus = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtDiscussionTranslationWWPDiscus_Internalname), ".", ","), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrimStr( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0));
               }
            ...
            else
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
               {
                  ...
                  A585Trn_DiscussionTranslationId = StringUtil.StrToGuid( GetPar( "Trn_DiscussionTranslationId"));
                  AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
                  getEqualNoModal( ) ;
                  if ( IsIns( )  && (Guid.Empty==A585Trn_DiscussionTranslationId) && ( Gx_BScreen == 0 ) )
                  {
                     A585Trn_DiscussionTranslationId = Guid.NewGuid( );
                     AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
                  }
                  Gx_mode = "DSP";
                  AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void ZM1S106( short GX_JID )
      {
         if ( ( GX_JID == 3 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z586DiscussionTranslationWWPDiscus = T001S3_A586DiscussionTranslationWWPDiscus[0];
            ...
            {
               Z586DiscussionTranslationWWPDiscus = A586DiscussionTranslationWWPDiscus;
         ...
         if ( GX_JID == -3 )
         {
            Z585Trn_DiscussionTranslationId = A585Trn_DiscussionTranslationId;
            Z586DiscussionTranslationWWPDiscus = A586DiscussionTranslationWWPDiscus;
            Z595DiscussionTranslationEnglish = A595DiscussionTranslationEnglish;
            Z596DiscussionTranslationDutch = A596DiscussionTranslationDutch;
         }
      ...
      protected void Load1S106( )
      {
         /* Using cursor T001S4 */
         pr_default.execute(2, new Object[] {A585Trn_DiscussionTranslationId});
         if ( (pr_default.getStatus(2) != 101) )
         {
            RcdFound106 = 1;
            A586DiscussionTranslationWWPDiscus = T001S4_A586DiscussionTranslationWWPDiscus[0];
            AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrimStr( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0));
      ...
      protected void OnLoadActions1S106( )
      {
      }

      protected void CheckExtendedTable1S106( )
      {
         Gx_BScreen = 1;
         AssignAttri("", false, "Gx_BScreen", StringUtil.Str( (decimal)(Gx_BScreen), 1, 0));
         standaloneModal( ) ;
      ...
      protected void CloseExtendedTableCursors1S106( )
      {
      }
      ...
      protected void GetKey1S106( )
      {
         /* Using cursor T001S5 */
         pr_default.execute(3, new Object[] {A585Trn_DiscussionTranslationId});
      ...
      {
         /* Using cursor T001S3 */
         pr_default.execute(1, new Object[] {A585Trn_DiscussionTranslationId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM1S106( 3) ;
            RcdFound106 = 1;
            A585Trn_DiscussionTranslationId = T001S3_A585Trn_DiscussionTranslationId[0];
            AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
            A586DiscussionTranslationWWPDiscus = T001S3_A586DiscussionTranslationWWPDiscus[0];
            AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrimStr( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0));
      ...
      protected void move_next( )
      {
         RcdFound106 = 0;
         /* Using cursor T001S6 */
         pr_default.execute(4, new Object[] {A585Trn_DiscussionTranslationId});
         if ( (pr_default.getStatus(4) != 101) )
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( GuidUtil.Compare(T001S6_A585Trn_DiscussionTranslationId[0], A585Trn_DiscussionTranslationId, 0) < 0 ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( GuidUtil.Compare(T001S6_A585Trn_DiscussionTranslationId[0], A585Trn_DiscussionTranslationId, 0) > 0 ) ) )
            {
               A585Trn_DiscussionTranslationId = T001S6_A585Trn_DiscussionTranslationId[0];
               AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
               RcdFound106 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound106 = 0;
         /* Using cursor T001S7 */
         pr_default.execute(5, new Object[] {A585Trn_DiscussionTranslationId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( GuidUtil.Compare(T001S7_A585Trn_DiscussionTranslationId[0], A585Trn_DiscussionTranslationId, 0) > 0 ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( GuidUtil.Compare(T001S7_A585Trn_DiscussionTranslationId[0], A585Trn_DiscussionTranslationId, 0) < 0 ) ) )
            {
               A585Trn_DiscussionTranslationId = T001S7_A585Trn_DiscussionTranslationId[0];
               AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
               RcdFound106 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound106 == 1 )
            {
               if ( A585Trn_DiscussionTranslationId != Z585Trn_DiscussionTranslationId )
               {
                  A585Trn_DiscussionTranslationId = Z585Trn_DiscussionTranslationId;
                  AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
      ...
      protected void CheckOptimisticConcurrency1S106( )
      {
         if ( ! IsIns( ) )
         {
            /* Using cursor T001S2 */
            pr_default.execute(0, new Object[] {A585Trn_DiscussionTranslationId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( Z586DiscussionTranslationWWPDiscus != T001S2_A586DiscussionTranslationWWPDiscus[0] ) || ( StringUtil.StrCmp(Z595DiscussionTranslationEnglish, T001S2_A595DiscussionTranslationEnglish[0]) != 0 ) || ( StringUtil.StrCmp(Z596DiscussionTranslationDutch, T001S2_A596DiscussionTranslationDutch[0]) != 0 ) )
            {
               if ( Z586DiscussionTranslationWWPDiscus != T001S2_A586DiscussionTranslationWWPDiscus[0] )
               {
                  GXUtil.WriteLog("trn_discussiontranslation:[seudo value changed for attri]"+"DiscussionTranslationWWPDiscus");
                  GXUtil.WriteLogRaw("Old: ",Z586DiscussionTranslationWWPDiscus);
                  GXUtil.WriteLogRaw("Current: ",T001S2_A586DiscussionTranslationWWPDiscus[0]);
               }
      ...
      protected void Insert1S106( )
      {
         ...
         if ( AnyError == 0 )
         {
            CheckExtendedTable1S106( ) ;
         }
         if ( AnyError == 0 )
         {
            ZM1S106( 0) ;
            CheckOptimisticConcurrency1S106( ) ;
            if ( AnyError == 0 )
            {
               AfterConfirm1S106( ) ;
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T001S8 */
                     pr_default.execute(6, new Object[] {A585Trn_DiscussionTranslationId, A586DiscussionTranslationWWPDiscus, A595DiscussionTranslationEnglish, A596DiscussionTranslationDutch});
                     pr_default.close(6);
         ...
         CloseExtendedTableCursors1S106( ) ;
      }

      protected void Update1S106( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T001S9 */
                     pr_default.execute(7, new Object[] {A586DiscussionTranslationWWPDiscus, A595DiscussionTranslationEnglish, A596DiscussionTranslationDutch, A585Trn_DiscussionTranslationId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_DiscussionTranslation");
      ...
      protected void DeferredUpdate1S106( )
      {
      }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {A585Trn_DiscussionTranslationId});
                  pr_default.close(8);
                  pr_default.SmartCacheProvider.SetUpdated("Trn_DiscussionTranslation");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls1S106( )
      {
         standaloneModal( ) ;
         /* No delete mode formulas found. */
      }

      protected void EndLevel1S106( )
      {
         if ( ! IsIns( ) )
         {
            pr_default.close(0);
      ...
      public void ScanStart1S106( )
      {
         ...
         {
            RcdFound106 = 1;
            A585Trn_DiscussionTranslationId = T001S11_A585Trn_DiscussionTranslationId[0];
            AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext1S106( )
      {
         /* Scan next routine */
      ...
      protected void ScanEnd1S106( )
      {
         pr_default.close(9);
      }

      protected void AfterConfirm1S106( )
      {
         /* After Confirm Rules */
      }

      protected void BeforeInsert1S106( )
      {
         /* Before Insert Rules */
      }

      protected void BeforeUpdate1S106( )
      {
         /* Before Update Rules */
      }

      protected void BeforeDelete1S106( )
      {
         /* Before Delete Rules */
      }

      protected void BeforeComplete1S106( )
      {
         /* Before Complete Rules */
      }

      protected void BeforeValidate1S106( )
      {
         /* Before Validate Rules */
      }

      protected void DisableAttributes1S106( )
      {
      ...
      protected void send_integrity_lvl_hashes1S106( )
      {
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z585Trn_DiscussionTranslationId", Z585Trn_DiscussionTranslationId.ToString());
         GxWebStd.gx_hidden_field( context, "Z586DiscussionTranslationWWPDiscus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z586DiscussionTranslationWWPDiscus), 10, 0, ".", "")));
      ...
      {
         return "Trn_Discussion Translation" ;
      }

      protected void InitializeNonKey1S106( )
      {
         A586DiscussionTranslationWWPDiscus = 0;
         AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrimStr( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0));
         ...
         AssignAttri("", false, "A596DiscussionTranslationDutch", A596DiscussionTranslationDutch);
         Z586DiscussionTranslationWWPDiscus = 0;
         Z595DiscussionTranslationEnglish = "";
         Z596DiscussionTranslationDutch = "";
      }

      protected void InitAll1S106( )
      {
         A585Trn_DiscussionTranslationId = Guid.NewGuid( );
         AssignAttri("", false, "A585Trn_DiscussionTranslationId", A585Trn_DiscussionTranslationId.ToString());
         InitializeNonKey1S106( ) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241153024", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_discussiontranslation.js", "?20254241153024", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Discussion Translation";
         bttBtntrn_delete_Enabled = 1;
      ...
      public void Valid_Trn_discussiontranslationid( )
      {
         ...
         AssignAttri("", false, "A586DiscussionTranslationWWPDiscus", StringUtil.LTrim( StringUtil.NToC( (decimal)(A586DiscussionTranslationWWPDiscus), 10, 0, ".", "")));
         AssignAttri("", false, "A595DiscussionTranslationEnglish", A595DiscussionTranslationEnglish);
         AssignAttri("", false, "A596DiscussionTranslationDutch", A596DiscussionTranslationDutch);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_TRN_DISCUSSIONTRANSLATIONID","""{"handler":"Valid_Trn_discussiontranslationid","iparms":[{"av":"A585Trn_DiscussionTranslationId","fld":"TRN_DISCUSSIONTRANSLATIONID"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_TRN_DISCUSSIONTRANSLATIONID",""","oparms":[{"av":"A586DiscussionTranslationWWPDiscus","fld":"DISCUSSIONTRANSLATIONWWPDISCUS","pic":"ZZZZZZZZZ9"},{"av":"A595DiscussionTranslationEnglish","fld":"DISCUSSIONTRANSLATIONENGLISH"},{"av":"A596DiscussionTranslationDutch","fld":"DISCUSSIONTRANSLATIONDUTCH"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z585Trn_DiscussionTranslationId"},{"av":"Z586DiscussionTranslationWWPDiscus"},{"av":"Z595DiscussionTranslationEnglish"},{"av":"Z596DiscussionTranslationDutch"},{"ctrl":"BTNTRN_DELETE","prop":"Enabled"},{"ctrl":"BTNTRN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }
      ...
      {
         sPrefix = "";
         Z585Trn_DiscussionTranslationId = Guid.Empty;
         Z595DiscussionTranslationEnglish = "";
         Z596DiscussionTranslationDutch = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         ...
         endTrnMsgTxt = "";
         endTrnMsgCod = "";
         T001S4_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S4_A586DiscussionTranslationWWPDiscus = new long[1] ;
         T001S4_A595DiscussionTranslationEnglish = new string[] {""} ;
         T001S4_A596DiscussionTranslationDutch = new string[] {""} ;
         T001S5_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S3_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S3_A586DiscussionTranslationWWPDiscus = new long[1] ;
         T001S3_A595DiscussionTranslationEnglish = new string[] {""} ;
         T001S3_A596DiscussionTranslationDutch = new string[] {""} ;
         sMode106 = "";
         T001S6_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S7_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S2_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         T001S2_A586DiscussionTranslationWWPDiscus = new long[1] ;
         T001S2_A595DiscussionTranslationEnglish = new string[] {""} ;
         T001S2_A596DiscussionTranslationDutch = new string[] {""} ;
         T001S11_A585Trn_DiscussionTranslationId = new Guid[] {Guid.Empty} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ585Trn_DiscussionTranslationId = Guid.Empty;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_discussiontranslation__default(),
            new Object[][] {
                new Object[] {
               T001S2_A585Trn_DiscussionTranslationId, T001S2_A586DiscussionTranslationWWPDiscus, T001S2_A595DiscussionTranslationEnglish, T001S2_A596DiscussionTranslationDutch
               }
               , new Object[] {
               T001S3_A585Trn_DiscussionTranslationId, T001S3_A586DiscussionTranslationWWPDiscus, T001S3_A595DiscussionTranslationEnglish, T001S3_A596DiscussionTranslationDutch
               }
               , new Object[] {
               T001S4_A585Trn_DiscussionTranslationId, T001S4_A586DiscussionTranslationWWPDiscus, T001S4_A595DiscussionTranslationEnglish, T001S4_A596DiscussionTranslationDutch
               }
               , new Object[] {
               T001S5_A585Trn_DiscussionTranslationId
               }
               , new Object[] {
               T001S6_A585Trn_DiscussionTranslationId
               }
               , new Object[] {
               T001S7_A585Trn_DiscussionTranslationId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T001S11_A585Trn_DiscussionTranslationId
               }
            }
         );
         Z585Trn_DiscussionTranslationId = Guid.NewGuid( );
         A585Trn_DiscussionTranslationId = Guid.NewGuid( );
      }
      ...
      private int idxLst ;
      private long Z586DiscussionTranslationWWPDiscus ;
      private long A586DiscussionTranslationWWPDiscus ;
      private long ZZ586DiscussionTranslationWWPDiscus ;
      ...
      private Guid Z585Trn_DiscussionTranslationId ;
      private Guid A585Trn_DiscussionTranslationId ;
      private Guid ZZ585Trn_DiscussionTranslationId ;
      private GXWebForm Form ;
      private IGxDataStore dsDataStore1 ;
      private IGxDataStore dsGAM ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private Guid[] T001S4_A585Trn_DiscussionTranslationId ;
      private long[] T001S4_A586DiscussionTranslationWWPDiscus ;
      private string[] T001S4_A595DiscussionTranslationEnglish ;
      private string[] T001S4_A596DiscussionTranslationDutch ;
      private Guid[] T001S5_A585Trn_DiscussionTranslationId ;
      private Guid[] T001S3_A585Trn_DiscussionTranslationId ;
      private long[] T001S3_A586DiscussionTranslationWWPDiscus ;
      private string[] T001S3_A595DiscussionTranslationEnglish ;
      private string[] T001S3_A596DiscussionTranslationDutch ;
      private Guid[] T001S6_A585Trn_DiscussionTranslationId ;
      private Guid[] T001S7_A585Trn_DiscussionTranslationId ;
      private Guid[] T001S2_A585Trn_DiscussionTranslationId ;
      private long[] T001S2_A586DiscussionTranslationWWPDiscus ;
      private string[] T001S2_A595DiscussionTranslationEnglish ;
      private string[] T001S2_A596DiscussionTranslationDutch ;
      private Guid[] T001S11_A585Trn_DiscussionTranslationId ;
