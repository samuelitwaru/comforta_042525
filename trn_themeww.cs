...
namespace GeneXus.Programs {
   public class trn_themeww : GXDataArea
   {
      ...
      private void E196W2( )
      {
         ...
         {
            edtTrn_ThemeName_Link = formatLink("trn_themeview.aspx", new object[] {UrlEncode(A273Trn_ThemeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_ThemeId","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E116W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ThemeWWFilters")),UrlEncode(StringUtil.RTrim(AV44Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ThemeWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void E166W2( )
      {
         ...
         {
            CallWebObject(formatLink("trn_theme.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","Trn_ThemeId"}) );
      ...
      protected void S202( )
      {
         ...
         if ( AV35IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_themeview.aspx", new object[] {UrlEncode(A273Trn_ThemeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_ThemeId","TabCode"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S212( )
      {
         ...
         if ( AV36IsAuthorized_Update )
         {
            CallWebObject(formatLink("trn_theme.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A273Trn_ThemeId.ToString())}, new string[] {"Mode","Trn_ThemeId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV37IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_theme.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A273Trn_ThemeId.ToString())}, new string[] {"Mode","Trn_ThemeId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241156993", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_themeww.js", "?20254241156995", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E196W2","iparms":[{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_Trn_ThemeName","fld":"vISAUTHORIZED_TRN_THEMENAME","hsh":true},{"av":"A273Trn_ThemeId","fld":"TRN_THEMEID","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E166W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV42ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV44Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV20TFTrn_ThemeName","fld":"vTFTRN_THEMENAME"},{"av":"AV21TFTrn_ThemeName_Sel","fld":"vTFTRN_THEMENAME_SEL"},{"av":"AV22TFTrn_ThemeFontFamily","fld":"vTFTRN_THEMEFONTFAMILY"},{"av":"AV23TFTrn_ThemeFontFamily_Sel","fld":"vTFTRN_THEMEFONTFAMILY_SEL"},{"av":"AV24TFTrn_ThemeFontSize","fld":"vTFTRN_THEMEFONTSIZE","pic":"ZZZ9"},{"av":"AV25TFTrn_ThemeFontSize_To","fld":"vTFTRN_THEMEFONTSIZE_TO","pic":"ZZZ9"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_Trn_ThemeName","fld":"vISAUTHORIZED_TRN_THEMENAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A273Trn_ThemeId","fld":"TRN_THEMEID","hsh":true}]""");
