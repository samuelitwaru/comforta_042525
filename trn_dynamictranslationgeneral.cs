   ...
   public class trn_dynamictranslationgeneral : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Dynamic Translation General") ;
      ...
      {
         return "Trn_Dynamic Translation General" ;
      }
      ...
      protected void WBBC0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtDynamicTranslationTrnName_Internalname, "Trn Name", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtDynamicTranslationAttributeNam_Internalname, "Attribute Name", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtDynamicTranslationEnglish_Internalname, "Translation English", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtDynamicTranslationDutch_Internalname, "Translation Dutch", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Edit", bttBtnupdate_Jsonclick, 7, "Edit", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11bc1_client"+"'", TempTags, "", 2, "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12bc1_client"+"'", TempTags, "", 2, "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTBC2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Dynamic Translation General", 0) ;
            context.wjLoc = "";
      ...
      protected void RFBC2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A580DynamicTranslationPrimaryKey = H00BC2_A580DynamicTranslationPrimaryKey[0];
               AssignAttri(sPrefix, false, "A580DynamicTranslationPrimaryKey", A580DynamicTranslationPrimaryKey.ToString());
               A583DynamicTranslationDutch = H00BC2_A583DynamicTranslationDutch[0];
               AssignAttri(sPrefix, false, "A583DynamicTranslationDutch", A583DynamicTranslationDutch);
               A582DynamicTranslationEnglish = H00BC2_A582DynamicTranslationEnglish[0];
               AssignAttri(sPrefix, false, "A582DynamicTranslationEnglish", A582DynamicTranslationEnglish);
               A581DynamicTranslationAttributeNam = H00BC2_A581DynamicTranslationAttributeNam[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411524848", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_dynamictranslationgeneral.js", "?202542411524849", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00BC2_A582DynamicTranslationEnglish = new string[] {""} ;
         H00BC2_A581DynamicTranslationAttributeNam = new string[] {""} ;
         H00BC2_A579DynamicTranslationTrnName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_dynamictranslationgeneral__default(),
            new Object[][] {
                new Object[] {
               H00BC2_A578DynamicTranslationId, H00BC2_A580DynamicTranslationPrimaryKey, H00BC2_A583DynamicTranslationDutch, H00BC2_A582DynamicTranslationEnglish, H00BC2_A581DynamicTranslationAttributeNam, H00BC2_A579DynamicTranslationTrnName
               }
            }
         );
         AV14Pgmname = "Trn_DynamicTranslationGeneral";
      ...
      private Guid[] H00BC2_A578DynamicTranslationId ;
      private Guid[] H00BC2_A580DynamicTranslationPrimaryKey ;
      private string[] H00BC2_A583DynamicTranslationDutch ;
      private string[] H00BC2_A582DynamicTranslationEnglish ;
      private string[] H00BC2_A581DynamicTranslationAttributeNam ;
      private string[] H00BC2_A579DynamicTranslationTrnName ;
