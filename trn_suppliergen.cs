...
namespace GeneXus.Programs {
   public class trn_suppliergen : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         {
            A600SG_OrganisationSupplierId = StringUtil.StrToGuid( GetPar( "SG_OrganisationSupplierId"));
            n600SG_OrganisationSupplierId = false;
            AssignAttri("", false, "A600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
            ...
            gxLoad_47( A600SG_OrganisationSupplierId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_48") == 0 )
         {
            A601SG_LocationSupplierLocationId = StringUtil.StrToGuid( GetPar( "SG_LocationSupplierLocationId"));
            n601SG_LocationSupplierLocationId = false;
            AssignAttri("", false, "A601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
            ...
            gxLoad_48( A601SG_LocationSupplierLocationId, A602SG_LocationSupplierOrganisatio) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenTypeId_Internalname, "Category", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenContactName_Internalname, "Name", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-4 gx-label AttributeLabel control-label", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblPhonelabellandline_Internalname, "Landline", "", "", lblPhonelabellandline_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-8", "start", "top", "", "", "div");
         /* Div Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenLandlineCode_Internalname, "Supplier Gen Landline Code", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenLandlineSubNumber_Internalname, "Supplier Gen Landline Sub Number", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenLandlineNumber_Internalname, "Landline", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenEmail_Internalname, "Email", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierGenWebsite_Internalname, A428SupplierGenWebsite, StringUtil.RTrim( context.localUtil.Format( A428SupplierGenWebsite, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,113);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "www.website.com", edtSupplierGenWebsite_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierGenWebsite_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, Suppliergendescription_Internalname, "Description", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockdescriptionlabel_Internalname, "Description", "", "", lblTextblockdescriptionlabel_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
         /* Div Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierGenAddressLine2_Internalname, A311SupplierGenAddressLine2, StringUtil.RTrim( context.localUtil.Format( A311SupplierGenAddressLine2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,141);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Address Line 2", edtSupplierGenAddressLine2_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierGenAddressLine2_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierGenAddressZipCode_Internalname, "Zipcode", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 146,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierGenAddressZipCode_Internalname, A259SupplierGenAddressZipCode, StringUtil.RTrim( context.localUtil.Format( A259SupplierGenAddressZipCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,146);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "1234 AB", edtSupplierGenAddressZipCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierGenAddressZipCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierGenAddressCity_Internalname, A260SupplierGenAddressCity, StringUtil.RTrim( context.localUtil.Format( A260SupplierGenAddressCity, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,151);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "City", edtSupplierGenAddressCity_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierGenAddressCity_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierGen.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z600SG_OrganisationSupplierId = StringUtil.StrToGuid( cgiGet( "Z600SG_OrganisationSupplierId"));
               n600SG_OrganisationSupplierId = ((Guid.Empty==A600SG_OrganisationSupplierId) ? true : false);
               ...
               Z601SG_LocationSupplierLocationId = StringUtil.StrToGuid( cgiGet( "Z601SG_LocationSupplierLocationId"));
               n601SG_LocationSupplierLocationId = ((Guid.Empty==A601SG_LocationSupplierLocationId) ? true : false);
               A600SG_OrganisationSupplierId = StringUtil.StrToGuid( cgiGet( "Z600SG_OrganisationSupplierId"));
               n600SG_OrganisationSupplierId = false;
               n600SG_OrganisationSupplierId = ((Guid.Empty==A600SG_OrganisationSupplierId) ? true : false);
               A602SG_LocationSupplierOrganisatio = StringUtil.StrToGuid( cgiGet( "Z602SG_LocationSupplierOrganisatio"));
               n602SG_LocationSupplierOrganisatio = false;
               n602SG_LocationSupplierOrganisatio = ((Guid.Empty==A602SG_LocationSupplierOrganisatio) ? true : false);
               A601SG_LocationSupplierLocationId = StringUtil.StrToGuid( cgiGet( "Z601SG_LocationSupplierLocationId"));
               n601SG_LocationSupplierLocationId = false;
               n601SG_LocationSupplierLocationId = ((Guid.Empty==A601SG_LocationSupplierLocationId) ? true : false);
               ...
               N600SG_OrganisationSupplierId = StringUtil.StrToGuid( cgiGet( "N600SG_OrganisationSupplierId"));
               n600SG_OrganisationSupplierId = ((Guid.Empty==A600SG_OrganisationSupplierId) ? true : false);
               N602SG_LocationSupplierOrganisatio = StringUtil.StrToGuid( cgiGet( "N602SG_LocationSupplierOrganisatio"));
               n602SG_LocationSupplierOrganisatio = ((Guid.Empty==A602SG_LocationSupplierOrganisatio) ? true : false);
               N601SG_LocationSupplierLocationId = StringUtil.StrToGuid( cgiGet( "N601SG_LocationSupplierLocationId"));
               n601SG_LocationSupplierLocationId = ((Guid.Empty==A601SG_LocationSupplierLocationId) ? true : false);
               ...
               A600SG_OrganisationSupplierId = StringUtil.StrToGuid( cgiGet( "SG_ORGANISATIONSUPPLIERID"));
               n600SG_OrganisationSupplierId = ((Guid.Empty==A600SG_OrganisationSupplierId) ? true : false);
               ...
               A601SG_LocationSupplierLocationId = StringUtil.StrToGuid( cgiGet( "SG_LOCATIONSUPPLIERLOCATIONID"));
               n601SG_LocationSupplierLocationId = ((Guid.Empty==A601SG_LocationSupplierLocationId) ? true : false);
               ...
               Combo_suppliergenlandlinecode_Datalistupdateminimumcharacters = (int)(Math.Round(context.localUtil.CToN( cgiGet( "COMBO_SUPPLIERGENLANDLINECODE_Datalistupdateminimumcharacters"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               Combo_suppliergenlandlinecode_Gxcontroltype = (int)(Math.Round(context.localUtil.CToN( cgiGet( "COMBO_SUPPLIERGENLANDLINECODE_Gxcontroltype"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               Suppliergendescription_Color = (int)(Math.Round(context.localUtil.CToN( cgiGet( "SUPPLIERGENDESCRIPTION_Color"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               Suppliergendescription_Coltitlecolor = (int)(Math.Round(context.localUtil.CToN( cgiGet( "SUPPLIERGENDESCRIPTION_Coltitlecolor"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E11062( )
      {
         ...
         if ( (Guid.Empty==AV39SG_LocationSupplierLocationId) )
         {
            ...
            n601SG_LocationSupplierLocationId = false;
            AssignAttri("", false, "A601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
            n601SG_LocationSupplierLocationId = true;
         }
         if ( ! (Guid.Empty==AV39SG_LocationSupplierLocationId) )
         {
         ...
         if ( (Guid.Empty==AV39SG_LocationSupplierLocationId) )
         {
            ...
            if ( (Guid.Empty==AV40SG_OrganisationSupplierId) )
            {
               ...
               n600SG_OrganisationSupplierId = false;
               AssignAttri("", false, "A600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
               n600SG_OrganisationSupplierId = true;
            }
         }
      }
      ...
      protected void E13062( )
      {
         ...
         {
            AV12WebSession.Set("NotificationMessage", "General Supplier Updated successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "General Supplier Deleted successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "General Supplier Inserted successfully");
         }
      ...
      protected void ZM069( short GX_JID )
      {
         if ( ( GX_JID == 45 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z600SG_OrganisationSupplierId = T00063_A600SG_OrganisationSupplierId[0];
               Z602SG_LocationSupplierOrganisatio = T00063_A602SG_LocationSupplierOrganisatio[0];
               Z601SG_LocationSupplierLocationId = T00063_A601SG_LocationSupplierLocationId[0];
            }
            else
            {
               ...
               Z600SG_OrganisationSupplierId = A600SG_OrganisationSupplierId;
               Z602SG_LocationSupplierOrganisatio = A602SG_LocationSupplierOrganisatio;
               Z601SG_LocationSupplierLocationId = A601SG_LocationSupplierLocationId;
            }
         }
         if ( GX_JID == -45 )
         {
      ...
      protected void standaloneModal( )
      {
         ...
         {
            A601SG_LocationSupplierLocationId = AV36Insert_SG_LocationSupplierLocationId;
            n601SG_LocationSupplierLocationId = false;
            AssignAttri("", false, "A601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
         }
         else
         {
            ...
            {
               A601SG_LocationSupplierLocationId = AV39SG_LocationSupplierLocationId;
               n601SG_LocationSupplierLocationId = false;
               AssignAttri("", false, "A601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
            }
         }
         ...
         {
            A600SG_OrganisationSupplierId = AV34Insert_SG_OrganisationSupplierId;
            n600SG_OrganisationSupplierId = false;
            AssignAttri("", false, "A600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
         }
         else
         {
            ...
            {
               A600SG_OrganisationSupplierId = AV40SG_OrganisationSupplierId;
               n600SG_OrganisationSupplierId = false;
               AssignAttri("", false, "A600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
            }
         }
      ...
      protected void Load069( )
      {
         ...
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            AssignAttri("", false, "A253SupplierGenTypeId", A253SupplierGenTypeId.ToString());
            A600SG_OrganisationSupplierId = T00067_A600SG_OrganisationSupplierId[0];
            n600SG_OrganisationSupplierId = T00067_n600SG_OrganisationSupplierId[0];
            ...
            A601SG_LocationSupplierLocationId = T00067_A601SG_LocationSupplierLocationId[0];
            n601SG_LocationSupplierLocationId = T00067_n601SG_LocationSupplierLocationId[0];
            ZM069( -45) ;
         }
         pr_default.close(5);
         OnLoadActions069( ) ;
      ...
      protected void CheckExtendedTable069( )
      {
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Category", "", "", "", "", "", "", "", ""), 1, "SUPPLIERGENTYPEID");
            AnyError = 1;
            GX_FocusControl = edtSupplierGenTypeId_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "City", "", "", "", "", "", "", "", ""), 1, "SUPPLIERGENADDRESSCITY");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Zip Code", "", "", "", "", "", "", "", ""), 1, "SUPPLIERGENADDRESSZIPCODE");
            AnyError = 1;
            GX_FocusControl = edtSupplierGenAddressZipCode_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         if ( ! GxRegex.IsMatch(A259SupplierGenAddressZipCode,"^\\d{4}\\s?[A-Z]{2}$") && ! String.IsNullOrEmpty(StringUtil.RTrim( A259SupplierGenAddressZipCode)) )
         {
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Address Line1", "", "", "", "", "", "", "", ""), 1, "SUPPLIERGENADDRESSLINE1");
            AnyError = 1;
         ...
         A48SupplierGenContactPhone = GXt_char2;
         AssignAttri("", false, "A48SupplierGenContactPhone", A48SupplierGenContactPhone);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A354SupplierGenPhoneNumber)) && ! GxRegex.IsMatch(A354SupplierGenPhoneNumber,"^\\d{9}$") )
         {
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "SUPPLIERGENEMAIL");
            AnyError = 1;
            GX_FocusControl = edtSupplierGenEmail_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         if ( ! GxRegex.IsMatch(A428SupplierGenWebsite,"(?:https?://|www\\.)[^\\s/$.?#].[^\\s]*") && ! String.IsNullOrEmpty(StringUtil.RTrim( A428SupplierGenWebsite)) )
         {
         ...
         /* Using cursor T00065 */
         pr_default.execute(3, new Object[] {n600SG_OrganisationSupplierId, A600SG_OrganisationSupplierId});
         if ( (pr_default.getStatus(3) == 101) )
         {
            if ( ! ( (Guid.Empty==A600SG_OrganisationSupplierId) ) )
            {
               GX_msglist.addItem("No matching 'SG_Organisation Supplier'.", "ForeignKeyNotFound", 1, "SG_ORGANISATIONSUPPLIERID");
               AnyError = 1;
            }
         }
         pr_default.close(3);
         /* Using cursor T00066 */
         pr_default.execute(4, new Object[] {n601SG_LocationSupplierLocationId, A601SG_LocationSupplierLocationId, n602SG_LocationSupplierOrganisatio, A602SG_LocationSupplierOrganisatio});
         if ( (pr_default.getStatus(4) == 101) )
         {
            if ( ! ( (Guid.Empty==A601SG_LocationSupplierLocationId) || (Guid.Empty==A602SG_LocationSupplierOrganisatio) ) )
            {
               GX_msglist.addItem("No matching 'SG_Location Supplier'.", "ForeignKeyNotFound", 1, "SG_LOCATIONSUPPLIERORGANISATIO");
               AnyError = 1;
            }
         }
         pr_default.close(4);
      ...
      protected void gxLoad_47( Guid A600SG_OrganisationSupplierId )
      {
         /* Using cursor T00069 */
         pr_default.execute(7, new Object[] {n600SG_OrganisationSupplierId, A600SG_OrganisationSupplierId});
      ...
      protected void gxLoad_48( Guid A601SG_LocationSupplierLocationId ,
                                Guid A602SG_LocationSupplierOrganisatio )
      {
         /* Using cursor T000610 */
         pr_default.execute(8, new Object[] {n601SG_LocationSupplierLocationId, A601SG_LocationSupplierLocationId, n602SG_LocationSupplierOrganisatio, A602SG_LocationSupplierOrganisatio});
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A253SupplierGenTypeId", A253SupplierGenTypeId.ToString());
            A600SG_OrganisationSupplierId = T00063_A600SG_OrganisationSupplierId[0];
            n600SG_OrganisationSupplierId = T00063_n600SG_OrganisationSupplierId[0];
            ...
            A601SG_LocationSupplierLocationId = T00063_A601SG_LocationSupplierLocationId[0];
            n601SG_LocationSupplierLocationId = T00063_n601SG_LocationSupplierLocationId[0];
            Z42SupplierGenId = A42SupplierGenId;
            sMode9 = Gx_mode;
            Gx_mode = "DSP";
            AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void CheckOptimisticConcurrency069( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z428SupplierGenWebsite, T00062_A428SupplierGenWebsite[0]) != 0 ) || ( Z253SupplierGenTypeId != T00062_A253SupplierGenTypeId[0] ) || ( Z600SG_OrganisationSupplierId != T00062_A600SG_OrganisationSupplierId[0] ) || ( Z602SG_LocationSupplierOrganisatio != T00062_A602SG_LocationSupplierOrganisatio[0] ) || ( Z601SG_LocationSupplierLocationId != T00062_A601SG_LocationSupplierLocationId[0] ) )
            {
               ...
               if ( Z600SG_OrganisationSupplierId != T00062_A600SG_OrganisationSupplierId[0] )
               {
                  GXUtil.WriteLog("trn_suppliergen:[seudo value changed for attri]"+"SG_OrganisationSupplierId");
                  GXUtil.WriteLogRaw("Old: ",Z600SG_OrganisationSupplierId);
                  GXUtil.WriteLogRaw("Current: ",T00062_A600SG_OrganisationSupplierId[0]);
               }
               ...
               if ( Z601SG_LocationSupplierLocationId != T00062_A601SG_LocationSupplierLocationId[0] )
               {
                  GXUtil.WriteLog("trn_suppliergen:[seudo value changed for attri]"+"SG_LocationSupplierLocationId");
                  GXUtil.WriteLogRaw("Old: ",Z601SG_LocationSupplierLocationId);
                  GXUtil.WriteLogRaw("Current: ",T00062_A601SG_LocationSupplierLocationId[0]);
               }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z600SG_OrganisationSupplierId", Z600SG_OrganisationSupplierId.ToString());
         GxWebStd.gx_hidden_field( context, "Z602SG_LocationSupplierOrganisatio", Z602SG_LocationSupplierOrganisatio.ToString());
         GxWebStd.gx_hidden_field( context, "Z601SG_LocationSupplierLocationId", Z601SG_LocationSupplierLocationId.ToString());
         ...
         GxWebStd.gx_hidden_field( context, "N600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
         GxWebStd.gx_hidden_field( context, "N602SG_LocationSupplierOrganisatio", A602SG_LocationSupplierOrganisatio.ToString());
         GxWebStd.gx_hidden_field( context, "N601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "SG_ORGANISATIONSUPPLIERID", A600SG_OrganisationSupplierId.ToString());
         ...
         GxWebStd.gx_hidden_field( context, "SG_LOCATIONSUPPLIERLOCATIONID", A601SG_LocationSupplierLocationId.ToString());
      ...
      protected void InitializeNonKey069( )
      {
         ...
         Z600SG_OrganisationSupplierId = Guid.Empty;
         Z602SG_LocationSupplierOrganisatio = Guid.Empty;
         Z601SG_LocationSupplierLocationId = Guid.Empty;
      }
      ...
      {
         A601SG_LocationSupplierLocationId = i601SG_LocationSupplierLocationId;
         n601SG_LocationSupplierLocationId = false;
         AssignAttri("", false, "A601SG_LocationSupplierLocationId", A601SG_LocationSupplierLocationId.ToString());
         A602SG_LocationSupplierOrganisatio = i602SG_LocationSupplierOrganisatio;
         n602SG_LocationSupplierOrganisatio = false;
         AssignAttri("", false, "A602SG_LocationSupplierOrganisatio", A602SG_LocationSupplierOrganisatio.ToString());
         A600SG_OrganisationSupplierId = i600SG_OrganisationSupplierId;
         n600SG_OrganisationSupplierId = false;
         AssignAttri("", false, "A600SG_OrganisationSupplierId", A600SG_OrganisationSupplierId.ToString());
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418144487", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergen.js", "?202542418144491", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         N600SG_OrganisationSupplierId = Guid.Empty;
         N602SG_LocationSupplierOrganisatio = Guid.Empty;
         N601SG_LocationSupplierLocationId = Guid.Empty;
         ...
         T00067_A600SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         T00067_n600SG_OrganisationSupplierId = new bool[] {false} ;
         T00067_A602SG_LocationSupplierOrganisatio = new Guid[] {Guid.Empty} ;
         T00067_n602SG_LocationSupplierOrganisatio = new bool[] {false} ;
         T00067_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         T00067_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         T00065_A600SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         T00065_n600SG_OrganisationSupplierId = new bool[] {false} ;
         T00066_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         T00066_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         T00068_A254SupplierGenTypeName = new string[] {""} ;
         T00069_A600SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         T00069_n600SG_OrganisationSupplierId = new bool[] {false} ;
         T000610_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         T000610_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         ...
         T00063_A600SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         T00063_n600SG_OrganisationSupplierId = new bool[] {false} ;
         T00063_A602SG_LocationSupplierOrganisatio = new Guid[] {Guid.Empty} ;
         T00063_n602SG_LocationSupplierOrganisatio = new bool[] {false} ;
         T00063_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         T00063_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         ...
         T00062_A600SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         T00062_n600SG_OrganisationSupplierId = new bool[] {false} ;
         T00062_A602SG_LocationSupplierOrganisatio = new Guid[] {Guid.Empty} ;
         T00062_n602SG_LocationSupplierOrganisatio = new bool[] {false} ;
         T00062_A601SG_LocationSupplierLocationId = new Guid[] {Guid.Empty} ;
         T00062_n601SG_LocationSupplierLocationId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergen__default(),
            new Object[][] {
               ...
               T00062_A310SupplierGenAddressLine1, T00062_A311SupplierGenAddressLine2, T00062_A47SupplierGenContactName, T00062_A354SupplierGenPhoneNumber, T00062_A606SupplierGenLandlineSubNumber, T00062_A501SupplierGenEmail, T00062_A428SupplierGenWebsite, T00062_A604SupplierGenDescription, T00062_A253SupplierGenTypeId, T00062_A600SG_OrganisationSupplierId,
               T00062_n600SG_OrganisationSupplierId, T00062_A602SG_LocationSupplierOrganisatio, T00062_n602SG_LocationSupplierOrganisatio, T00062_A601SG_LocationSupplierLocationId, T00062_n601SG_LocationSupplierLocationId
               }
               , new Object[] {
               ...
               T00063_A310SupplierGenAddressLine1, T00063_A311SupplierGenAddressLine2, T00063_A47SupplierGenContactName, T00063_A354SupplierGenPhoneNumber, T00063_A606SupplierGenLandlineSubNumber, T00063_A501SupplierGenEmail, T00063_A428SupplierGenWebsite, T00063_A604SupplierGenDescription, T00063_A253SupplierGenTypeId, T00063_A600SG_OrganisationSupplierId,
               T00063_n600SG_OrganisationSupplierId, T00063_A602SG_LocationSupplierOrganisatio, T00063_n602SG_LocationSupplierOrganisatio, T00063_A601SG_LocationSupplierLocationId, T00063_n601SG_LocationSupplierLocationId
               }
               , new Object[] {
               T00064_A254SupplierGenTypeName
               }
               , new Object[] {
               T00065_A600SG_OrganisationSupplierId
               }
               , new Object[] {
               T00066_A601SG_LocationSupplierLocationId
               }
               , new Object[] {
               ...
               T00067_A600SG_OrganisationSupplierId, T00067_n600SG_OrganisationSupplierId, T00067_A602SG_LocationSupplierOrganisatio, T00067_n602SG_LocationSupplierOrganisatio, T00067_A601SG_LocationSupplierLocationId, T00067_n601SG_LocationSupplierLocationId
               }
               , new Object[] {
               T00068_A254SupplierGenTypeName
               }
               , new Object[] {
               T00069_A600SG_OrganisationSupplierId
               }
               , new Object[] {
               T000610_A601SG_LocationSupplierLocationId
               }
               , new Object[] {
      ...
      private Guid Z600SG_OrganisationSupplierId ;
      private Guid Z602SG_LocationSupplierOrganisatio ;
      private Guid Z601SG_LocationSupplierLocationId ;
      private Guid N253SupplierGenTypeId ;
      private Guid N600SG_OrganisationSupplierId ;
      private Guid N602SG_LocationSupplierOrganisatio ;
      private Guid N601SG_LocationSupplierLocationId ;
      ...
      private Guid i601SG_LocationSupplierLocationId ;
      private Guid i602SG_LocationSupplierOrganisatio ;
      private Guid i600SG_OrganisationSupplierId ;
      ...
      private Guid[] T00067_A600SG_OrganisationSupplierId ;
      private bool[] T00067_n600SG_OrganisationSupplierId ;
      private Guid[] T00067_A602SG_LocationSupplierOrganisatio ;
      private bool[] T00067_n602SG_LocationSupplierOrganisatio ;
      private Guid[] T00067_A601SG_LocationSupplierLocationId ;
      private bool[] T00067_n601SG_LocationSupplierLocationId ;
      private Guid[] T00065_A600SG_OrganisationSupplierId ;
      private bool[] T00065_n600SG_OrganisationSupplierId ;
      private Guid[] T00066_A601SG_LocationSupplierLocationId ;
      private bool[] T00066_n601SG_LocationSupplierLocationId ;
      private string[] T00068_A254SupplierGenTypeName ;
      private Guid[] T00069_A600SG_OrganisationSupplierId ;
      private bool[] T00069_n600SG_OrganisationSupplierId ;
      private Guid[] T000610_A601SG_LocationSupplierLocationId ;
      private bool[] T000610_n601SG_LocationSupplierLocationId ;
      ...
      private Guid[] T00063_A600SG_OrganisationSupplierId ;
      private bool[] T00063_n600SG_OrganisationSupplierId ;
      private Guid[] T00063_A602SG_LocationSupplierOrganisatio ;
      private bool[] T00063_n602SG_LocationSupplierOrganisatio ;
      private Guid[] T00063_A601SG_LocationSupplierLocationId ;
      private bool[] T00063_n601SG_LocationSupplierLocationId ;
      ...
      private Guid[] T00062_A600SG_OrganisationSupplierId ;
      private bool[] T00062_n600SG_OrganisationSupplierId ;
      private Guid[] T00062_A602SG_LocationSupplierOrganisatio ;
      private bool[] T00062_n602SG_LocationSupplierOrganisatio ;
      private Guid[] T00062_A601SG_LocationSupplierLocationId ;
      private bool[] T00062_n601SG_LocationSupplierLocationId ;
