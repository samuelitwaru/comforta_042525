   ...
   public class trn_location : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel12"+"_"+"TRN_THEMEID") == 0 )
         {
            ...
            GX12ASATRN_THEMEID04103( AV25Insert_Trn_ThemeId, A273Trn_ThemeId, Gx_BScreen) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel22"+"_"+"LOCATIONPHONE") == 0 )
         {
            ...
            GX22ASALOCATIONPHONE04103( A355LocationPhoneCode, A356LocationPhoneNumber) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel24"+"_"+"vSDT_TRNATTRIBUTES") == 0 )
         {
            ...
            GX24ASASDT_TRNATTRIBUTES04103( A29LocationId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel25"+"_"+"vLOCATIONDESCRIPTIONVAR") == 0 )
         {
            ...
            GX25ASALOCATIONDESCRIPTIONVAR04103( A36LocationDescription, AV39trnName, AV37AttributeDescription, A29LocationId) ;
            return  ;
         }
         ...
         {
            A576LocationThemeId = StringUtil.StrToGuid( GetPar( "LocationThemeId"));
            n576LocationThemeId = false;
            AssignAttri("", false, "A576LocationThemeId", A576LocationThemeId.ToString());
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_48") == 0 )
         {
            ...
            gxLoad_48( A584ActiveAppVersionId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_49") == 0 )
         {
            ...
            gxLoad_49( A598PublishedActiveAppVersionId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblProductserviceimagetext_Internalname, "Images", "", "", lblProductserviceimagetext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_Trn_Location.htm");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, Locationdescriptionvar_Internalname, "Description", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 gx-label AttributeLabel control-label", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockdescriptionlabel_Internalname, "Description", "", "", lblTextblockdescriptionlabel_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_Trn_Location.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
         /* Div Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtLocationZipCode_Internalname, A329LocationZipCode, StringUtil.RTrim( context.localUtil.Format( A329LocationZipCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "1234 AB", edtLocationZipCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLocationZipCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_Location.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "ButtonMaterialDefault";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtnudelete_Internalname, "", "Delete", bttBtnudelete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtnudelete_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUDELETE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_Location.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z576LocationThemeId = StringUtil.StrToGuid( cgiGet( "Z576LocationThemeId"));
               n576LocationThemeId = ((Guid.Empty==A576LocationThemeId) ? true : false);
               ...
               n273Trn_ThemeId = false;
               n273Trn_ThemeId = ((Guid.Empty==A273Trn_ThemeId) ? true : false);
               A576LocationThemeId = StringUtil.StrToGuid( cgiGet( "Z576LocationThemeId"));
               n576LocationThemeId = false;
               n576LocationThemeId = ((Guid.Empty==A576LocationThemeId) ? true : false);
               ...
               n273Trn_ThemeId = ((Guid.Empty==A273Trn_ThemeId) ? true : false);
               N576LocationThemeId = StringUtil.StrToGuid( cgiGet( "N576LocationThemeId"));
               n576LocationThemeId = ((Guid.Empty==A576LocationThemeId) ? true : false);
               ...
               A576LocationThemeId = StringUtil.StrToGuid( cgiGet( "LOCATIONTHEMEID"));
               n576LocationThemeId = ((Guid.Empty==A576LocationThemeId) ? true : false);
               ...
               Locationdescriptionvar_Color = (int)(Math.Round(context.localUtil.CToN( cgiGet( "LOCATIONDESCRIPTIONVAR_Color"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               Locationdescriptionvar_Coltitlecolor = (int)(Math.Round(context.localUtil.CToN( cgiGet( "LOCATIONDESCRIPTIONVAR_Coltitlecolor"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E14042( )
      {
         ...
         if ( AV28isSuccessful )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  "Deleted location successfully",  "success",  "",  "true",  ""));
            CallWebObject(formatLink("trn_locationww.aspx") );
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void ZM04103( short GX_JID )
      {
         if ( ( GX_JID == 44 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z576LocationThemeId = T00043_A576LocationThemeId[0];
      ...
      protected void Load04103( )
      {
         ...
         if ( (pr_default.getStatus(7) != 101) )
         {
            ...
            A576LocationThemeId = T00049_A576LocationThemeId[0];
            n576LocationThemeId = T00049_n576LocationThemeId[0];
      ...
      protected void OnLoadActions04103( )
      {
         ...
         {
            A576LocationThemeId = AV32Insert_LocationThemeId;
            n576LocationThemeId = false;
            AssignAttri("", false, "A576LocationThemeId", A576LocationThemeId.ToString());
         }
         else
      ...
      protected void CheckExtendedTable04103( )
      {
         ...
         {
            GX_msglist.addItem("Zip Code is incorrect", 1, "LOCATIONZIPCODE");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "LOCATIONEMAIL");
            AnyError = 1;
      ...
      protected void gxLoad_47( Guid A576LocationThemeId )
      {
         /* Using cursor T000411 */
         pr_default.execute(9, new Object[] {n576LocationThemeId, A576LocationThemeId});
      ...
      protected void gxLoad_48( Guid A584ActiveAppVersionId )
      {
      ...
      protected void gxLoad_49( Guid A598PublishedActiveAppVersionId )
      {
      ...
      protected void gxLoad_46( Guid A273Trn_ThemeId )
      {
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A576LocationThemeId = T00043_A576LocationThemeId[0];
            n576LocationThemeId = T00043_n576LocationThemeId[0];
      ...
      protected void CheckOptimisticConcurrency04103( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z503ToolBoxDefaultLogo, T00042_A503ToolBoxDefaultLogo[0]) != 0 ) || ( StringUtil.StrCmp(Z575ReceptionDescription, T00042_A575ReceptionDescription[0]) != 0 ) || ( Z273Trn_ThemeId != T00042_A273Trn_ThemeId[0] ) || ( Z576LocationThemeId != T00042_A576LocationThemeId[0] ) || ( Z584ActiveAppVersionId != T00042_A584ActiveAppVersionId[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z598PublishedActiveAppVersionId != T00042_A598PublishedActiveAppVersionId[0] ) )
            {
               ...
               if ( Z576LocationThemeId != T00042_A576LocationThemeId[0] )
               {
                  GXUtil.WriteLog("trn_location:[seudo value changed for attri]"+"LocationThemeId");
                  GXUtil.WriteLogRaw("Old: ",Z576LocationThemeId);
                  GXUtil.WriteLogRaw("Current: ",T00042_A576LocationThemeId[0]);
               }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z576LocationThemeId", Z576LocationThemeId.ToString());
         ...
         GxWebStd.gx_hidden_field( context, "N576LocationThemeId", A576LocationThemeId.ToString());
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "LOCATIONTHEMEID", A576LocationThemeId.ToString());
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418131276", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_location.js", "?202542418131278", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/UC_CustomImageUploadRender.js", "", false, true);
      ...
      protected void GX12ASATRN_THEMEID04103( Guid AV25Insert_Trn_ThemeId ,
      ...
      protected void GX22ASALOCATIONPHONE04103( string A355LocationPhoneCode ,
      ...
      protected void GX24ASASDT_TRNATTRIBUTES04103( Guid A29LocationId )
      {
         GXt_SdtSDT_TrnAttributes6 = AV33SDT_TrnAttributes;
         new prc_addlocationattributestosdt(context ).execute(  A29LocationId, out  GXt_SdtSDT_TrnAttributes6) ;
         AV33SDT_TrnAttributes = GXt_SdtSDT_TrnAttributes6;
      ...
      protected void GX25ASALOCATIONDESCRIPTIONVAR04103( string A36LocationDescription ,
                                                         string AV39trnName ,
      ...
      protected void XC_41_04103( Guid A29LocationId )
      {
         new trn_deletelocationpages(context ).execute(  A29LocationId) ;
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALIDV_LOCATIONDESCRIPTIONVAR","""{"handler":"Validv_Locationdescriptionvar","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         N576LocationThemeId = Guid.Empty;
         ...
         AV42UploadedFiles = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         AV41FilesToUpdate = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         ...
         GXt_objcol_SdtSDT_FileUploadData3 = new GXBaseCollection<SdtSDT_FileUploadData>( context, "SDT_FileUploadData", "Comforta_version20");
         AV29Message = "";
         ...
         T00049_A576LocationThemeId = new Guid[] {Guid.Empty} ;
         T00049_n576LocationThemeId = new bool[] {false} ;
         ...
         T00046_A576LocationThemeId = new Guid[] {Guid.Empty} ;
         T00046_n576LocationThemeId = new bool[] {false} ;
         ...
         T000411_A576LocationThemeId = new Guid[] {Guid.Empty} ;
         T000411_n576LocationThemeId = new bool[] {false} ;
         ...
         T00043_A576LocationThemeId = new Guid[] {Guid.Empty} ;
         T00043_n576LocationThemeId = new bool[] {false} ;
         ...
         T00042_A576LocationThemeId = new Guid[] {Guid.Empty} ;
         T00042_n576LocationThemeId = new bool[] {false} ;
         ...
         T000428_A523AppVersionId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_location__default(),
            new Object[][] {
               ...
               T00042_A273Trn_ThemeId, T00042_n273Trn_ThemeId, T00042_A576LocationThemeId, T00042_n576LocationThemeId, T00042_A584ActiveAppVersionId, T00042_n584ActiveAppVersionId, T00042_A598PublishedActiveAppVersionId, T00042_n598PublishedActiveAppVersionId, T00042_A494LocationImage, T00042_A574ReceptionImage,
               ...
               T00043_A273Trn_ThemeId, T00043_n273Trn_ThemeId, T00043_A576LocationThemeId, T00043_n576LocationThemeId, T00043_A584ActiveAppVersionId, T00043_n584ActiveAppVersionId, T00043_A598PublishedActiveAppVersionId, T00043_n598PublishedActiveAppVersionId, T00043_A494LocationImage, T00043_A574ReceptionImage,
               ...
               T00049_A273Trn_ThemeId, T00049_n273Trn_ThemeId, T00049_A576LocationThemeId, T00049_n576LocationThemeId, T00049_A584ActiveAppVersionId, T00049_n584ActiveAppVersionId, T00049_A598PublishedActiveAppVersionId, T00049_n598PublishedActiveAppVersionId, T00049_A494LocationImage, T00049_A574ReceptionImage,
      ...
      private Guid N576LocationThemeId ;
      ...
      private Guid[] T00049_A576LocationThemeId ;
      private bool[] T00049_n576LocationThemeId ;
      ...
      private Guid[] T00046_A576LocationThemeId ;
      private bool[] T00046_n576LocationThemeId ;
      ...
      private Guid[] T000411_A576LocationThemeId ;
      private bool[] T000411_n576LocationThemeId ;
      ...
      private Guid[] T00043_A576LocationThemeId ;
      private bool[] T00043_n576LocationThemeId ;
      ...
      private Guid[] T00042_A576LocationThemeId ;
      private bool[] T00042_n576LocationThemeId ;
      ...
      private Guid[] T000428_A523AppVersionId ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("T000428", "SELECT AppVersionId FROM Trn_AppVersion WHERE LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000428,1, GxCacheFrequency.OFF ,true,true )
