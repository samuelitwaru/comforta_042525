...
namespace GeneXus.Programs {
   public class trn_memoww : GXDataArea
   {
      ...
      protected void RFAP2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A543MemoCategoryName = H00AP2_A543MemoCategoryName[0];
               A542MemoCategoryId = H00AP2_A542MemoCategoryId[0];
      ...
      protected void E18AP2( )
      {
         ...
         edtMemoCategoryName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoTitle_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoStartDateTime_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoEndDateTime_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoDuration_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoRemoveDate_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(6)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E11AP2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_MemoWWFilters")),UrlEncode(StringUtil.RTrim(AV60Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_MemoWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoCategoryName",  "",  "Category Name",  true,  "") ;
      ...
      protected void S202( )
      {
         ...
         if ( AV56IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_memoview.aspx", new object[] {UrlEncode(A549MemoId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"MemoId","TabCode"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S212( )
      {
         ...
         if ( AV57IsAuthorized_Update )
         {
            CallWebObject(formatLink("trn_memo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A549MemoId.ToString())}, new string[] {"Mode","MemoId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV58IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_memo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A549MemoId.ToString())}, new string[] {"Mode","MemoId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         {
            AV12GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV74GXV1));
         ...
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV26TFMemoCategoryName_Sel)),  AV26TFMemoCategoryName_Sel, out  GXt_char3) ;
         GXt_char5 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV28TFMemoTitle_Sel)),  AV28TFMemoTitle_Sel, out  GXt_char5) ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E19AP2","iparms":[{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"A549MemoId","fld":"MEMOID","hsh":true}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E20AP2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV55ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A549MemoId","fld":"MEMOID","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E16AP2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A549MemoId","fld":"MEMOID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         H00AP2_A543MemoCategoryName = new string[] {""} ;
         H00AP2_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memoww__default(),
            new Object[][] {
               ...
               H00AP2_A563MemoDuration, H00AP2_n563MemoDuration, H00AP2_A562MemoEndDateTime, H00AP2_n562MemoEndDateTime, H00AP2_A561MemoStartDateTime, H00AP2_n561MemoStartDateTime, H00AP2_A553MemoDocument, H00AP2_n553MemoDocument, H00AP2_A552MemoImage, H00AP2_n552MemoImage,
               H00AP2_A551MemoDescription, H00AP2_A550MemoTitle, H00AP2_A543MemoCategoryName, H00AP2_A542MemoCategoryId, H00AP2_A549MemoId
               }
               , new Object[] {
      ...
      private string[] H00AP2_A543MemoCategoryName ;
      private Guid[] H00AP2_A542MemoCategoryId ;
