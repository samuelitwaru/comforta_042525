...
namespace GeneXus.Programs {
   public class trn_organisationtrn_locationwc : GXWebComponent
   {
      ...
      protected void RFB22( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A36LocationDescription = H00B22_A36LocationDescription[0];
               A35LocationPhone = H00B22_A35LocationPhone[0];
               A356LocationPhoneNumber = H00B22_A356LocationPhoneNumber[0];
               A355LocationPhoneCode = H00B22_A355LocationPhoneCode[0];
               A34LocationEmail = H00B22_A34LocationEmail[0];
               A331LocationAddressLine2 = H00B22_A331LocationAddressLine2[0];
               A330LocationAddressLine1 = H00B22_A330LocationAddressLine1[0];
               A329LocationZipCode = H00B22_A329LocationZipCode[0];
               A328LocationCity = H00B22_A328LocationCity[0];
               A327LocationCountry = H00B22_A327LocationCountry[0];
               A40000LocationImage_GXI = H00B22_A40000LocationImage_GXI[0];
               AssignProp(sPrefix, false, edtLocationImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A494LocationImage)) ? A40000LocationImage_GXI : context.convertURL( context.PathToRelativeUrl( A494LocationImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtLocationImage_Internalname, "SrcSet", context.GetImageSrcSet( A494LocationImage), true);
               A31LocationName = H00B22_A31LocationName[0];
               A11OrganisationId = H00B22_A11OrganisationId[0];
               A29LocationId = H00B22_A29LocationId[0];
               A494LocationImage = H00B22_A494LocationImage[0];
               AssignProp(sPrefix, false, edtLocationImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A494LocationImage)) ? A40000LocationImage_GXI : context.convertURL( context.PathToRelativeUrl( A494LocationImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtLocationImage_Internalname, "SrcSet", context.GetImageSrcSet( A494LocationImage), true);
               /* Execute user event: Grid.Load */
               E18B22 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H00B23_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUPB20( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV33GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ".", ","), 18, MidpointRounding.ToEven));
            AV34GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      private void E18B22( )
      {
         ...
         {
            cmbavActiongroup.addItem("4", StringUtil.Format( "%1;%2", "Manage License", "fas fa-gears", "", "", "", "", "", "", ""), 0);
         }
      ...
      protected void E11B22( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_OrganisationTrn_LocationWCFilters")),UrlEncode(StringUtil.RTrim(AV46Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV21ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV21ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV21ManageFiltersExecutionStep), 1, 0));
      ...
      protected void E15B22( )
      {
         ...
         {
            CallWebObject(formatLink("wp_createlocationandlicense.aspx", new object[] {UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.BoolToStr(false)),UrlEncode(A11OrganisationId.ToString())}, new string[] {"PreviousStep","CurrentStep","GoingBack","OrganisationId"}) );
      ...
      protected void S192( )
      {
         ...
         if ( AV38IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_locationview.aspx", new object[] {UrlEncode(A29LocationId.ToString()),UrlEncode(A11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"LocationId","OrganisationId","TabCode"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV41IsAuthorized_LocationBranding )
         {
            CallWebObject(formatLink("wp_managelocationbranding.aspx", new object[] {UrlEncode(A11OrganisationId.ToString()),UrlEncode(A29LocationId.ToString())}, new string[] {"OrganisationId","LocationId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025424114730", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_organisationtrn_locationwc.js", "?2025424114732", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18B22","iparms":[{"av":"AV38IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV39IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV40IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV41IsAuthorized_LocationBranding","fld":"vISAUTHORIZED_LOCATIONBRANDING","hsh":true},{"av":"AV36IsAuthorized_LocationName","fld":"vISAUTHORIZED_LOCATIONNAME","hsh":true}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E19B22","iparms":[{"av":"cmbavActiongroup"},{"av":"AV37ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV46Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV38IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV39IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV40IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV41IsAuthorized_LocationBranding","fld":"vISAUTHORIZED_LOCATIONBRANDING","hsh":true},{"av":"AV36IsAuthorized_LocationName","fld":"vISAUTHORIZED_LOCATIONNAME","hsh":true},{"av":"AV42IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A29LocationId","fld":"LOCATIONID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV17LocationAddress = "";
         lV16FilterFullText = "";
         H00B22_A36LocationDescription = new string[] {""} ;
         H00B22_A35LocationPhone = new string[] {""} ;
         H00B22_A356LocationPhoneNumber = new string[] {""} ;
         H00B22_A355LocationPhoneCode = new string[] {""} ;
         H00B22_A34LocationEmail = new string[] {""} ;
         H00B22_A331LocationAddressLine2 = new string[] {""} ;
         H00B22_A330LocationAddressLine1 = new string[] {""} ;
         H00B22_A329LocationZipCode = new string[] {""} ;
         H00B22_A328LocationCity = new string[] {""} ;
         H00B22_A327LocationCountry = new string[] {""} ;
         H00B22_A40000LocationImage_GXI = new string[] {""} ;
         H00B22_A31LocationName = new string[] {""} ;
         H00B22_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B22_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B22_A494LocationImage = new string[] {""} ;
         H00B23_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationtrn_locationwc__default(),
            new Object[][] {
                new Object[] {
               H00B22_A36LocationDescription, H00B22_A35LocationPhone, H00B22_A356LocationPhoneNumber, H00B22_A355LocationPhoneCode, H00B22_A34LocationEmail, H00B22_A331LocationAddressLine2, H00B22_A330LocationAddressLine1, H00B22_A329LocationZipCode, H00B22_A328LocationCity, H00B22_A327LocationCountry,
               H00B22_A40000LocationImage_GXI, H00B22_A31LocationName, H00B22_A11OrganisationId, H00B22_A29LocationId, H00B22_A494LocationImage
               }
               , new Object[] {
               H00B23_AGRID_nRecordCount
               }
            }
         );
         AV46Pgmname = "Trn_OrganisationTrn_LocationWC";
      ...
      private string[] H00B22_A36LocationDescription ;
      private string[] H00B22_A35LocationPhone ;
      private string[] H00B22_A356LocationPhoneNumber ;
      private string[] H00B22_A355LocationPhoneCode ;
      private string[] H00B22_A34LocationEmail ;
      private string[] H00B22_A331LocationAddressLine2 ;
      private string[] H00B22_A330LocationAddressLine1 ;
      private string[] H00B22_A329LocationZipCode ;
      private string[] H00B22_A328LocationCity ;
      private string[] H00B22_A327LocationCountry ;
      private string[] H00B22_A40000LocationImage_GXI ;
      private string[] H00B22_A31LocationName ;
      private Guid[] H00B22_A11OrganisationId ;
      private Guid[] H00B22_A29LocationId ;
      private string[] H00B22_A494LocationImage ;
      private long[] H00B23_AGRID_nRecordCount ;
   ...
   {
      protected Object[] conditional_H00B22( IGxContext context ,
                                             string AV16FilterFullText ,
      ...
      protected Object[] conditional_H00B23( IGxContext context ,
                                             string AV16FilterFullText ,
                                             string A31LocationName ,
                                             string A34LocationEmail ,
                                             string A35LocationPhone ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00B22(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H00B23(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B22", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B22,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00B23", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B23,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
