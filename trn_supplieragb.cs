...
namespace GeneXus.Programs {
   public class trn_supplieragb : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbWebsite_Internalname, A427SupplierAgbWebsite, StringUtil.RTrim( context.localUtil.Format( A427SupplierAgbWebsite, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "www.website.com", edtSupplierAgbWebsite_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbWebsite_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Website", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E13072( )
      {
         ...
         {
            AV12WebSession.Set("NotificationMessage", "AGB Supplier Updated successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "AGB Supplier Deleted successfully");
         }
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV12WebSession.Set("NotificationMessage", "AGB Supplier Inserted successfully");
         }
      ...
      protected void E12072( )
      {
         ...
         if ( StringUtil.StrCmp(Combo_supplieragbtypeid_Selectedvalue_get, "<#NEW#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wp_createnewsupplieragbtype.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(A255SupplierAgbTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV30DefaultSupplierAgbTypeName))}, new string[] {"TrnMode","SupplierAgbTypeId","DefaultSupplierAgbTypeName"}) , new Object[] {});
         }
      ...
      protected void CheckExtendedTable0711( )
      {
         ...
         if ( ! GxRegex.IsMatch(A263SupplierAgbAddressZipCode,"^\\d{4}\\s?[A-Z]{2}$") && ! String.IsNullOrEmpty(StringUtil.RTrim( A263SupplierAgbAddressZipCode)) )
         {
         ...
         A56SupplierAgbPhone = GXt_char2;
         AssignAttri("", false, "A56SupplierAgbPhone", A56SupplierAgbPhone);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A350SupplierAgbPhoneNumber)) && ! GxRegex.IsMatch(A350SupplierAgbPhoneNumber,"^\\d{9}$") )
         {
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "SUPPLIERAGBEMAIL");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbEmail_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         if ( ! GxRegex.IsMatch(A427SupplierAgbWebsite,"^(https?:\\/\\/)?(www\\.)?[a-zA-Z0-9-]+(\\.[a-zA-Z]{2,})(\\/[^\\s]*)?$") && ! String.IsNullOrEmpty(StringUtil.RTrim( A427SupplierAgbWebsite)) )
         {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_supplieragb.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7SupplierAgbId.ToString())}, new string[] {"Gx_mode","SupplierAgbId"}) +"\">") ;
      ...
      {
         return formatLink("trn_supplieragb.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(AV7SupplierAgbId.ToString())}, new string[] {"Gx_mode","SupplierAgbId"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418145733", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragb.js", "?202542418145736", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
