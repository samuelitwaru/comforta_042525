...
namespace GeneXus.Programs {
   public class prc_inithomepage : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         new prc_createpagetile(context ).execute(  "Reception",  "#ffffff",  "left",  "Reception",  0,  "accentColor",  AV23BC_Trn_Location.gxTpr_Receptionimage_gxi,  AV8ReceptionPageId.ToString(),  "Reception",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
      ...
      protected void S121( )
      {
         ...
         AV16RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "Agenda",  "#ffffff",  "left",  "Calendar",  0,  "accentColor",  AV18baseUrl+"media/Calendar.png",  AV19CalendarId.ToString(),  "Calendar",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "My Activity",  "#ffffff",  "left",  "",  0,  "accentColor",  "",  AV20MyActivityId.ToString(),  "MyActivity",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         AV14SDT_MenuPage.gxTpr_Rows.Add(AV16RowsItem, 0);
      }
      ...
      protected void S131( )
      {
         ...
         AV16RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "Location",  "#ffffff",  "left",  "",  0,  "accentColor",  AV23BC_Trn_Location.gxTpr_Locationimage_gxi,  AV9LocationPageId.ToString(),  "Location",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         AV14SDT_MenuPage.gxTpr_Rows.Add(AV16RowsItem, 0);
      }
      ...
      protected void S141( )
      {
         ...
         AV16RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "My Care",  "#ffffff",  "center",  "",  0,  "accentColor",  "",  AV10CarePageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "My Living",  "#ffffff",  "center",  "",  0,  "accentColor",  "",  AV11LivingPageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "My Services",  "#ffffff",  "center",  "",  0,  "accentColor",  "",  AV12ServicesPageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         AV14SDT_MenuPage.gxTpr_Rows.Add(AV16RowsItem, 0);
      }
      ...
      protected void S151( )
      {
         ...
         AV16RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV15TilesItem;
         new prc_createpagetile(context ).execute(  "Maps",  "#ffffff",  "left",  "",  0,  "accentColor",  "",  AV24MapsPageId.ToString(),  "Map",  AV24MapsPageId.ToString(), out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV15TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV16RowsItem.gxTpr_Tiles.Add(AV15TilesItem, 0);
         AV14SDT_MenuPage.gxTpr_Rows.Add(AV16RowsItem, 0);
      }
