...
namespace GeneXus.Programs {
   ...
   public class wp_locationdynamicformgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A240WWPFormType )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV52Wp_locationdynamicformds_4_tfwwpformtitle_sel)) && ! ( StringUtil.StrCmp(AV52Wp_locationdynamicformds_4_tfwwpformtitle_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV52Wp_locationdynamicformds_4_tfwwpformtitle_sel, "<#Empty#>") == 0 )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV54Wp_locationdynamicformds_6_tfwwpformreferencename_sel)) && ! ( StringUtil.StrCmp(AV54Wp_locationdynamicformds_6_tfwwpformreferencename_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV54Wp_locationdynamicformds_6_tfwwpformreferencename_sel, "<#Empty#>") == 0 )
         {
