...
namespace GeneXus.Programs {
   public class ucreatedynamicform : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ucreatedynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV32WWPFormId,4,0)),UrlEncode(StringUtil.RTrim(AV26WWPDynamicFormMode)),UrlEncode(StringUtil.RTrim(AV6DefaultFormType)),UrlEncode(StringUtil.LTrimStr(AV43WWPFormType,1,0))}, new string[] {"WWPFormId","WWPDynamicFormMode","DefaultFormType","WWPFormType"}) +"\">") ;
      ...
      {
         return formatLink("ucreatedynamicform.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV32WWPFormId,4,0)),UrlEncode(StringUtil.RTrim(AV26WWPDynamicFormMode)),UrlEncode(StringUtil.RTrim(AV6DefaultFormType)),UrlEncode(StringUtil.LTrimStr(AV43WWPFormType,1,0))}, new string[] {"WWPFormId","WWPDynamicFormMode","DefaultFormType","WWPFormType"})  ;
      }
      ...
      protected void WB9P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavDynamicformtitle_Internalname, "Dynamic Form Title", "col-sm-3 TextBlockTitleMaterialLabel", 0, true, "");
            /* Single line edit */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsettings_Internalname, "", "UASettings", bttBtnsettings_Jsonclick, 7, "UASettings", "", StyleString, ClassString, bttBtnsettings_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e119p1_client"+"'", TempTags, "", 2, "HLP_UCreateDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavSessionid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13SessionId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13SessionId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSessionid_Jsonclick, 0, "Attribute", "", "", "", "", edtavSessionid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_UCreateDynamicForm.htm");
      ...
      protected void E139P2( )
      {
         ...
         if ( StringUtil.StrCmp(AV9HttpRequest.Method, "GET") == 0 )
         {
            ...
            else
            {
               ...
               {
                  GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "Record not found",  "success",  "",  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241212521", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ucreatedynamicform.js", "?20254241212521", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Settings_modal_Title = "Add Element";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E149P2","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("VDYNAMICSECTIONTOUPDATE.CLICK","""{"handler":"E179P2","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV26WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true},{"av":"cmbavDynamicsectiontoupdate"},{"av":"AV28DynamicSectionToUpdate","fld":"vDYNAMICSECTIONTOUPDATE","pic":"ZZZ9"}]""");
