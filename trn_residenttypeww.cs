   ...
   public class trn_residenttypeww : GXDataArea
   {
      ...
      protected void E115H2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ResidentTypeWWFilters")),UrlEncode(StringUtil.RTrim(AV43Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ResidentTypeWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV19ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV19ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV19ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void E165H2( )
      {
         ...
         {
            context.PopUp(formatLink("trn_residenttype.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","ResidentTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S202( )
      {
         ...
         if ( AV31IsAuthorized_Display )
         {
            CallWebObject(formatLink("trn_residenttypeview.aspx", new object[] {UrlEncode(A96ResidentTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ResidentTypeId","TabCode"}) );
      ...
      protected void S212( )
      {
         ...
         if ( AV33IsAuthorized_Update )
         {
            context.PopUp(formatLink("trn_residenttype.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A96ResidentTypeId.ToString())}, new string[] {"Mode","ResidentTypeId"}) , new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV35IsAuthorized_Delete )
         {
            CallWebObject(formatLink("trn_residenttype.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A96ResidentTypeId.ToString())}, new string[] {"Mode","ResidentTypeId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411551615", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residenttypeww.js", "?202542411551617", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E195H2","iparms":[{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_ResidentTypeName","fld":"vISAUTHORIZED_RESIDENTTYPENAME","hsh":true},{"av":"A96ResidentTypeId","fld":"RESIDENTTYPEID","hsh":true}]""");
