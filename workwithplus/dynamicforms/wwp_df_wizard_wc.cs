   ...
   public class wwp_df_wizard_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_wizard_wc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV19WWPDynamicFormMode)),UrlEncode(StringUtil.LTrimStr(AV15SessionId,4,0)),UrlEncode(StringUtil.RTrim(AV29DefaultStep))}, new string[] {"WWPDynamicFormMode","SessionId","DefaultStep","WWPFormInstance"}) +"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542717555941", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_wizard_wc.js", "?202542717555942", false, true);
