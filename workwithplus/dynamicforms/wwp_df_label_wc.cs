   ...
   public class wwp_df_label_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_label_wc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9WWPFormElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV11WWPFormInstanceElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV6SessionId,4,0))}, new string[] {"WWPFormElementId","WWPFormInstanceElementId","SessionId","WWPFormInstance"}) +"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542717555045", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_label_wc.js", "?202542717555046", false, true);
