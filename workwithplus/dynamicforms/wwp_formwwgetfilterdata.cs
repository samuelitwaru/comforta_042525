   ...
   public class wwp_formwwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         while ( AV42GXV1 <= AV30GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV15TFWWPFormDate = context.localUtil.CToT( AV31GridStateFilterValue.gxTpr_Value, 2);
               AV16TFWWPFormDate_To = context.localUtil.CToT( AV31GridStateFilterValue.gxTpr_Valueto, 2);
            }
