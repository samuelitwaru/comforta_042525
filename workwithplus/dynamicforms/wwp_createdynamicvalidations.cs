   ...
   public class wwp_createdynamicvalidations : GXDataArea
   {
      ...
      protected void STRUP230( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV28SessionId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSESSIONID"), ".", ","), 18, MidpointRounding.ToEven));
            AV40WWPFormElementDataType = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vWWPFORMELEMENTDATATYPE"), ".", ","), 18, MidpointRounding.ToEven));
            AV43WWPFormElementReferenceId = cgiGet( "vWWPFORMELEMENTREFERENCEID");
            AV41WWPFormElementId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vWWPFORMELEMENTID"), ".", ","), 18, MidpointRounding.ToEven));
            AV42WWPFormElementParentId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vWWPFORMELEMENTPARENTID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241153491", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_createdynamicvalidations.js", "?20254241153491", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
