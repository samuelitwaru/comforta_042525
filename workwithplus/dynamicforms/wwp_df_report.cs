   ...
   public class wwp_df_report : GXWebProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            AV86WWPFormElements = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Comforta_version20");
            ...
            while ( AV98GXV1 <= AV86WWPFormElements.Count )
            {
               ...
               else if ( AV81WWPFormElement.gxTpr_Wwpformelementtype == 3 )
               {
                  ...
                  {
                     AV87WWPFormElementsMultiples = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Comforta_version20");
