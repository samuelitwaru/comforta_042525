   ...
   public class wwp_df_checkbox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)),UrlEncode(StringUtil.LTrimStr(AV28WWPFormElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV7WWPFormInstanceElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0))}, new string[] {"WWPDynamicFormMode","WWPFormElementId","WWPFormInstanceElementId","SessionId","WWPFormInstance"}) +"\">") ;
      ...
      protected void S152( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", AV30WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV13ElementInternalName,  "true",  ""));
            AV18IsValid = false;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241144490", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_checkbox_wc.js", "?20254241144490", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV23Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Comforta_version20");
         AV22ThisValueStr = "";
