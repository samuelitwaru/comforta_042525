   ...
   public class wwp_ds_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_ds_wc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV5SessionId,4,0)),UrlEncode(StringUtil.RTrim(AV14WWPFormReferenceName)),UrlEncode(StringUtil.RTrim(AV25WWPFormContainerReferenceId)),UrlEncode(StringUtil.RTrim(AV24WWPFormInstanceRecordKey)),UrlEncode(StringUtil.RTrim(Gx_mode))}, new string[] {"SessionId","WWPFormReferenceName","WWPFormContainerReferenceId","WWPFormInstanceRecordKey","Gx_mode"}) +"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254271756348", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_ds_wc.js", "?20254271756349", false, true);
