   ...
   public class wwp_df_text_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_text_wc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)),UrlEncode(StringUtil.LTrimStr(AV29WWPFormElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV34WWPFormInstanceElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0))}, new string[] {"WWPDynamicFormMode","WWPFormElementId","WWPFormInstanceElementId","SessionId","WWPFormInstance"}) +"\">") ;
      ...
      protected void S162( )
      {
         ...
         if ( new WorkWithPlus.workwithplus_dynamicforms.wwp_df_validatetextvalue(context).executeUdp(  AV28WWPFormElementDataType,  AV8Data, out  AV35ErrorMessage) )
         {
            ...
            {
               GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", AV31WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV11ElementInternalName,  "true",  ""));
               AV17IsValid = false;
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241144112", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_text_wc.js", "?20254241144113", false, true);
