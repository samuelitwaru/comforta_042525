   ...
   public class wwp_df_combobox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_combobox_wc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV31WWPDynamicFormMode)),UrlEncode(StringUtil.LTrimStr(AV32WWPFormElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8WWPFormInstanceElementId,4,0)),UrlEncode(StringUtil.LTrimStr(AV25SessionId,4,0))}, new string[] {"WWPDynamicFormMode","WWPFormElementId","WWPFormInstanceElementId","SessionId","WWPFormInstance"}) +"\">") ;
      ...
      protected void S162( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", AV34WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV17ElementInternalName,  "true",  ""));
            AV22IsValid = false;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241144144", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_combobox_wc.js", "?20254241144145", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
