   ...
   public class wwp_df_editvalidation : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_editvalidation.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV16WWPDynamicFormMode)),UrlEncode(StringUtil.LTrimStr(AV21WWPFormElementParentId,4,0)),UrlEncode(StringUtil.LTrimStr(AV19WWPFormElementId,4,0)),UrlEncode(StringUtil.RTrim(AV20WWPFormElementReferenceId)),UrlEncode(StringUtil.LTrimStr(AV18WWPFormElementDataType,2,0)),UrlEncode(StringUtil.LTrimStr(AV9SessionId,4,0)),UrlEncode(StringUtil.RTrim(AV12ValidationJson))}, new string[] {"WWPDynamicFormMode","WWPFormElementParentId","WWPFormElementId","WWPFormElementReferenceId","WWPFormElementDataType","SessionId","ValidationJson"}) +"\">") ;
      ...
      protected void E13242( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "Enter a condition to validate",  "error",  edtavValidationcondition_Internalname,  "true",  ""));
         }
         else
         {
      ...
      protected void S122( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Validation message", "", "", "", "", "", "", "", ""),  "error",  edtavValidationmessage_Internalname,  "true",  ""));
            AV6CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV6CheckRequiredFieldsResult", AV6CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11ValidationCondition)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Validation condition", "", "", "", "", "", "", "", ""),  "error",  edtavValidationcondition_Internalname,  "true",  ""));
            AV6CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV6CheckRequiredFieldsResult", AV6CheckRequiredFieldsResult);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411443265", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_editvalidation.js", "?202542411443268", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Suggest/SuggestRender.js", "", false, true);
