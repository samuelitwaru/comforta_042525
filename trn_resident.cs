   ...
   public class trn_resident : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action59") == 0 )
         {
            ...
            XC_59_0964( Gx_mode, A71ResidentGUID) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_69") == 0 )
         {
            ...
            gxLoad_69( A527ResidentPackageId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtResidentBirthDate_Internalname, context.localUtil.Format(A73ResidentBirthDate, "99/99/9999"), context.localUtil.Format( A73ResidentBirthDate, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'eng',false,0);"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentBirthDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtResidentBirthDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Trn_Resident.htm");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup5_Internalname, "Address Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_Resident.htm");
         /* Div Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtResidentZipCode_Internalname, A314ResidentZipCode, StringUtil.RTrim( context.localUtil.Format( A314ResidentZipCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,133);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "1234 AB", edtResidentZipCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtResidentZipCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_Resident.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup7_Internalname, "Provisioning Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_Resident.htm");
         /* Div Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockresidentpackageid_Internalname, "Access Rights Name", "", "", lblTextblockresidentpackageid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Trn_Resident.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtResidentPackageId_Internalname, "Resident Package Id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z603ResidentLanguage = cgiGet( "Z603ResidentLanguage");
               ...
               A603ResidentLanguage = cgiGet( "Z603ResidentLanguage");
               ...
               A603ResidentLanguage = cgiGet( "RESIDENTLANGUAGE");
               ...
               Combo_residentpackageid_Datalistupdateminimumcharacters = (int)(Math.Round(context.localUtil.CToN( cgiGet( "COMBO_RESIDENTPACKAGEID_Datalistupdateminimumcharacters"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               forbiddenHiddens.Add("ResidentLanguage", StringUtil.RTrim( context.localUtil.Format( A603ResidentLanguage, "")));
               hsh = cgiGet( "hsh");
      ...
      protected void E14092( )
      {
         ...
         {
            AV46Session.Set("NotificationMessage", "Resident Updated successfully");
         ...
         {
            AV46Session.Set("NotificationMessage", "Resident Deleted successfully");
            context.setWebReturnParms(new Object[] {});
            context.setWebReturnParmsMetadata(new Object[] {});
            context.wjLocDisableFrm = 1;
            context.nUserReturn = 1;
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV46Session.Set("NotificationMessage", "Resident Inserted successfully");
            context.setWebReturnParms(new Object[] {});
            context.setWebReturnParmsMetadata(new Object[] {});
            context.wjLocDisableFrm = 1;
            context.nUserReturn = 1;
      ...
      protected void ZM0964( short GX_JID )
      {
         if ( ( GX_JID == 65 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z603ResidentLanguage = T00093_A603ResidentLanguage[0];
            ...
            else
            {
               ...
               Z603ResidentLanguage = A603ResidentLanguage;
      ...
      protected void Load0964( )
      {
         ...
         if ( (pr_default.getStatus(6) != 101) )
         {
            ...
            A603ResidentLanguage = T00098_A603ResidentLanguage[0];
      ...
      protected void CheckExtendedTable0964( )
      {
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "RESIDENTEMAIL");
            AnyError = 1;
         ...
         A314ResidentZipCode = StringUtil.Upper( A314ResidentZipCode);
         AssignAttri("", false, "A314ResidentZipCode", A314ResidentZipCode);
         if ( ! GxRegex.IsMatch(A314ResidentZipCode,"^\\d{4}\\s?[A-Z]{2}$") && ! String.IsNullOrEmpty(StringUtil.RTrim( A314ResidentZipCode)) )
         {
         ...
         A70ResidentPhone = GXt_char2;
         AssignAttri("", false, "A70ResidentPhone", A70ResidentPhone);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A348ResidentPhoneNumber)) && ! GxRegex.IsMatch(A348ResidentPhoneNumber,"^\\d{9}$") )
         {
         ...
         A430ResidentHomePhone = GXt_char2;
         AssignAttri("", false, "A430ResidentHomePhone", A430ResidentHomePhone);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A432ResidentHomePhoneNumber)) && ! GxRegex.IsMatch(A432ResidentHomePhoneNumber,"^\\d{9}$") )
         {
         ...
         if ( (pr_default.getStatus(5) == 101) )
         {
            ...
            {
               GX_msglist.addItem("No matching 'Trn_ResidentPackage'.", "ForeignKeyNotFound", 1, "RESIDENTPACKAGEID");
               AnyError = 1;
               GX_FocusControl = edtResidentPackageId_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
            }
      ...
      protected void gxLoad_69( Guid A527ResidentPackageId )
      {
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A603ResidentLanguage = T00093_A603ResidentLanguage[0];
      ...
      protected void CheckOptimisticConcurrency0964( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z603ResidentLanguage, T00092_A603ResidentLanguage[0]) != 0 ) || ( Z96ResidentTypeId != T00092_A96ResidentTypeId[0] ) || ( Z98MedicalIndicationId != T00092_A98MedicalIndicationId[0] ) || ( Z527ResidentPackageId != T00092_A527ResidentPackageId[0] ) )
            {
               ...
               if ( StringUtil.StrCmp(Z603ResidentLanguage, T00092_A603ResidentLanguage[0]) != 0 )
               {
                  GXUtil.WriteLog("trn_resident:[seudo value changed for attri]"+"ResidentLanguage");
                  GXUtil.WriteLogRaw("Old: ",Z603ResidentLanguage);
                  GXUtil.WriteLogRaw("Current: ",T00092_A603ResidentLanguage[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(14, new Object[] {A62ResidentId, A312ResidentCountry, A431ResidentHomePhoneCode, A347ResidentPhoneCode, A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A348ResidentPhoneNumber, A432ResidentHomePhoneNumber, n445ResidentImage, A445ResidentImage, n40000ResidentImage_GXI, A40000ResidentImage_GXI, A603ResidentLanguage, A29LocationId, A11OrganisationId, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId});
                     pr_default.close(14);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(15, new Object[] {A312ResidentCountry, A431ResidentHomePhoneCode, A347ResidentPhoneCode, A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A348ResidentPhoneNumber, A432ResidentHomePhoneNumber, A603ResidentLanguage, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId, A62ResidentId, A29LocationId, A11OrganisationId});
                     pr_default.close(15);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_Resident");
      ...
      protected void OnDeleteControls0964( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"Trn_Memo"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(21);
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z603ResidentLanguage", StringUtil.RTrim( Z603ResidentLanguage));
         ...
         GxWebStd.gx_hidden_field( context, "RESIDENTLANGUAGE", StringUtil.RTrim( A603ResidentLanguage));
      ...
      protected void InitializeNonKey0964( )
      {
         ...
         AssignAttri("", false, "A603ResidentLanguage", A603ResidentLanguage);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254241149670", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_resident.js", "?20254241149674", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void XC_59_0964( string Gx_mode ,
                                 string A71ResidentGUID )
      {
         if ( IsDlt( )  )
         {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV13TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV7ResidentId","fld":"vRESIDENTID","hsh":true},{"av":"AV8LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV9OrganisationId","fld":"vORGANISATIONID","hsh":true},{"av":"AV62Pgmname","fld":"vPGMNAME"},{"av":"A603ResidentLanguage","fld":"RESIDENTLANGUAGE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         T00098_A603ResidentLanguage = new string[] {""} ;
         ...
         T00093_A603ResidentLanguage = new string[] {""} ;
         ...
         T00092_A603ResidentLanguage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_resident__default(),
            new Object[][] {
               ...
               T00092_A432ResidentHomePhoneNumber, T00092_A40000ResidentImage_GXI, T00092_n40000ResidentImage_GXI, T00092_A603ResidentLanguage, T00092_A29LocationId, T00092_A11OrganisationId, T00092_A96ResidentTypeId, T00092_n96ResidentTypeId, T00092_A98MedicalIndicationId, T00092_n98MedicalIndicationId,
               ...
               T00093_A432ResidentHomePhoneNumber, T00093_A40000ResidentImage_GXI, T00093_n40000ResidentImage_GXI, T00093_A603ResidentLanguage, T00093_A29LocationId, T00093_A11OrganisationId, T00093_A96ResidentTypeId, T00093_n96ResidentTypeId, T00093_A98MedicalIndicationId, T00093_n98MedicalIndicationId,
               ...
               T00098_A99MedicalIndicationName, T00098_A348ResidentPhoneNumber, T00098_A432ResidentHomePhoneNumber, T00098_A40000ResidentImage_GXI, T00098_n40000ResidentImage_GXI, T00098_A603ResidentLanguage, T00098_A531ResidentPackageName, T00098_A29LocationId, T00098_A11OrganisationId, T00098_A96ResidentTypeId,
      ...
      private string Z603ResidentLanguage ;
      ...
      private string[] T00098_A603ResidentLanguage ;
      ...
      private string[] T00093_A603ResidentLanguage ;
      ...
      private string[] T00092_A603ResidentLanguage ;
