...
namespace GeneXus.Programs {
   public class trn_supplieragbview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_supplieragbview.aspx", new object[] {UrlEncode(AV10SupplierAgbId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SupplierAgbId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_supplieragbview.aspx", new object[] {UrlEncode(AV10SupplierAgbId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SupplierAgbId","TabCode"})  ;
      }
      ...
      protected void STRUP4G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10SupplierAgbId = StringUtil.StrToGuid( cgiGet( "vSUPPLIERAGBID"));
      ...
      protected void E124G2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_SupplierAgb",StringUtil.Trim( A49SupplierAgbId.ToString()),(string)AV14RecordDescription,formatLink("trn_supplieragbview.aspx", new object[] {UrlEncode(A49SupplierAgbId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"SupplierAgbId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418145573", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbview.js", "?202542418145573", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
