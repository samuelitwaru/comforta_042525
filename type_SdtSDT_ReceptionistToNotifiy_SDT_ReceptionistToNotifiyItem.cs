...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_ReceptionistToNotifiyItem" , Namespace="Comforta_version20" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_ReceptionistToNotifiyItem", Namespace="Comforta_version20")]
