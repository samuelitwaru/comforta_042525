...
namespace GeneXus.Programs {
   public class trn_locationview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_locationview.aspx", new object[] {UrlEncode(AV10LocationId.ToString()),UrlEncode(AV11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LocationId","OrganisationId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_locationview.aspx", new object[] {UrlEncode(AV10LocationId.ToString()),UrlEncode(AV11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LocationId","OrganisationId","TabCode"})  ;
      }
      ...
      protected void STRUP410( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10LocationId = StringUtil.StrToGuid( cgiGet( "vLOCATIONID"));
      ...
      protected void E12412( )
      {
         ...
         if ( AV17IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_Location",StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription,formatLink("trn_locationview.aspx", new object[] {UrlEncode(A29LocationId.ToString()),UrlEncode(A11OrganisationId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"LocationId","OrganisationId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542418145858", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_locationview.js", "?202542418145858", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
