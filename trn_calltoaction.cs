   ...
   public class trn_calltoaction : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_16") == 0 )
         {
            ...
            gxLoad_16( A58ProductServiceId, A29LocationId, A11OrganisationId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_15") == 0 )
         {
            ...
            gxLoad_15( A366LocationDynamicFormId, A11OrganisationId, A29LocationId) ;
            return  ;
         }
      ...
      protected void CheckExtendedTable1572( )
      {
         ...
         pr_default.close(3);
         /* Using cursor T00154 */
         pr_default.execute(2, new Object[] {n366LocationDynamicFormId, A366LocationDynamicFormId, A11OrganisationId, A29LocationId});
         ...
         A206WWPFormId = T00154_A206WWPFormId[0];
         AssignAttri("", false, "A206WWPFormId", StringUtil.LTrimStr( (decimal)(A206WWPFormId), 4, 0));
         A207WWPFormVersionNumber = T00154_A207WWPFormVersionNumber[0];
         AssignAttri("", false, "A207WWPFormVersionNumber", StringUtil.LTrimStr( (decimal)(A207WWPFormVersionNumber), 4, 0));
         pr_default.close(2);
         GXt_int1 = A219WWPFormLatestVersionNumber;
         new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_getlatestversionofform(context ).execute(  A206WWPFormId, out  GXt_int1) ;
         ...
         {
            GX_msglist.addItem("Invalid email pattern", "OutOfRange", 1, "CALLTOACTIONEMAIL");
            AnyError = 1;
      ...
      protected void gxLoad_16( Guid A58ProductServiceId ,
                                Guid A29LocationId ,
      ...
      protected void gxLoad_15( Guid A366LocationDynamicFormId ,
                                Guid A11OrganisationId ,
                                Guid A29LocationId )
      {
         /* Using cursor T00159 */
      ...
      protected void CheckOptimisticConcurrency1572( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z500CallToActionPhoneNumber, T00152_A500CallToActionPhoneNumber[0]) != 0 ) || ( StringUtil.StrCmp(Z341CallToActionEmail, T00152_A341CallToActionEmail[0]) != 0 ) || ( Z366LocationDynamicFormId != T00152_A366LocationDynamicFormId[0] ) || ( Z11OrganisationId != T00152_A11OrganisationId[0] ) || ( Z29LocationId != T00152_A29LocationId[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z58ProductServiceId != T00152_A58ProductServiceId[0] ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(12, new Object[] {A339CallToActionId, A367CallToActionUrl, A368CallToActionName, A340CallToActionType, A342CallToActionPhone, A499CallToActionPhoneCode, A500CallToActionPhoneNumber, A341CallToActionEmail, n366LocationDynamicFormId, A366LocationDynamicFormId, A11OrganisationId, A29LocationId, A58ProductServiceId});
                     pr_default.close(12);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411512839", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_calltoaction.js", "?202542411512842", false, true);
      ...
      public override void initialize( )
      {
         ...
         T00155_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         T00154_A206WWPFormId = new short[1] ;
         T00154_A207WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_calltoaction__default(),
            new Object[][] {
                new Object[] {
               T00152_A339CallToActionId, T00152_A367CallToActionUrl, T00152_A368CallToActionName, T00152_A340CallToActionType, T00152_A342CallToActionPhone, T00152_A499CallToActionPhoneCode, T00152_A500CallToActionPhoneNumber, T00152_A341CallToActionEmail, T00152_A366LocationDynamicFormId, T00152_n366LocationDynamicFormId,
               T00152_A11OrganisationId, T00152_A29LocationId, T00152_A58ProductServiceId
               }
               , new Object[] {
               T00153_A339CallToActionId, T00153_A367CallToActionUrl, T00153_A368CallToActionName, T00153_A340CallToActionType, T00153_A342CallToActionPhone, T00153_A499CallToActionPhoneCode, T00153_A500CallToActionPhoneNumber, T00153_A341CallToActionEmail, T00153_A366LocationDynamicFormId, T00153_n366LocationDynamicFormId,
               T00153_A11OrganisationId, T00153_A29LocationId, T00153_A58ProductServiceId
               }
               , new Object[] {
               T00154_A206WWPFormId, T00154_A207WWPFormVersionNumber
               }
               , new Object[] {
               T00155_A58ProductServiceId
               }
               , new Object[] {
               ...
               T00157_A231WWPFormDate, T00157_A232WWPFormIsWizard, T00157_A216WWPFormResume, T00157_A235WWPFormResumeMessage, T00157_A233WWPFormValidations, T00157_A234WWPFormInstantiated, T00157_A240WWPFormType, T00157_A241WWPFormSectionRefElements, T00157_A242WWPFormIsForDynamicValidations, T00157_A366LocationDynamicFormId,
               T00157_n366LocationDynamicFormId, T00157_A11OrganisationId, T00157_A29LocationId, T00157_A58ProductServiceId, T00157_A206WWPFormId, T00157_A207WWPFormVersionNumber
               }
               , new Object[] {
      ...
      private Guid[] T00155_A58ProductServiceId ;
      private short[] T00154_A206WWPFormId ;
      private short[] T00154_A207WWPFormVersionNumber ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("T00154", "SELECT WWPFormId, WWPFormVersionNumber FROM Trn_LocationDynamicForm WHERE LocationDynamicFormId = :LocationDynamicFormId AND OrganisationId = :OrganisationId AND LocationId = :LocationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00154,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T00155", "SELECT ProductServiceId FROM Trn_ProductService WHERE ProductServiceId = :ProductServiceId AND LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00155,1, GxCacheFrequency.OFF ,true,false )
