   ...
   public class trn_resident_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void Load0964( )
      {
         ...
         if ( (pr_default.getStatus(6) != 101) )
         {
            ...
            A603ResidentLanguage = BC00098_A603ResidentLanguage[0];
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A603ResidentLanguage = BC00093_A603ResidentLanguage[0];
      ...
      protected void CheckOptimisticConcurrency0964( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z603ResidentLanguage, BC00092_A603ResidentLanguage[0]) != 0 ) || ( Z96ResidentTypeId != BC00092_A96ResidentTypeId[0] ) || ( Z98MedicalIndicationId != BC00092_A98MedicalIndicationId[0] ) || ( Z527ResidentPackageId != BC00092_A527ResidentPackageId[0] ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A62ResidentId, A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A347ResidentPhoneCode, A348ResidentPhoneNumber, A431ResidentHomePhoneCode, A432ResidentHomePhoneNumber, n445ResidentImage, A445ResidentImage, n40000ResidentImage_GXI, A40000ResidentImage_GXI, A603ResidentLanguage, A29LocationId, A11OrganisationId, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId});
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A66ResidentInitials, A70ResidentPhone, A430ResidentHomePhone, A314ResidentZipCode, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A312ResidentCountry, A313ResidentCity, A315ResidentAddressLine1, A316ResidentAddressLine2, A73ResidentBirthDate, A71ResidentGUID, A347ResidentPhoneCode, A348ResidentPhoneNumber, A431ResidentHomePhoneCode, A432ResidentHomePhoneNumber, A603ResidentLanguage, n96ResidentTypeId, A96ResidentTypeId, n98MedicalIndicationId, A98MedicalIndicationId, n527ResidentPackageId, A527ResidentPackageId, A62ResidentId, A29LocationId, A11OrganisationId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_Resident");
      ...
      public void ScanKeyStart0964( )
      {
         ...
         if ( (pr_default.getStatus(16) != 101) )
         {
            ...
            A603ResidentLanguage = BC000918_A603ResidentLanguage[0];
      ...
      public void VarsToRow64( SdtTrn_Resident obj64 )
      {
         ...
         obj64.gxTpr_Residentlanguage = A603ResidentLanguage;
         ...
         obj64.gxTpr_Residentlanguage_Z = Z603ResidentLanguage;
                               ...
                               int forceLoad )
      {
         ...
         n40000ResidentImage_GXI = false;
         A603ResidentLanguage = obj64.gxTpr_Residentlanguage;
         ...
         Z603ResidentLanguage = obj64.gxTpr_Residentlanguage_Z;
      ...
      public override void initialize( )
      {
         ...
         BC00098_A603ResidentLanguage = new string[] {""} ;
         ...
         BC00093_A603ResidentLanguage = new string[] {""} ;
         ...
         BC00092_A603ResidentLanguage = new string[] {""} ;
         ...
         BC000918_A603ResidentLanguage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_resident_bc__default(),
            new Object[][] {
               ...
               BC00092_A432ResidentHomePhoneNumber, BC00092_A40000ResidentImage_GXI, BC00092_n40000ResidentImage_GXI, BC00092_A603ResidentLanguage, BC00092_A29LocationId, BC00092_A11OrganisationId, BC00092_A96ResidentTypeId, BC00092_n96ResidentTypeId, BC00092_A98MedicalIndicationId, BC00092_n98MedicalIndicationId,
               ...
               BC00093_A432ResidentHomePhoneNumber, BC00093_A40000ResidentImage_GXI, BC00093_n40000ResidentImage_GXI, BC00093_A603ResidentLanguage, BC00093_A29LocationId, BC00093_A11OrganisationId, BC00093_A96ResidentTypeId, BC00093_n96ResidentTypeId, BC00093_A98MedicalIndicationId, BC00093_n98MedicalIndicationId,
               ...
               BC00098_A348ResidentPhoneNumber, BC00098_A431ResidentHomePhoneCode, BC00098_A432ResidentHomePhoneNumber, BC00098_A40000ResidentImage_GXI, BC00098_n40000ResidentImage_GXI, BC00098_A603ResidentLanguage, BC00098_A531ResidentPackageName, BC00098_A29LocationId, BC00098_A11OrganisationId, BC00098_A96ResidentTypeId,
      ...
      private string[] BC00098_A603ResidentLanguage ;
      ...
      private string[] BC00093_A603ResidentLanguage ;
      ...
      private string[] BC00092_A603ResidentLanguage ;
      ...
      private string[] BC000918_A603ResidentLanguage ;
