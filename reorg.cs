...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_Organisation( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE INDEX ITRN_ORGANISATION3 ON Trn_Organisation (OrganisationTypeId ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX ITRN_ORGANISATION3 "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Media( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Media (MediaId CHAR(36) NOT NULL , MediaName VARCHAR(100) NOT NULL , MediaImage BYTEA , MediaImage_GXI VARCHAR(2048) , MediaSize integer NOT NULL , MediaType CHAR(20) NOT NULL , MediaUrl VARCHAR(1000) NOT NULL , LocationId CHAR(36) NOT NULL , PRIMARY KEY(MediaId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_AppVersion( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_AppVersion (AppVersionId CHAR(36) NOT NULL , AppVersionName VARCHAR(100) NOT NULL , IsActive BOOLEAN NOT NULL , LocationId CHAR(36) , OrganisationId CHAR(36) , PRIMARY KEY(AppVersionId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITrn_OrganisationTrn_OrganisationType( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Organisation ADD CONSTRAINT ITRN_ORGANISATION3 FOREIGN KEY (OrganisationTypeId) REFERENCES Trn_OrganisationType (OrganisationTypeId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_Organisation DROP CONSTRAINT ITRN_ORGANISATION3 "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      private void ExecuteOnlyTablesReorganization( )
      {
         ...
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "CreateTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "CreateTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "CreateTrn_Theme" , new Object[]{ });
         ...
         ReorgExecute.RegisterBlockForSubmit( 31 ,  "CreateTrn_Receptionist" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 32 ,  "CreateTrn_Template" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 33 ,  "CreateTrn_ThemeColor" , new Object[]{ });
         ...
         ReorgExecute.RegisterBlockForSubmit( 62 ,  "CreateTrn_AppVersion" , new Object[]{ });
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 65 ,  "RITrn_ManagerTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 66 ,  "RITrn_AppVersionTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 67 ,  "RITrn_AppVersionTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 68 ,  "RITrn_SupplierGenTrn_SupplierGenType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 69 ,  "RITrn_SupplierGenTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 70 ,  "RITrn_SupplierGenTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 71 ,  "RITrn_SupplierAGBTrn_SupplierAgbType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 72 ,  "RIWWP_SubscriptionWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 73 ,  "RIWWP_SubscriptionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 74 ,  "RIWWP_SMSWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 75 ,  "RIWWP_WebNotificationWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 76 ,  "RIWWP_WebClientWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 77 ,  "RIWWP_NotificationDefinitionWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 78 ,  "RIWWP_NotificationWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 79 ,  "RIWWP_NotificationWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 80 ,  "RIWWP_MailWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 81 ,  "RIWWP_MailAttachmentsWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 82 ,  "RIWWP_DiscussionMessageWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 83 ,  "RIWWP_DiscussionMessageWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 84 ,  "RIWWP_DiscussionMessageWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 85 ,  "RIWWP_DiscussionMessageMentionWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 86 ,  "RIWWP_DiscussionMessageMentionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 87 ,  "RIWWP_FormElementWWP_FormElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 88 ,  "RIWWP_FormInstanceWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 89 ,  "RIWWP_FormInstanceWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 90 ,  "RIWWP_FormInstanceElementWWP_FormInstance" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 91 ,  "RITrn_AgendaCalendarTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 92 ,  "RITrn_ThemeColorTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 93 ,  "RITrn_ReceptionistTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 94 ,  "RITrn_ResidentTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 95 ,  "RITrn_ResidentTrn_ResidentType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 96 ,  "RITrn_ResidentTrn_MedicalIndication" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 97 ,  "RITrn_ResidentTrn_ResidentPackage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 98 ,  "RITrn_ProductServiceTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 99 ,  "RITrn_ProductServiceTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 100 ,  "RITrn_ProductServiceTrn_SupplierAGB" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 101 ,  "RITrn_LocationDynamicFormTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 102 ,  "RITrn_LocationDynamicFormWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 103 ,  "RITrn_CallToActionTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 104 ,  "RITrn_CallToActionTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 105 ,  "RITrn_AuditTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 106 ,  "RITrn_ThemeIconTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 107 ,  "RITrn_AgendaEventGroupTrn_AgendaCalendar" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 108 ,  "RITrn_ResidentNotificationTrn_AppNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 109 ,  "RITrn_PageTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 110 ,  "RITrn_PageTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 111 ,  "RITrn_OrganisationDynamicFormTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 112 ,  "RITrn_OrganisationDynamicFormWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 113 ,  "RITrn_OrganisationSettingTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 114 ,  "RITrn_OrganisationSettingTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 115 ,  "RITrn_AppVersionPageTrn_AppVersion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 116 ,  "RITrn_ResidentPackageTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 117 ,  "RITrn_ThemeCtaColorTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 118 ,  "RITrn_MemoTrn_MemoCategory" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 119 ,  "RITrn_MemoTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 120 ,  "RITrn_OrganisationTrn_OrganisationType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 121 ,  "RITrn_LocationTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 122 ,  "RITrn_LocationTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 123 ,  "RITrn_LocationTrn_Theme1" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 124 ,  "RITrn_LocationTrn_AppVersion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 125 ,  "RITrn_LocationTrn_AppVersion1" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 126 ,  "RITrn_SupplierDynamicFormTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 127 ,  "RITrn_SupplierDynamicFormWWP_Form" , new Object[]{ });
      }
      ...
      private void SetPrecedencetables( )
      {
         ...
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Location", ""}) );
         ...
         ReorgExecute.RegisterPrecedence( "CreateTrn_Location" ,  "CreateTrn_Theme" );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Location" ,  "CreateTrn_AppVersion" );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Location" ,  "CreateTrn_AppVersion" );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Organisation", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Organisation" ,  "CreateTrn_OrganisationType" );
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Theme", ""}) );
         ...
         GXReorganization.SetMsg( 31 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Receptionist", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Receptionist" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 32 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Template", ""}) );
         GXReorganization.SetMsg( 33 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeColor", ""}) );
         ...
         GXReorganization.SetMsg( 62 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppVersion", ""}) );
      ...
      {
         GXReorganization.SetMsg( 65 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MANAGER1"}) );
         ...
         GXReorganization.SetMsg( 66 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_0006000B"}) );
         ...
         GXReorganization.SetMsg( 67 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_APPVERSION1"}) );
         ...
         GXReorganization.SetMsg( 68 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN1"}) );
         ...
         GXReorganization.SetMsg( 69 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN3"}) );
         ...
         GXReorganization.SetMsg( 70 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN2"}) );
         ...
         GXReorganization.SetMsg( 71 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERAGB1"}) );
         ...
         GXReorganization.SetMsg( 72 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION2"}) );
         ...
         GXReorganization.SetMsg( 73 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION1"}) );
         ...
         GXReorganization.SetMsg( 74 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SMS1"}) );
         ...
         GXReorganization.SetMsg( 75 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 76 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBCLIENT1"}) );
         ...
         GXReorganization.SetMsg( 77 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATIONDEFINITION1"}) );
         ...
         GXReorganization.SetMsg( 78 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION2"}) );
         ...
         GXReorganization.SetMsg( 79 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 80 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAIL1"}) );
         ...
         GXReorganization.SetMsg( 81 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAILATTACHMENTS1"}) );
         ...
         GXReorganization.SetMsg( 82 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE3"}) );
         ...
         GXReorganization.SetMsg( 83 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE2"}) );
         ...
         GXReorganization.SetMsg( 84 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         GXReorganization.SetMsg( 85 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION2"}) );
         ...
         GXReorganization.SetMsg( 86 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION1"}) );
         ...
         GXReorganization.SetMsg( 87 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMELEMENT1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         GXReorganization.SetMsg( 88 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCE1"}) );
         ...
         GXReorganization.SetMsg( 89 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_FORMINSTANCE"}) );
         ...
         GXReorganization.SetMsg( 90 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCEELEMENT1"}) );
         ...
         GXReorganization.SetMsg( 92 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMECOLOR1"}) );
         ...
         GXReorganization.SetMsg( 94 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT4"}) );
         ...
         GXReorganization.SetMsg( 95 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT3"}) );
         ...
         GXReorganization.SetMsg( 96 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT2"}) );
         ...
         GXReorganization.SetMsg( 97 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT1"}) );
         ...
         GXReorganization.SetMsg( 98 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE3"}) );
         ...
         GXReorganization.SetMsg( 99 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE2"}) );
         ...
         GXReorganization.SetMsg( 100 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE1"}) );
         ...
         GXReorganization.SetMsg( 101 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 102 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM1"}) );
         ...
         GXReorganization.SetMsg( 103 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION2"}) );
         ...
         GXReorganization.SetMsg( 104 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION1"}) );
         ...
         GXReorganization.SetMsg( 105 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AUDIT"}) );
         ...
         GXReorganization.SetMsg( 106 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMEICON1"}) );
         ...
         GXReorganization.SetMsg( 107 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AGENDAEVENTGROUP1"}) );
         ...
         GXReorganization.SetMsg( 108 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 109 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_002G000B000T"}) );
         ...
         GXReorganization.SetMsg( 110 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PAGE1"}) );
         ...
         GXReorganization.SetMsg( 111 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 112 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONDYNAMICFORM1"}) );
         ...
         GXReorganization.SetMsg( 113 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONSETTING1"}) );
         ...
         GXReorganization.SetMsg( 114 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONSETTING2"}) );
         ...
         GXReorganization.SetMsg( 115 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_APPVERSIONPAGE2"}) );
         ...
         GXReorganization.SetMsg( 116 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTPACKAGE1"}) );
         ...
         GXReorganization.SetMsg( 117 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMECTACOLOR1"}) );
         ...
         GXReorganization.SetMsg( 118 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MEMO1"}) );
         ...
         GXReorganization.SetMsg( 119 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MEMO2"}) );
         ...
         GXReorganization.SetMsg( 120 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATION3"}) );
         ...
         GXReorganization.SetMsg( 121 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION1"}) );
         ...
         GXReorganization.SetMsg( 122 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION3"}) );
         ...
         GXReorganization.SetMsg( 123 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION2"}) );
         ...
         GXReorganization.SetMsg( 124 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION5"}) );
         ...
         GXReorganization.SetMsg( 125 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION4"}) );
         ...
         GXReorganization.SetMsg( 126 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 127 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERDYNAMICFORM1"}) );
