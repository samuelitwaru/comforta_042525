...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_Media( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_Media ADD MediaDateTime timestamp without time zone  "
         ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Trn_Media",sSchemaVar,"MediaDateTime") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"MediaDateTime", "Trn_Media"}) ) ;
            return false ;
         }
         return true ;
      }
