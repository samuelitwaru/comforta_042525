...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("Trn_SupplierDynamicForm",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Trn_SupplierDynamicForm"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "RITrn_SupplierDynamicFormTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "RITrn_SupplierDynamicFormWWP_Form" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERDYNAMICFORM2"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_SupplierDynamicFormTrn_SupplierGen" ,  "CreateTrn_SupplierDynamicForm" );
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERDYNAMICFORM1"}) );
