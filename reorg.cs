...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_AppVersion( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_AppVersion ADD IsVersionDeleted BOOLEAN NOT NULL DEFAULT FALSE, ADD VersionDeletedAt timestamp without time zone  "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_AppVersion ALTER COLUMN IsVersionDeleted DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      public void ReorganizeTrn_AppVersionPage( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_AppVersionPage ADD IsPageDeleted BOOLEAN NOT NULL DEFAULT FALSE, ADD PageDeletedAt timestamp without time zone  "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_AppVersionPage ALTER COLUMN IsPageDeleted DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            Trn_AppVersionPageCount = P00023_ATrn_AppVersionPageCount[0];
            pr_default.close(1);
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Trn_AppVersion",sSchemaVar,"IsVersionDeleted") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"IsVersionDeleted", "Trn_AppVersion"}) ) ;
            return false ;
         }
         if ( ColumnExist("Trn_AppVersion",sSchemaVar,"VersionDeletedAt") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"VersionDeletedAt", "Trn_AppVersion"}) ) ;
            return false ;
         }
         if ( ColumnExist("Trn_AppVersionPage",sSchemaVar,"IsPageDeleted") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"IsPageDeleted", "Trn_AppVersionPage"}) ) ;
            return false ;
         }
         if ( ColumnExist("Trn_AppVersionPage",sSchemaVar,"PageDeletedAt") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"PageDeletedAt", "Trn_AppVersionPage"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      private void ExecuteOnlyTablesReorganization( )
      {
         ...
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "ReorganizeTrn_AppVersionPage" , new Object[]{ });
      }
      ...
      private void SetPrecedencetables( )
      {
         ...
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"Trn_AppVersionPage", ""}) );
      }
      ...
      public override void initialize( )
      {
         ...
         P00023_ATrn_AppVersionPageCount = new int[1] ;
         sSchemaVar = "";
         sTableName = "";
         sMySchemaName = "";
         sMyColumnName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reorg__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00023_ATrn_AppVersionPageCount
               }
               , new Object[] {
      ...
      protected int[] P00023_ATrn_AppVersionPageCount ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00023", "SELECT COUNT(*) FROM Trn_AppVersionPage ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00023,100, GxCacheFrequency.OFF ,true,false )
