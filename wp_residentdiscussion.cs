...
namespace GeneXus.Programs {
   public class wp_residentdiscussion : GXDataArea
   {
      ...
      protected void E117N2( )
      {
         ...
         AV9ResidentId = AV11WebSession.Get("WebViewResidentId");
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A603ResidentLanguage = H007N2_A603ResidentLanguage[0];
            AV22Language = A603ResidentLanguage;
         ...
         else
         {
            ...
            AssignAttri("", false, "AV17ShowNoRecordFound", AV17ShowNoRecordFound);
            lblErrormessage_Caption = "The user session has expired";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411555731", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_residentdiscussion.js", "?202542411555731", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblErrormessage_Caption = "The discussion record could not be found";
      ...
      public override void initialize( )
      {
         ...
         H007N2_A603ResidentLanguage = new string[] {""} ;
         A71ResidentGUID = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_residentdiscussion__default(),
            new Object[][] {
                new Object[] {
               H007N2_A62ResidentId, H007N2_A29LocationId, H007N2_A11OrganisationId, H007N2_A71ResidentGUID, H007N2_A603ResidentLanguage
               }
            }
         );
      ...
      private string[] H007N2_A603ResidentLanguage ;
