...
namespace GeneXus.Programs {
   public class wp_residentdynamicform : GXDataArea
   {
      ...
      protected void E117K2( )
      {
         ...
         if ( AV16isTokenValid )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A603ResidentLanguage = H007K2_A603ResidentLanguage[0];
               AV19Language = A603ResidentLanguage;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411555670", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_residentdynamicform.js", "?202542411555670", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblErrormessage_Caption = "The record could not be found";
      ...
      public override void initialize( )
      {
         ...
         H007K2_A603ResidentLanguage = new string[] {""} ;
         A71ResidentGUID = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_residentdynamicform__default(),
            new Object[][] {
                new Object[] {
               H007K2_A62ResidentId, H007K2_A29LocationId, H007K2_A11OrganisationId, H007K2_A71ResidentGUID, H007K2_A603ResidentLanguage
               }
            }
         );
      ...
      private string[] H007K2_A603ResidentLanguage ;
