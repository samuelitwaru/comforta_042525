...
namespace GeneXus.Programs {
   public class trn_organisationtypeview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_organisationtypeview.aspx", new object[] {UrlEncode(AV10OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"OrganisationTypeId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_organisationtypeview.aspx", new object[] {UrlEncode(AV10OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"OrganisationTypeId","TabCode"})  ;
      }
      ...
      protected void WB3J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_OrganisationTypeView.htm");
            /* Div Control */
      ...
      protected void STRUP3J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10OrganisationTypeId = StringUtil.StrToGuid( cgiGet( "vORGANISATIONTYPEID"));
      ...
      protected void E123J2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_OrganisationType",StringUtil.Trim( A19OrganisationTypeId.ToString()),(string)AV14RecordDescription,formatLink("trn_organisationtypeview.aspx", new object[] {UrlEncode(A19OrganisationTypeId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationTypeId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542411535534", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationtypeview.js", "?202542411535534", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
