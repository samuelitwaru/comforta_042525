...
namespace GeneXus.Programs {
   public class trn_memoview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_memoview.aspx", new object[] {UrlEncode(AV10MemoId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MemoId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_memoview.aspx", new object[] {UrlEncode(AV10MemoId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MemoId","TabCode"})  ;
      }
      ...
      protected void WBAO0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_MemoView.htm");
            /* Div Control */
      ...
      protected void STARTAO2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Memo View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUPAO0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10MemoId = StringUtil.StrToGuid( cgiGet( "vMEMOID"));
      ...
      protected void E12AO2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Memo",StringUtil.Trim( A549MemoId.ToString()),(string)AV14RecordDescription,formatLink("trn_memoview.aspx", new object[] {UrlEncode(A549MemoId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"MemoId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025424121353", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memoview.js", "?2025424121353", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
