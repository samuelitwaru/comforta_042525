...
namespace GeneXus.Programs {
   public class trn_memocategoryview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_memocategoryview.aspx", new object[] {UrlEncode(AV10MemoCategoryId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MemoCategoryId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_memocategoryview.aspx", new object[] {UrlEncode(AV10MemoCategoryId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"MemoCategoryId","TabCode"})  ;
      }
      ...
      protected void WBAK0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_MemoCategoryView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_memo_title_Internalname, "Memo", "", "", lblTrn_memo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_MemoCategoryView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void STARTAK2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Memo Category View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUPAK0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10MemoCategoryId = StringUtil.StrToGuid( cgiGet( "vMEMOCATEGORYID"));
      ...
      protected void E12AK2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_MemoCategory",StringUtil.Trim( A542MemoCategoryId.ToString()),(string)AV14RecordDescription,formatLink("trn_memocategoryview.aspx", new object[] {UrlEncode(A542MemoCategoryId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"MemoCategoryId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025424121256", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memocategoryview.js", "?2025424121257", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Memo Category View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
