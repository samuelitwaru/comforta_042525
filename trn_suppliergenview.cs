...
namespace GeneXus.Programs {
   public class trn_suppliergenview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_suppliergenview.aspx", new object[] {UrlEncode(AV10SupplierGenId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SupplierGenId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("trn_suppliergenview.aspx", new object[] {UrlEncode(AV10SupplierGenId.ToString()),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SupplierGenId","TabCode"})  ;
      }
      ...
      protected void STRUP4D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10SupplierGenId = StringUtil.StrToGuid( cgiGet( "vSUPPLIERGENID"));
      ...
      protected void E114D2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_SupplierGen",(short)2,StringUtil.Trim( A42SupplierGenId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E124D2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            {
               WebComp_Wwpaux_wc.setjustcreated();
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_SupplierGen",StringUtil.Trim( A42SupplierGenId.ToString()),(string)AV14RecordDescription,formatLink("trn_suppliergenview.aspx", new object[] {UrlEncode(A42SupplierGenId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"SupplierGenId","TabCode"}) });
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542718145895", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergenview.js", "?202542718145895", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
