...
namespace GeneXus.Programs {
   public class prc_countdevices : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A337DeviceUserId = P00EX2_A337DeviceUserId[0];
            A333DeviceId = P00EX2_A333DeviceId[0];
            ...
            {
               A11OrganisationId = P00EX4_A11OrganisationId[0];
               A29LocationId = P00EX4_A29LocationId[0];
               A62ResidentId = P00EX4_A62ResidentId[0];
               A40000GXC1 = P00EX4_A40000GXC1[0];
               n40000GXC1 = P00EX4_n40000GXC1[0];
               A40000GXC1 = P00EX4_A40000GXC1[0];
               n40000GXC1 = P00EX4_n40000GXC1[0];
      ...
      {
         P00EX2_A337DeviceUserId = new string[] {""} ;
         P00EX2_A333DeviceId = new string[] {""} ;
         A337DeviceUserId = "";
         A333DeviceId = "";
         AV9DeviceUserId = Guid.Empty;
         AV12Udparg1 = Guid.Empty;
         P00EX4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00EX4_A29LocationId = new Guid[] {Guid.Empty} ;
         P00EX4_A62ResidentId = new Guid[] {Guid.Empty} ;
         P00EX4_A40000GXC1 = new int[1] ;
         P00EX4_n40000GXC1 = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_countdevices__default(),
            new Object[][] {
                new Object[] {
               P00EX2_A337DeviceUserId, P00EX2_A333DeviceId
               }
               , new Object[] {
               P00EX4_A11OrganisationId, P00EX4_A29LocationId, P00EX4_A62ResidentId, P00EX4_A40000GXC1, P00EX4_n40000GXC1
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00EX2_A337DeviceUserId ;
      private string[] P00EX2_A333DeviceId ;
      private Guid[] P00EX4_A11OrganisationId ;
      private Guid[] P00EX4_A29LocationId ;
      private Guid[] P00EX4_A62ResidentId ;
      private int[] P00EX4_A40000GXC1 ;
      private bool[] P00EX4_n40000GXC1 ;
