...
namespace GeneXus.Programs {
   public class prc_countlocationresidents : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A11OrganisationId = P00EZ3_A11OrganisationId[0];
            A29LocationId = P00EZ3_A29LocationId[0];
            A40000GXC1 = P00EZ3_A40000GXC1[0];
            n40000GXC1 = P00EZ3_n40000GXC1[0];
            A62ResidentId = P00EZ3_A62ResidentId[0];
            A40000GXC1 = P00EZ3_A40000GXC1[0];
            n40000GXC1 = P00EZ3_n40000GXC1[0];
      ...
      public override void initialize( )
      {
         ...
         P00EZ3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00EZ3_A29LocationId = new Guid[] {Guid.Empty} ;
         P00EZ3_A40000GXC1 = new int[1] ;
         P00EZ3_n40000GXC1 = new bool[] {false} ;
         P00EZ3_A62ResidentId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_countlocationresidents__default(),
            new Object[][] {
                new Object[] {
               P00EZ3_A11OrganisationId, P00EZ3_A29LocationId, P00EZ3_A40000GXC1, P00EZ3_n40000GXC1, P00EZ3_A62ResidentId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00EZ3_A11OrganisationId ;
      private Guid[] P00EZ3_A29LocationId ;
      private int[] P00EZ3_A40000GXC1 ;
      private bool[] P00EZ3_n40000GXC1 ;
      private Guid[] P00EZ3_A62ResidentId ;
