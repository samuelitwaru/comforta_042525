...
namespace GeneXus.Programs {
   public class wp_receptionistdashboard : GXDataArea
   {
      ...
      protected void gxgrGridusdtnotificationsdatas_refresh_invoke( )
      {
         ...
         gxgrGridusdtnotificationsdatas_refresh( subGridusdtnotificationsdatas_Rows, AV71WWPContext, AV29ForceLoadDots, AV27EventsLoaded, AV5CalendarLoadFromDate, AV6CalendarLoadToDate, AV19Date_ShowingDatesFrom, AV10LoadedDotsFromDate, AV11LoadedDotsToDate, AV12LoadedFromDate, AV13LoadedToDate, AV25Events, AV70USDTNotificationsData, AV18Date, AV15CalendarEventId, AV32IsAuthorized_UserAction1) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vWWPCONTEXT", AV71WWPContext);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vWWPCONTEXT", AV71WWPContext);
         }
         GxWebStd.gx_hidden_field( context, "gxhash_vWWPCONTEXT", GetSecureSignedToken( "", AV71WWPContext, context));
      ...
      protected void WBBN0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_16_BN2( true) ;
         }
         else
         {
            wb_table1_16_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_28_BN2( true) ;
         }
         else
         {
            wb_table2_28_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table2_28_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table3_44_BN2( true) ;
         }
         else
         {
            wb_table3_44_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table3_44_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm hidden-md hidden-lg", "Center", "top", "", "", "div");
            wb_table4_56_BN2( true) ;
         }
         else
         {
            wb_table4_56_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table4_56_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table5_72_BN2( true) ;
         }
         else
         {
            wb_table5_72_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table5_72_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm hidden-md hidden-lg", "Center", "top", "", "", "div");
            wb_table6_84_BN2( true) ;
         }
         else
         {
            wb_table6_84_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table6_84_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table7_100_BN2( true) ;
         }
         else
         {
            wb_table7_100_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table7_100_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm hidden-md hidden-lg", "Center", "top", "", "", "div");
            wb_table8_112_BN2( true) ;
         }
         else
         {
            wb_table8_112_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table8_112_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
         ...
         if ( wbEnd == 139 )
         {
            ...
            wb_table9_168_BN2( true) ;
         }
         else
         {
            wb_table9_168_BN2( false) ;
         }
         return  ;
      }

      protected void wb_table9_168_BN2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 31), "GRIDUSDTNOTIFICATIONSDATAS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 41), "GRIDUSDTNOTIFICATIONSDATAS.ONLINEACTIVATE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( ( AV70USDTNotificationsData.Count >= AV73GXV1 ) && ( AV73GXV1 > 0 ) )
                              {
                                 ...
                                 AV56NotificationIcon1 = cgiGet( edtavNotificationicon1_Internalname);
                                 AssignAttri("", false, edtavNotificationicon1_Internalname, AV56NotificationIcon1);
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void E14BN2( )
      {
         ...
         AV53LocationId = AV71WWPContext.gxTpr_Locationid;
         ...
         AV60Progress1_Value = 1568;
         AV59Progress1_TotalValue = 1890;
         AV62Progress2_Value = 421;
         AV61Progress2_TotalValue = 752;
         AV64Progress3_Value = 1669;
      ...
      private void E16BN2( )
      {
         ...
         while ( AV73GXV1 <= AV70USDTNotificationsData.Count )
         {
            ...
            AV56NotificationIcon1 = StringUtil.Format( "<i class=\"%1 %2\"></i>", ((SdtUSDTNotificationsData_USDTNotificationsDataItem)(AV70USDTNotificationsData.CurrentItem)).gxTpr_Notificationiconclass, "NotificationFontIconGrid", "", "", "", "", "", "", "");
            AssignAttri("", false, edtavNotificationicon1_Internalname, AV56NotificationIcon1);
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void S132( )
      {
         ...
         if ( ( DateTimeUtil.ResetTime ( AV7DotsFromDate ) < DateTimeUtil.ResetTime ( AV10LoadedDotsFromDate ) ) || ( DateTimeUtil.ResetTime ( AV8DotsToDate ) > DateTimeUtil.ResetTime ( AV11LoadedDotsToDate ) ) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( AV7DotsFromDate ) < DateTimeUtil.ResetTime ( AV12LoadedFromDate ) ) || ( DateTimeUtil.ResetTime ( AV8DotsToDate ) > DateTimeUtil.ResetTime ( AV13LoadedToDate ) ) )
            {
               ...
               AV26EventsAux = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
            }
            else
            {
               GXt_SdtWWPDateRangePickerOptions9 = AV14WWPDateRangePickerOptions;
      ...
      protected void wb_table9_168_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table9_168_BN2e( true) ;
         }
         else
         {
            wb_table9_168_BN2e( false) ;
         }
      }

      protected void wb_table8_112_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table8_112_BN2e( true) ;
         }
         else
         {
            wb_table8_112_BN2e( false) ;
         }
      }

      protected void wb_table7_100_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table7_100_BN2e( true) ;
         }
         else
         {
            wb_table7_100_BN2e( false) ;
         }
      }

      protected void wb_table6_84_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_84_BN2e( true) ;
         }
         else
         {
            wb_table6_84_BN2e( false) ;
         }
      }

      protected void wb_table5_72_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_72_BN2e( true) ;
         }
         else
         {
            wb_table5_72_BN2e( false) ;
         }
      }

      protected void wb_table4_56_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_56_BN2e( true) ;
         }
         else
         {
            wb_table4_56_BN2e( false) ;
         }
      }

      protected void wb_table3_44_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_44_BN2e( true) ;
         }
         else
         {
            wb_table3_44_BN2e( false) ;
         }
      }

      protected void wb_table2_28_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_28_BN2e( true) ;
         }
         else
         {
            wb_table2_28_BN2e( false) ;
         }
      }

      protected void wb_table1_16_BN2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_BN2e( true) ;
         }
         else
         {
            wb_table1_16_BN2e( false) ;
         }
      }
      ...
      protected void StartGridControl139( )
      {
         ...
         else
         {
            ...
            GridusdtnotificationsdatasColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV56NotificationIcon1));
      ...
      public override void initialize( )
      {
         ...
         AV25Events = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
         AV70USDTNotificationsData = new GXBaseCollection<SdtUSDTNotificationsData_USDTNotificationsDataItem>( context, "USDTNotificationsDataItem", "Comforta_version20");
         ...
         EvtRowId = "";
         sEvtType = "";
         AV56NotificationIcon1 = "";
         AV53LocationId = Guid.Empty;
         AV9HomeSampleData = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "Comforta_version20");
         GXt_objcol_SdtHomeSampleData_HomeSampleDataItem3 = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "Comforta_version20");
         GXt_objcol_SdtUSDTNotificationsData_USDTNotificationsDataItem4 = new GXBaseCollection<SdtUSDTNotificationsData_USDTNotificationsDataItem>( context, "USDTNotificationsDataItem", "Comforta_version20");
         ...
         AV26EventsAux = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
         GXt_objcol_SdtWWP_Calendar_Events_Item7 = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta_version20");
      ...
      private short AV59Progress1_TotalValue ;
      private short AV62Progress2_Value ;
      private short AV61Progress2_TotalValue ;
      private short AV64Progress3_Value ;
      private short AV63Progress3_TotalValue ;
      private short AV66Progress4_Value ;
      private short AV65Progress4_TotalValue ;
      ...
      private string AV56NotificationIcon1 ;
