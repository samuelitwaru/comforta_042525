...
namespace GeneXus.Programs {
   public class aprc_addpagechildren : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV29Error.gxTpr_Status = "Error";
            AV29Error.gxTpr_Message = "Not Authenticated";
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         A424PageChildren = "";
         AV23SDT_PageChildrenCollection = new GXBaseCollection<SdtSDT_PageChildren>( context, "SDT_PageChildren", "Comforta_version20");
         AV22SDT_PageChildren = new SdtSDT_PageChildren(context);
