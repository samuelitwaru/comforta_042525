   ...
   public class prc_getresidentinformation : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A603ResidentLanguage = P00752_A603ResidentLanguage[0];
            ...
            AV8ResidentDetails.gxTpr_Residentlanguage = A603ResidentLanguage;
      ...
      public override void initialize( )
      {
         ...
         P00752_A603ResidentLanguage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getresidentinformation__default(),
            new Object[][] {
               ...
               P00752_n96ResidentTypeId, P00752_A97ResidentTypeName, P00752_A98MedicalIndicationId, P00752_n98MedicalIndicationId, P00752_A99MedicalIndicationName, P00752_A603ResidentLanguage, P00752_A62ResidentId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00752_A603ResidentLanguage ;
