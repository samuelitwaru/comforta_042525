   ...
   public class prc_getresidentmemos : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A542MemoCategoryId = P00CU4_A542MemoCategoryId[0];
            A543MemoCategoryName = P00CU4_A543MemoCategoryName[0];
            ...
            AV16SDT_Memo.gxTpr_Memocategoryid = A542MemoCategoryId;
            AV16SDT_Memo.gxTpr_Memocategoryname = A543MemoCategoryName;
      ...
      public override void initialize( )
      {
         ...
         P00CU4_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00CU4_A543MemoCategoryName = new string[] {""} ;
         ...
         AV16SDT_Memo = new SdtSDT_Memo(context);
         AV17SDT_Memos = new GXBaseCollection<SdtSDT_Memo>( context, "SDT_Memo", "Comforta_version20");
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getresidentmemos__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00CU4_A528SG_LocationId, P00CU4_A29LocationId, P00CU4_A529SG_OrganisationId, P00CU4_A11OrganisationId, P00CU4_A62ResidentId, P00CU4_A542MemoCategoryId, P00CU4_A543MemoCategoryName, P00CU4_A550MemoTitle, P00CU4_A551MemoDescription, P00CU4_A552MemoImage,
               P00CU4_n552MemoImage, P00CU4_A553MemoDocument, P00CU4_n553MemoDocument, P00CU4_A561MemoStartDateTime, P00CU4_n561MemoStartDateTime, P00CU4_A562MemoEndDateTime, P00CU4_n562MemoEndDateTime, P00CU4_A563MemoDuration, P00CU4_n563MemoDuration, P00CU4_A564MemoRemoveDate,
               P00CU4_A72ResidentSalutation, P00CU4_A64ResidentGivenName, P00CU4_A65ResidentLastName, P00CU4_A71ResidentGUID, P00CU4_A566MemoBgColorCode, P00CU4_A567MemoForm, P00CU4_A549MemoId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00CU4_A542MemoCategoryId ;
      private string[] P00CU4_A543MemoCategoryName ;
