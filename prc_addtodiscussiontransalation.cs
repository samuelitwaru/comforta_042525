   ...
   public class prc_addtodiscussiontransalation : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV9Language, "English") == 0 )
         {
            ...
            new prc_translatelanguage(context ).execute(  AV12LanguageCode,  "nl",  AV16SDT_DiscussionTranslation.gxTpr_Discussiontranslationvalue, out  GXt_char1) ;
         ...
         else if ( StringUtil.StrCmp(AV9Language, "Dutch") == 0 )
         {
            ...
            new prc_translatelanguage(context ).execute(  AV12LanguageCode,  "en",  AV16SDT_DiscussionTranslation.gxTpr_Discussiontranslationvalue, out  GXt_char1) ;
         ...
         */
         A586DiscussionTranslationWWPDiscus = AV16SDT_DiscussionTranslation.gxTpr_Discussiontranslationwwpdiscussionmessageid;
         ...
         /* Using cursor P00EE2 */
         pr_default.execute(0, new Object[] {A585Trn_DiscussionTranslationId, A586DiscussionTranslationWWPDiscus, A595DiscussionTranslationEnglish, A596DiscussionTranslationDutch});
         pr_default.close(0);
...
public class prc_addtodiscussiontransalation__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00EE2", "SAVEPOINT gxupdate;INSERT INTO Trn_DiscussionTranslation(Trn_DiscussionTranslationId, DiscussionTranslationWWPDiscus, DiscussionTranslationEnglish, DiscussionTranslationDutch) VALUES(:Trn_DiscussionTranslationId, :DiscussionTranslationWWPDiscus, :DiscussionTranslationEnglish, :DiscussionTranslationDutch);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00EE2)
       };
    }
 }
